*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZQTCV_PUB_TYP_PG
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZQTCV_PUB_TYP_PG    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZQTCV_PUB_TYP_PG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZQTCV_PUB_TYP_PG_EXTRACT
TOTAL = ZQTCV_PUB_TYP_PG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZQTCV_PUB_TYP_PG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZQTCV_PUB_TYP_PG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_PUB_TYP_PG_EXTRACT
TOTAL = ZQTCV_PUB_TYP_PG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZQTCV_PUB_TYP_PG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZQTCV_PUB_TYP_PG'
...
TOTAL = ZQTCV_PUB_TYP_PG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZQTCV_PUB_TYP_PG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZQTCV_PUB_TYP_PG-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZQTCV_PUB_TYP_PG'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZQTCV_PUB_TYP_PG-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_PUB_TYP_PG_EXTRACT
TOTAL = ZQTCV_PUB_TYP_PG_TOTAL
