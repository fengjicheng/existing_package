class ZCL_ZLW_SALESDATA_MPC definition
  public
...
public section.
  ...
  types:
     TS_SALESHEADERDATA type VBAK .
  types:
TT_SALESHEADERDATA type standard table of TS_SALESHEADERDATA .
  types:
  ...
  constants GC_SALESHEADERDATA type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SalesHeaderData' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_SALESHEADERDATA
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZLW_SALESDATA_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZLW_SALESDATA_SRV' ).

define_salesheaderdata( ).
  endmethod.


  method DEFINE_SALESHEADERDATA.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - SalesHeaderData
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SalesHeaderData' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SalesHeaderDataSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200721143204'.                  "#EC NOTEXT
