class ZCL_ZQTC_ODATA_MATERIA_DPC_EXT definition
  public
  inheriting from ZCL_ZQTC_ODATA_MATERIA_DPC
  create public .
...
CLASS ZCL_ZQTC_ODATA_MATERIA_DPC_EXT IMPLEMENTATION.
...
**ENDTRY.
    ...
    CONSTANTS : lc_action       TYPE string VALUE 'ZMAT',         " Action Name
                lc_extent       TYPE /iwbep/s_mgw_name_value_pair-name VALUE 'Extent',
                lc_extentuom    TYPE /iwbep/s_mgw_name_value_pair-name VALUE 'ExtentUoM',
                ...
                lc_dimensionuom TYPE /iwbep/s_mgw_name_value_pair-name VALUE 'DimensionUoM',
                lc_volume       TYPE /iwbep/s_mgw_name_value_pair-name VALUE 'Volume',
                lc_volumeuom    TYPE /iwbep/s_mgw_name_value_pair-name VALUE 'VolumeUoM',
                lc_tcode        TYPE tcode      VALUE 'JP28',
        ...
        IF it_parameter IS NOT INITIAL.     " request Parameter table In not null
          ...
          LOOP AT it_parameter ASSIGNING <lfs_parameter>.
            CASE <lfs_parameter>-name.
              ...
              WHEN lc_extent.                                   " Extent
                <lfs_amara>-ismextent = <lfs_parameter>-value.
              WHEN lc_extentuom.                                   " ExtentUoM
                <lfs_amara>-ismextentunit  = <lfs_parameter>-value.
              WHEN lc_dimensionuom.                             " Dimension UoM
                <lfs_amara>-meabm  = <lfs_parameter>-value.
              WHEN OTHERS.
...
*                        SEPARATED BY ' '.             " Message text
              CALL FUNCTION 'MESSAGE_TEXT_BUILD'
                EXPORTING
                  msgid               = <lfs_errmsg>-msgid
                  msgnr               = <lfs_errmsg>-msgno
                  msgv1               = <lfs_errmsg>-msgv1
                  msgv2               = <lfs_errmsg>-msgv2
                  msgv3               = <lfs_errmsg>-msgv3
                  msgv4               = <lfs_errmsg>-msgv4
                IMPORTING
                  message_text_output = lst_material-message
                EXCEPTIONS
                  OTHERS              = 4.
              IF sy-subrc NE 0.
