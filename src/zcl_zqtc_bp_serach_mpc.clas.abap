class ZCL_ZQTC_BP_SERACH_MPC definition
  public
...
public section.
  ...
  types:
     TS_IMPORT type BAPIBUS1006_COMM .
  types:
TT_IMPORT type standard table of TS_IMPORT .
  types:
  ...
  types:
     TS_EXPORT type BAPIBUS1006_BP_ADDR .
  types:
TT_EXPORT type standard table of TS_EXPORT .
  types:
     TS_RETURNCODE type BAPIRET2 .
  types:
TT_RETURNCODE type standard table of TS_RETURNCODE .

  constants GC_EXPORT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Export' ##NO_TEXT.
  constants GC_IMPORT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Import' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZQTC_BP_SERACH_MPC========CP' ##NO_TEXT.

  methods DEFINE_IMPORT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_EXPORT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_RETURNCODE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZQTC_BP_SERACH_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZQTC_BP_SERACH_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Export' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Addressguid' iv_abap_fieldname = 'ADDRESSGUID' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CompanyPartner' iv_abap_fieldname = 'COMPANY_PARTNER' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'ALPHA' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'BAPIBUS1006_BP_ADDR'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ExportSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Import' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'BAPIBUS1006_COMM'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ImportSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ReturnCode' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ReturnCodeSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200416110108'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Addressguid'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Export'.                            "#EC NOTEXT
