*----------------------------------------------------------------------
* PROGRAM NAME: ZQTCN_FIELD_CATALOG_R112 (Include Program)
* PROGRAM DESCRIPTION: Field catalog Build
...
IF lv_actv_flag_r112 EQ abap_true.                         " Check Enhancement active flag
 " INCLUDE zqtcn_build_field_cat_r112 IF FOUND.             " Subroutine for Field catalog build
ENDIF.
