class ZCL_ZSD_ORDRS_MPC definition
  public
...
public section.
  ...
  begin of TS_BILLINGBLOCK,
     ...
     FAKSK type C length 45,
     FAKSD type C length 55,
     ...
     ZMENG type P length 7 decimals 3,
     ...
     BLOCKTYPE type C length 10,
     ORDTYP type C length 30,
     LINKREF type string,
     KNETWR type NETWR_AP,
     BSARK type C length 4,
     KUNNR type C length 10,
     STDATE type C length 10,
     ENDATE type C length 10,
     MESSAGE type string,
     MSG1 type string,
     MSG2 type string,
     MSG3 type string,
     ...
     BPLINK type string,
  end of TS_BILLINGBLOCK .
  types:
TT_BILLINGBLOCK type standard table of TS_BILLINGBLOCK .
  types:
  ...
  types:
TT_CREDIT type standard table of TS_CREDIT .
  types:
  begin of TS_DELIVERYBLOCK,
     VBELN type C length 10,
     POSNR type C length 6,
     MATNR type C length 18,
     CHARG type C length 10,
     ...
     GBSTA type C length 1,
     HUVALL type C length 1,
     IUVALL type C length 1,
     CMGST type C length 1,
     BLOCKTYPE type C length 10,
     ORDTYP type C length 30,
     LINKREF type string,
     ...
     ENDATE type C length 10,
     MESSAGE type string,
     MSG1 type C length 255,
     MSG2 type C length 255,
     MSG3 type C length 255,
     MSG4 type C length 255,
  end of TS_DELIVERYBLOCK .
  types:
TT_DELIVERYBLOCK type standard table of TS_DELIVERYBLOCK .
  types:
  begin of TS_INCOMPLETE,
     VBELN type string,
     POSNR type string,
     MATNR type string,
     AUART type string,
     ...
     FDNAM type string,
     ERDAT type ERDAT,
  end of TS_INCOMPLETE .
  types:
TT_INCOMPLETE type standard table of TS_INCOMPLETE .
  types:
     TS_ORDERTYPE type TVAKT .
  types:
TT_ORDERTYPE type standard table of TS_ORDERTYPE .
  types:
     TS_USERID type USR01 .
  types:
TT_USERID type standard table of TS_USERID .
  types:
     TS_ZSD_ORDRS type ZSD_ORDRS .
  types:
TT_ZSD_ORDRS type standard table of TS_ZSD_ORDRS .
  types:
...
TT_DELVHEAD type standard table of TS_DELVHEAD .
  types:
  begin of TS_INCTYPE,
     FDNAM type C length 30,
     TBNAM type C length 30,
     DESCR type C length 80,
  end of TS_INCTYPE .
  types:
TT_INCTYPE type standard table of TS_INCTYPE .
  types:
     TS_USERACCESS type ZQTCT_AUTH_CHECK .
  types:
TT_USERACCESS type standard table of TS_USERACCESS .
  types:
  begin of TS_SOLDTO,
     KUNNR type C length 10,
...
TT_SOLDTO type standard table of TS_SOLDTO .
  ...
  types:
TT_ITEMINC type standard table of TS_ITEMINC .
  types:
  begin of TS_ITEMBILL,
     VBELN type C length 10,
     POSNR type C length 6,
     MATNR type C length 18,
     ARKTX type C length 40,
  ...
  types:
TT_ITEMBILL type standard table of TS_ITEMBILL .
  types:
  begin of TS_ITEMDELV,
     VBELN type C length 10,
     POSNR type C length 6,
     MATNR type C length 18,
     ARKTX type C length 40,
  ...
  types:
TT_ITEMDELV type standard table of TS_ITEMDELV .
  types:
  begin of TS_BILLHEAD,
     VBELN type C length 10,
     MESSAGE type string,
  end of TS_BILLHEAD .
  types:
TT_BILLHEAD type standard table of TS_BILLHEAD .
  types:
...
TT_DELVITEM type standard table of TS_DELVITEM .
  ...
  types:
TT_BILLITEM type standard table of TS_BILLITEM .
  types:
  begin of TS_ITEMCREDIT,
     VBELN type C length 10,
     POSNR type C length 6,
     MATNR type C length 18,
     CHARG type C length 10,
     ...
     ENDATE type C length 10,
     KNETWR type NETWR,
  end of TS_ITEMCREDIT .
  types:
TT_ITEMCREDIT type standard table of TS_ITEMCREDIT .
  types:
  begin of TS_DSO,
     KUNNR type C length 10,
     VBELN type C length 10,
  ...
  types:
TT_DSO type standard table of TS_DSO .
  types:
  begin of TS_TIME,
     SALV_DE_SELOPT_LOW type C length 80,
  end of TS_TIME .
  types:
TT_TIME type standard table of TS_TIME .
  types:
     TS_ZCACONST type ZCACONSTANT .
  types:
TT_ZCACONST type standard table of TS_ZCACONST .

  constants GC_ZSD_ORDRS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZSD_ORDRS' ##NO_TEXT.
  constants GC_ZCACONST type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZCACONST' ##NO_TEXT.
  constants GC_USERID type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'UserId' ##NO_TEXT.
  constants GC_USERACCESS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'UserAccess' ##NO_TEXT.
  constants GC_TIME type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Time' ##NO_TEXT.
  ...
  constants GC_ITEMINC type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ItemINC' ##NO_TEXT.
  constants GC_ITEMDELV type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ItemDELV' ##NO_TEXT.
  constants GC_ITEMCREDIT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ItemCredit' ##NO_TEXT.
  constants GC_ITEMBILL type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ItemBILL' ##NO_TEXT.
  constants GC_INCTYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'IncType' ##NO_TEXT.
  constants GC_INCOMPLETE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Incomplete' ##NO_TEXT.
  constants GC_DSO type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'DSo' ##NO_TEXT.
  ...
  constants GC_DELIVERYBLOCK type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'DeliveryBlock' ##NO_TEXT.
  constants GC_CREDIT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Credit' ##NO_TEXT.
  constants GC_BILLITEM type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'BillItem' ##NO_TEXT.
  constants GC_BILLINGBLOCK type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'BillingBlock' ##NO_TEXT.
  constants GC_BILLHEAD type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'BillHead' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSD_ORDRS_MPC=============CP' ##NO_TEXT.

  methods DEFINE_BILLINGBLOCK
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_CREDIT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_DELIVERYBLOCK
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_INCOMPLETE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ORDERTYPE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_USERID
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ZSD_ORDRS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_DELVHEAD
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_INCTYPE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_USERACCESS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SOLDTO
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ITEMINC
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ITEMBILL
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ITEMDELV
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_BILLHEAD
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_DELVITEM
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_BILLITEM
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ITEMCREDIT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_DSO
    raising
...
CLASS ZCL_ZSD_ORDRS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSD_ORDRS_SRV' ).

define_billingblock( ).
define_credit( ).
define_deliveryblock( ).
define_incomplete( ).
define_ordertype( ).
define_userid( ).
define_zsd_ordrs( ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'ASSOCIATION' "#EC NOTEXT
                            iv_left_type        = 'DelvHead' "#EC NOTEXT
                            iv_right_type       = 'DelvItem' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - ASSOCIATION
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Vbeln'   iv_dependent_property = 'Vbeln' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'ASSOCIATIONSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'DelvHeadSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'DelvItemSet'             "#EC NOTEXT
                                              iv_association_name      = 'ASSOCIATION' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'ASSOCIATION2' "#EC NOTEXT
                            iv_left_type        = 'BillHead' "#EC NOTEXT
                            iv_right_type       = 'BillItem' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - ASSOCIATION2
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Vbeln'   iv_dependent_property = 'Vbeln' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'ASSOCIATION2Set'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'BillHeadSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'BillItemSet'             "#EC NOTEXT
                                              iv_association_name      = 'ASSOCIATION2' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'NP_VBELN' "#EC NOTEXT
                                                              ...
                                                              iv_association_name = 'ASSOCIATION' ). "#EC NOTEXT
* Navigation Properties for entity - BillHead
lo_entity_type = model->get_entity_type( iv_entity_name = 'BillHead' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'NP_VBELN' "#EC NOTEXT
                                                              iv_abap_fieldname = 'NP_VBELN' "#EC NOTEXT
                                                              iv_association_name = 'ASSOCIATION2' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'BillHead' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_BILLHEAD' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'BillHeadSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'BillingBlock' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Faksd' iv_abap_fieldname = 'FAKSD' ). "#EC NOTEXT
lo_property->set_label_from_text_element( iv_text_element_symbol = '197' iv_text_element_container = gc_incl_name ).  "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 55 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
lo_property->set_nullable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Zieme' iv_abap_fieldname = 'ZIEME' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Blocktype' iv_abap_fieldname = 'BLOCKTYPE' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Ordtyp' iv_abap_fieldname = 'ORDTYP' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Knetwr' iv_abap_fieldname = 'KNETWR' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Stdate' iv_abap_fieldname = 'STDATE' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Endate' iv_abap_fieldname = 'ENDATE' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Msg1' iv_abap_fieldname = 'MSG1' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Msg2' iv_abap_fieldname = 'MSG2' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Msg3' iv_abap_fieldname = 'MSG3' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Msg4' iv_abap_fieldname = 'MSG4' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Bplink' iv_abap_fieldname = 'BPLINK' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_BILLINGBLOCK' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'BillingBlockSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'BillItem' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_BILLITEM' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'BillItemSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Credit' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Spstg' iv_abap_fieldname = 'SPSTG' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_CREDIT' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'CreditSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - DeliveryBlock
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'DeliveryBlock' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Faksp' iv_abap_fieldname = 'FAKSP' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Lfsta' iv_abap_fieldname = 'LFSTA' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Fksaa' iv_abap_fieldname = 'FKSAA' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Fksta' iv_abap_fieldname = 'FKSTA' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Fssta' iv_abap_fieldname = 'FSSTA' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Lssta' iv_abap_fieldname = 'LSSTA' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Absta' iv_abap_fieldname = 'ABSTA' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Huvall' iv_abap_fieldname = 'HUVALL' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Iuvall' iv_abap_fieldname = 'IUVALL' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_DELIVERYBLOCK' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'DeliveryBlockSet' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_DELVHEAD' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_DELVITEM' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'DSo' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_DSO' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'DSoSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Incomplete' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_INCOMPLETE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'IncompleteSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'IncType' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_INCTYPE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'IncTypeSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ItemBILL' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Kdmat' iv_abap_fieldname = 'KDMAT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_ITEMBILL' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ItemBILLSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ItemCredit' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_ITEMCREDIT' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ItemCreditSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ItemDELV' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_ITEMDELV' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ItemDELVSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ItemINC' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_ITEMINC' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ItemINCSet' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'TVAKT'
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_SOLDTO' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Time' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'times' iv_abap_fieldname = 'SALV_DE_SELOPT_LOW' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 80 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_ORDRS_MPC=>TS_TIME' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'TimeSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'UserAccess' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DelvBlock' iv_abap_fieldname = 'DELV_BLOCK' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CreditBlock' iv_abap_fieldname = 'CREDIT_BLOCK' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'IncompleteBlock' iv_abap_fieldname = 'INCOMPLETE_BLOCK' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'BillingBlock' iv_abap_fieldname = 'BILLING_BLOCK' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZQTCT_AUTH_CHECK'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'UserAccessSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'UserId' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'USR01'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'UserIdSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ZSD_ORDRS' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSD_ORDRS'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZSD_ORDRSSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210329132510'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'BillingBlock'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Faksd'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'BillingBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Zieme'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'BillingBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Prodh'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'BillingBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Blocktype'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'BillingBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Ordtyp'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'BillingBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Knetwr'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'BillingBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Stdate'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'BillingBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Endate'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'BillingBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Vbeln'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Credit'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Spstg'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Credit'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Vbeln'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DeliveryBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Faksp'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DeliveryBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Lfsta'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DeliveryBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Fksaa'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DeliveryBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Fksta'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DeliveryBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Fssta'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DeliveryBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Lssta'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DeliveryBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Absta'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DeliveryBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Huvall'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DeliveryBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Iuvall'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'DeliveryBlock'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Knetwr'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Incomplete'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Blocktype'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ZSD_ORDRS'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'DelvBlock'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'UserAccess'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '193'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'CreditBlock'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'UserAccess'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'IncompleteBlock'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'UserAccess'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'BillingBlock'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'UserAccess'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Vbeln'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ItemINC'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Kdmat'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ItemINC'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Vbeln'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ItemBILL'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Vbeln'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ItemDELV'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
