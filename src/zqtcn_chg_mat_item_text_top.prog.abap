*&---------------------------------------------------------------------*
*&  Include           ZQTCN_CHG_MAT_ITEM_TEXT_TOP
*&---------------------------------------------------------------------*
*- Excal Upload
TYPES : BEGIN OF ty_excel_file,
          matnr TYPE mara-matnr,              "Material Number
          vkorg TYPE mvke-vkorg,              "Sales Org
          vtweg TYPE mvke-vtweg,              "Distrubution Channel
          lang  TYPE sy-langu,                "Language
          eal   TYPE tdline,                 "EAL Number
        END OF ty_excel_file,
        tt_excel_file TYPE STANDARD TABLE OF ty_excel_file,
*- Sales Document Item data
        BEGIN OF ty_mara,
          matnr TYPE mara-matnr,              "Sales Document Numnber
          vkorg TYPE mvke-vkorg,
          vtweg TYPE mvke-vtweg,
        END OF ty_mara,
*- Report Output
        BEGIN OF ty_alv_disp_screen,
          matnr          TYPE mara-matnr,     "Sales Document Number
          vkorg          TYPE mvke-vkorg,
          vtweg          TYPE mvke-vtweg,
          lang           TYPE sy-langu,     "Sales Document Item
          old_eal        TYPE tdline,        "OLD EAL
          new_eal        TYPE tdline,        "NEW EAL
          status         TYPE char10,         "Status
          status_message TYPE char100,        "Status Message
        END OF ty_alv_disp_screen,
        BEGIN OF ty_alv_disp_screen_text,
          matnr   TYPE mara-matnr,     "Sales Document Number
          lang    TYPE sy-langu,     "Sales Document Item
          old_eal TYPE tdline,        "OLD EAL
        END OF ty_alv_disp_screen_text,
        BEGIN OF ty_mail,
...
DATA:li_mara                 TYPE TABLE OF ty_mara,        "Sales Document Item Data
     ...
     st_alv_disp_screen_text TYPE ty_alv_disp_screen_text,
     li_alv_disp_screen_text TYPE TABLE OF ty_alv_disp_screen_text,
