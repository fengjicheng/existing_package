class ZCL_ZQTC_ODATA_BP_SERA_MPC definition
  public
...
public section.
  ...
  types:
TT_ZBP_BAPI type standard table of TS_ZBP_BAPI .
  types:
  ...
  constants GC_ZBP_BAPI type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'zbp_bapi' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZQTC_ODATA_BP_SERA_MPC====CP' ##NO_TEXT.

  methods DEFINE_ZBP_BAPI
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZQTC_ODATA_BP_SERA_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZQTC_ODATA_BP_SERACH_SRV' ).

define_zbp_bapi( ).
  endmethod.


  method DEFINE_ZBP_BAPI.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'zbp_bapi' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'IEmail' iv_abap_fieldname = 'I_EMAIL' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZQTC_ODATA_BP_SERA_MPC=>TS_ZBP_BAPI' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'zbp_bapiSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200427201201'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'IEmail'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'zbp_bapi'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'CompanyPartner'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'zbp_bapi'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
