*&---------------------------------------------------------------------*
*&  Include           ZQTCR_SALES_PARTNER_TOP
*&---------------------------------------------------------------------*
*&---------------------------------------------------------------------*
...
DATA:
  i_ord_alv      TYPE STANDARD TABLE OF  ty_ord_alv
                     INITIAL SIZE 0,
  i_final        TYPE STANDARD TABLE OF  ty_excel
                    INITIAL SIZE 0,
...
DATA: v_titlebar   TYPE syst_title, " For consolidated error message
      v_path       TYPE salv_de_selopt_low,
      v_sorg       TYPE salv_de_selopt_low,
      v_dist       TYPE salv_de_selopt_low,
      v_cond       TYPE salv_de_selopt_low,
      v_log        TYPE char100,
*====================================================================*
* C L A S S
*====================================================================*
...
CONSTANTS: c_x      TYPE char1    VALUE 'X',        "for marking the radiobutton as selected
           c_email  TYPE auart    VALUE 'EMAIL',      "for ZOPM order type
           ...
           c_devid  TYPE zdevid   VALUE 'E208',
