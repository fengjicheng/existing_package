*----------------------------------------------------------------------*
***INCLUDE LZQTC_IDOC_DEVIDF01.
*-------------------------------------------------------------------*
* PROGRAM NAME: LZQTC_IDOC_DEVIDF01
* PROGRAM DESCRIPTION: Table maintenance event for ZQTC_IDOC_DEVIDtable.
* Update changed by and changed on fields On SAVE event
* DEVELOPER: Prabhu(PTUFARAM)
* CREATION DATE:  12/03/2021
* OBJECT ID: R142 - OTCM-49142
* TRANSPORT NUMBER(S): ED2K925102
*-------------------------------------------------------------------*

*----------------------------------------------------------------------*
***INCLUDE LZCA_CONSTANTF01.
*----------------------------------------------------------------------*
FORM f_on_save.
...
* Assign the table header line to the work area
    ...
    IF <action> = lc_new_entry OR <action> = lc_upd_entry.      " New or updated entry
      ...
      IF sy-subrc = 0.
        ...
        <lfs_record>+242(12) = sy-uname.
        <lfs_record>+254(8)  = sy-datum.
