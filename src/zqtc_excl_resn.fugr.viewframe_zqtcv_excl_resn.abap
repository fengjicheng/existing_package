*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZQTCV_EXCL_RESN
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZQTCV_EXCL_RESN     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZQTCV_EXCL_RESN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZQTCV_EXCL_RESN_EXTRACT
TOTAL = ZQTCV_EXCL_RESN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZQTCV_EXCL_RESN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZQTCV_EXCL_RESN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_EXCL_RESN_EXTRACT
TOTAL = ZQTCV_EXCL_RESN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZQTCV_EXCL_RESN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZQTCV_EXCL_RESN'
...
TOTAL = ZQTCV_EXCL_RESN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZQTCV_EXCL_RESN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZQTCV_EXCL_RESN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZQTCV_EXCL_RESN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZQTCV_EXCL_RESN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_EXCL_RESN_EXTRACT
TOTAL = ZQTCV_EXCL_RESN_TOTAL
