*----------------------------------------------------------------------
* PROGRAM NAME: ZQTCN_ADD_FLDS_MB51_DATAFETCH (Include Program)
* PROGRAM DESCRIPTION: Data fetch for newly adding fields in MB51
...
IF lv_actv_flag_e218 EQ abap_true.                           " Check Enhancement active flag
  INCLUDE zqtcn_mb51_datafetch_sub IF FOUND.                 " Subroutine for data fetch and logic
ENDIF.
