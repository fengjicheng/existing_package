*----------------------------------------------------------------------*
* PROGRAM NAME        : ZQTCN_BUR_EXP_TOKEN_SEL
...
PARAMETERS:
  ...
  p_mescod TYPE edidc-mescod   DEFAULT text-s04 , " Logical Message Variant    'Z13'
  p_mesfct TYPE edidc-mesfct   DEFAULT text-s05 . " Logical message function   'TOK'
SELECTION-SCREEN SKIP 1.

PARAMETERS:
  p_auart  TYPE vbak-auart     DEFAULT text-s06 , " Sales Document Type        'ZTRO'
