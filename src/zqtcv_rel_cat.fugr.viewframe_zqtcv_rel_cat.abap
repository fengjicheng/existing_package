*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZQTCV_REL_CAT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZQTCV_REL_CAT       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZQTCV_REL_CAT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZQTCV_REL_CAT_EXTRACT
TOTAL = ZQTCV_REL_CAT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZQTCV_REL_CAT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZQTCV_REL_CAT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_REL_CAT_EXTRACT
TOTAL = ZQTCV_REL_CAT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZQTCV_REL_CAT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZQTCV_REL_CAT'
...
TOTAL = ZQTCV_REL_CAT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZQTCV_REL_CAT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZQTCV_REL_CAT-UPD_FLAG NE SPACE.
