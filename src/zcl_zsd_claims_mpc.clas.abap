class ZCL_ZSD_CLAIMS_MPC definition
  public
...
TT_CLAIMORD type standard table of TS_CLAIMORD .
  ...
  types:
     TS_CLAIMHEAD type ZSD_REL_ORDERS .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSD_CLAIMS_MPC============CP' ##NO_TEXT.
...
CLASS ZCL_ZSD_CLAIMS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSD_CLAIMS_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSD_REL_ORDERS'
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSD_CLAIMS_MPC=>TS_CLAIMORD' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200722094831'.                  "#EC NOTEXT
