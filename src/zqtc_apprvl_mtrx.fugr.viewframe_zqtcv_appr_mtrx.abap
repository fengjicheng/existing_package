*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZQTCV_APPR_MTRX
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZQTCV_APPR_MTRX     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZQTCV_APPR_MTRX'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZQTCV_APPR_MTRX_EXTRACT
TOTAL = ZQTCV_APPR_MTRX_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZQTCV_APPR_MTRX'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZQTCV_APPR_MTRX-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_APPR_MTRX_EXTRACT
TOTAL = ZQTCV_APPR_MTRX_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZQTCV_APPR_MTRX-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZQTCV_APPR_MTRX'
...
TOTAL = ZQTCV_APPR_MTRX_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZQTCV_APPR_MTRX-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZQTCV_APPR_MTRX-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZQTCV_APPR_MTRX'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZQTCV_APPR_MTRX-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_APPR_MTRX_EXTRACT
TOTAL = ZQTCV_APPR_MTRX_TOTAL
