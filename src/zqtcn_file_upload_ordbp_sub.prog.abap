...
*&---------------------------------------------------------------------*
*----------------------------------------------------------------------*
* PROGRAM NAME: ZQTCN_FILE_UPLOAD_ORDBP_SUB(Include Program for Methods)
...
* EOC by NPOLINA ERP7787     ED2K914488
      EXPORTING
        ...
        i_begin_col             = 1
        i_begin_row             = 1
*       i_end_col               = 54      "NPOLINA ERP7787     ED2K914488
        i_end_col               = 55       "NPOLINA ERP7787     ED2K914488
        i_end_row               = 65000
      TABLES
        intern                  = li_excel
      EXCEPTIONS
        ...
        LOOP AT li_excel INTO lst_excel.
          ...
          AT NEW col.
            CASE lst_excel_dummy-col.
              ...
              WHEN 2.
                lst_final-smn = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 3.
                lst_final-prefix = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.
              ...
              WHEN 5.
                lst_final-mname = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.
              ...
              WHEN 8.
                lst_final-cmpaff = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 9.
                lst_final-dept = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 10.
                lst_final-adrnr = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 11.
                lst_final-adrnr2 = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 12.
                lst_final-adrnr3 = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 13.
                lst_final-ort01 = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.
              ...
              WHEN 16.
                lst_final-pstlz = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.
              ...
              WHEN 18.
                lst_final-telf1 = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 19.
                lst_final-relcat = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 20.
                lst_final-relstdt = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 21.
                lst_final-relendt = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 22.
                lst_final-bukrs = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 23.
                lst_final-customer = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.
              ...
              WHEN 26.
                lst_final-vkorg = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 27.
                lst_final-vtweg = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.
              ...
              WHEN 34.
                lst_final-pstyv = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 35.
                lst_final-zmeng =  lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 36.
                lst_final-lifsk = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.
              ...
              WHEN 38.
                lst_final-abgru = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.
              ...
              WHEN 42.
                lst_final-bsark = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.
              ...
              WHEN 49.
                lst_final-kdkg4 = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 50.
                lst_final-kdkg5 = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 51.
                lst_final-kdkg3 = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.

              WHEN 52.
                lst_final-srid = lst_excel_dummy-value.
                CLEAR lst_excel_dummy.
...
*CALL METHOD OF v_EXCEL 'FILESAVEAS' EXPORTING  #1 = 'C:\Users\npolina\OneDrive - Wiley\Desktop\I0358_test.xls'.
...
* output column headings to active Excel sheet
        PERFORM:
    f_fill_cell USING 1 1 1   text-001 1 8,
    f_fill_cell USING 1 2 1   text-002 1 8,
    f_fill_cell USING 1 3 1   text-003 1 8,
    f_fill_cell USING 1 4 1   text-004 1 8,
    f_fill_cell USING 1 5 1   text-005 1 8,
    f_fill_cell USING 1 6 1   text-006 1 8,
    f_fill_cell USING 1 7 1   text-007 1 8,
    f_fill_cell USING 1 8 1   text-008 1 8,
    f_fill_cell USING 1 9 1   text-009 1 8,
    f_fill_cell USING 1 10 1  text-010 1 8,
    f_fill_cell USING 1 11 1  text-011 1 8,
    f_fill_cell USING 1 12 1  text-012 1 8,
    f_fill_cell USING 1 13 1  text-013 1 8,
    f_fill_cell USING 1 14 1  text-014 1 8,
    f_fill_cell USING 1 15 1  text-015 1 8,
    f_fill_cell USING 1 16 1  text-016 1 8,
    f_fill_cell USING 1 17 1  text-017 1 8,
    f_fill_cell USING 1 18 1  text-018 1 8,
    f_fill_cell USING 1 19 1  text-019 1 8,
    f_fill_cell USING 1 20 1  text-020 1 8,
    f_fill_cell USING 1 21 1  text-021 1 8,
    f_fill_cell USING 1 22 1  text-022 1 8,
    f_fill_cell USING 1 23 1  text-023 1 3,
    f_fill_cell USING 1 24 1  text-024 1 8,
    f_fill_cell USING 1 25 1  text-025 1 6,
    f_fill_cell USING 1 26 1  text-026 1 8,
    f_fill_cell USING 1 27 1  text-027 1 8,
    f_fill_cell USING 1 28 1  text-028 1 8,
    f_fill_cell USING 1 29 1  text-029 1 6,
    f_fill_cell USING 1 30 1  text-030 1 6,
    f_fill_cell USING 1 31 1  text-031 1 6,
    f_fill_cell USING 1 32 1  text-032 1 6,
    f_fill_cell USING 1 33 1  text-033 1 6,
    f_fill_cell USING 1 34 1  text-034 1 6,
    f_fill_cell USING 1 35 1  text-035 1 6,
    f_fill_cell USING 1 36 1  text-036 1 8,
    f_fill_cell USING 1 37 1  text-037 1 8,
    f_fill_cell USING 1 38 1  text-038 1 6,
    f_fill_cell USING 1 39 1  text-039 1 8,
    f_fill_cell USING 1 40 1  text-040 1 6,
    f_fill_cell USING 1 41 1  text-041 1 8,
    f_fill_cell USING 1 42 1  text-042 1 8,
    f_fill_cell USING 1 43 1  text-043 1 8,
    f_fill_cell USING 1 44 1  text-044 1 8,
    f_fill_cell USING 1 45 1  text-045 1 6,
    f_fill_cell USING 1 46 1  text-046 1 6,
    f_fill_cell USING 1 47 1  text-047 1 6,
    f_fill_cell USING 1 48 1  text-048 1 6,
    f_fill_cell USING 1 49 1  text-049 1 6,
    f_fill_cell USING 1 50 1  text-050 1 6,
    f_fill_cell USING 1 51 1  text-051 1 6,
    f_fill_cell USING 1 52 1  text-052 1 6,
    f_fill_cell USING 1 53 1  text-053 1 8,
    f_fill_cell USING 1 54 1  text-054 1 8,
    f_fill_cell USING 1 55 1  text-066 1 8,

*Row 2
    f_fill_cell USING 2 1 0  'Enter Customer Reference ID' 1 8,
    f_fill_cell USING 2 2 0  'Enter society member number for applicable scenarios.If left blank, it will assign a default for CDM to get the upload through.' 1 8,
    f_fill_cell USING 2 3 0  'Enter the salutation of the member within allowed data standards. ' 1 8,
    f_fill_cell USING 2 4 0  'Enter First Name of the Member (40 character limit)' 1 8,
    f_fill_cell USING 2 5 0  'Names input to the middle name field will not be mapped to SAP at this time.' 1 8,
    f_fill_cell USING 2 6 0  'Enter Last Name of the Member (40 character limit) MANDATORY' 1 8,
    f_fill_cell USING 2 7 0  'Suffix not accepted at this time. ' 1 8,
    f_fill_cell USING 2 8 0  'Company/Affiliate not accepted at this time. This will be mapped to SAP Street 2 field. Edits to this field can be made direct in SAP.' 1 8,
    f_fill_cell USING 2 9 0  'Company Department not accepted at this time.This will be mapped to SAP Street 3 fiel. Edits to this field can be made direct in SAP.' 1 8,
    f_fill_cell USING 2 10 0 'Enter member Street Address (35 character limit)MANDATRY' 1 8,
    f_fill_cell USING 2 11 0 'Enter member Street Address continued (35 character limit)' 1 8,
    f_fill_cell USING 2 12 0 'Enter member Street continued (35 character limit)' 1 8,
    f_fill_cell USING 2 13 0 'Enter member City  (40 character limit)MANDATORY' 1 8,
    f_fill_cell USING 2 14 0 'Enter member State/Province/Region, for countries that require.' 1 8,
    f_fill_cell USING 2 15 0 'Enter member Country in line with ISO standard. If country is a territory, use mother country ISO.2 alpha chars MANDATORY ' 1 8,
    f_fill_cell USING 2 16 0 'Enter member postal code. Correct Postal code should be entered, else it will fail through address doctor.' 1 8,
    f_fill_cell USING 2 17 0
 'Enter member e-mail address.Updates to exising members need to be done in SAP. Any unknown update to email for existing member in upload will result in duplicate customer records which will be found in Match/Merge Process until PGL CR is reviewed.' 1 8,
 f_fill_cell USING 2 18 0 '' 1 8,
 f_fill_cell USING 2 19 0 'Enter members type of relationship to society MANDATORY ' 1 8,
 f_fill_cell USING 2 20 0 'Populated by Wiley' 1 8,
 f_fill_cell USING 2 21 0 'Populated by Wiley ' 1 8,
 f_fill_cell USING 2 22 0 'Populated by Wiley ' 1 8,
 f_fill_cell USING 2 23 0 'M' 1 3,
 f_fill_cell USING 2 24 0 'M' 1 6,
 f_fill_cell USING 2 25 0 'M' 1 6,
 f_fill_cell USING 2 26 0 'M' 1 6,
 f_fill_cell USING 2 27 0 'M' 1 6,
 f_fill_cell USING 2 28 0 'M' 1 6,
 f_fill_cell USING 2 29 0 'M' 1 6,
 f_fill_cell USING 2 30 0 'M' 1 6,
 f_fill_cell USING 2 31 0 'M' 1 6,
 f_fill_cell USING 2 32 0 'M' 1 6,
 f_fill_cell USING 2 33 1 'NA' 3 6,
 f_fill_cell USING 2 34 0 '' 1 6,
 f_fill_cell USING 2 35 0 'M' 1 6,
 f_fill_cell USING 2 36 0 'O' 1 6,
 f_fill_cell USING 2 37 0 'O' 1 6,
 f_fill_cell USING 2 38 0 'O' 1 6,
 f_fill_cell USING 2 39 0 'M' 1 6,
 f_fill_cell USING 2 40 1 'NA' 3 6,
 f_fill_cell USING 2 41 0 'O' 1 6,
 f_fill_cell USING 2 42 0 'M' 1 6,
 f_fill_cell USING 2 43 0 'O' 1 6,
 f_fill_cell USING 2 44 0 'O' 1 6,
 f_fill_cell USING 2 45 0 'O' 1 6,
 f_fill_cell USING 2 46 0 'O' 1 6,
 f_fill_cell USING 2 47 0 'O' 1 6,
 f_fill_cell USING 2 48 0 'O' 1 6,
 f_fill_cell USING 2 49 1 'NA' 3 6,
 f_fill_cell USING 2 50 0 'O' 1 6,
 f_fill_cell USING 2 51 0 'O' 1 6,
 f_fill_cell USING 2 52 0 'M' 1 6,
 f_fill_cell USING 2 53 0 'M' 1 6,
 f_fill_cell USING 2 54 0 'O' 1 6,
 f_fill_cell USING 2 55 0 'O' 1 27  .
...
* Save the Excel file
        ...
        CALL METHOD OF v_workbook 'SAVEAS'
          EXPORTING
            #1 = lv_fpath   "'C:\Users\npolina\OneDrive - Wiley\Desktop\zxyss.xls'
            #2 = 1.
        ...
        FREE OBJECT:v_workbook, v_excel,v_mapl,v_column.
        FREE OBJECT:v_excel   ,
                    v_mapl    ,
                    v_map     ,
                    v_workbook,
...
*      -->P_1891   text
*----------------------------------------------------------------------*
FORM f_fill_cell  USING    VALUE(fp_i)         " Row number
                           VALUE(fp_j)         " Column number
                           VALUE(fp_bold)      " Bold
                           VALUE(fp_val)       " Cell
                           VALUE(fp_color)     " Text Color
                           VALUE(fp_bg) .       "Background
  ...
  ELSEIF fp_i = 2.
    SET PROPERTY OF v_f 'Bold' = fp_bold .
    IF fp_bold = 0.
      SET PROPERTY OF v_f 'ITALIC' = 1 .
    ENDIF.
  ENDIF.
