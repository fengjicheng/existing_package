...
*  <--  p2        text
*----------------------------------------------------------------------*
FORM f1_log_maintain USING fp_key   TYPE sapb-sapobjid            " SAP ArchiveLink: Object ID (object identifier)..
                          fp_error TYPE i.
...
*  <--  p2        text
*----------------------------------------------------------------------*
FORM f1_send_info_to_sap_inbox USING fp_key   TYPE sapb-sapobjid            " SAP ArchiveLink: Object ID (object identifier)..
                                    fp_error TYPE i.
  ...
  CONSTANTS:
    ...
    lc_mescod TYPE edipmescod VALUE 'Z2',         "Message code
