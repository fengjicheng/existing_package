...
*---------Selection Screen --------------------------------
TABLES:e070v,e070,e07t,adr6,ZCA_TR_LOG."/ibmaccel/ctslog.
...
*                s_inc FOR /ibmaccel/ctslog-incident_no.
...
SELECTION-SCREEN:BEGIN OF LINE.
PARAMETERS:p_ed1 AS CHECKBOX DEFAULT 'X' USER-COMMAND syssel.
SELECTION-SCREEN: COMMENT 3(21) text-s10 FOR FIELD p_ed1.
PARAMETERS:p_eds1 TYPE c AS LISTBOX VISIBLE LENGTH 20.
SELECTION-SCREEN:END OF LINE.

SELECTION-SCREEN:BEGIN OF LINE.
PARAMETERS:p_ed2 AS CHECKBOX DEFAULT 'X' USER-COMMAND syssel.
SELECTION-SCREEN: COMMENT 3(21) text-s11 FOR FIELD p_ed2.
PARAMETERS:p_eds2 TYPE c AS LISTBOX VISIBLE LENGTH 20.
SELECTION-SCREEN:END OF LINE.

SELECTION-SCREEN:BEGIN OF LINE.
PARAMETERS:p_eq1 AS CHECKBOX DEFAULT 'X' USER-COMMAND syssel.
SELECTION-SCREEN: COMMENT 3(21) text-s12 FOR FIELD p_eq1.
PARAMETERS:p_eqs1 TYPE c AS LISTBOX VISIBLE LENGTH 20.
SELECTION-SCREEN:END OF LINE.

SELECTION-SCREEN:BEGIN OF LINE.
PARAMETERS:p_eq2 AS CHECKBOX DEFAULT 'X' USER-COMMAND syssel.
SELECTION-SCREEN: COMMENT 3(21) text-s13 FOR FIELD p_eq2.
PARAMETERS:p_eqs2 TYPE c AS LISTBOX VISIBLE LENGTH 20.
SELECTION-SCREEN:END OF LINE.

SELECTION-SCREEN:BEGIN OF LINE.
PARAMETERS:p_ep1 AS CHECKBOX DEFAULT 'X' USER-COMMAND syssel.
SELECTION-SCREEN: COMMENT 3(21) text-s14 FOR FIELD p_ep1.
PARAMETERS:p_eps1 TYPE c AS LISTBOX VISIBLE LENGTH 20.
SELECTION-SCREEN:END OF LINE.

SELECTION-SCREEN:BEGIN OF LINE.
PARAMETERS:p_eq3 AS CHECKBOX  USER-COMMAND syssel.
SELECTION-SCREEN: COMMENT 3(21) text-s15 FOR FIELD p_eq3.
PARAMETERS:p_eqs3 TYPE c AS LISTBOX VISIBLE LENGTH 20.
SELECTION-SCREEN:END OF LINE.

SELECTION-SCREEN:BEGIN OF LINE.
PARAMETERS:p_es1 AS CHECKBOX USER-COMMAND syssel.
SELECTION-SCREEN: COMMENT 3(21) text-s16 FOR FIELD p_es1.
PARAMETERS:p_ess1 TYPE c AS LISTBOX VISIBLE LENGTH 20.
SELECTION-SCREEN:END OF LINE.
