...
If s_betdt IS NOT INITIAL. "If payment dates are given
  PERFORM f_payment_details_new.
  PERFORM f_get_vbak_new.
ELSE.
...
*--*BOC OTCM-25936 ED2K920475 Prabhu 11/27/2020
  PERFORM f_get_delivery.
*--*EOC OTCM-25936 ED2K920475 Prabhu 11/27/2020
