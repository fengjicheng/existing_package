"Name: \FU:COMPANY_CODE_READ\SE:END\EI
ENHANCEMENT 0 ZQTCEI_TAX_PROCEDURE_04.
*----------------------------------------------------------------------*
* PROGRAM NAME: ZQTCEI_TAX_PROCEDURE_04 (Implicit Enhancement)
...
* To check enhancement is active or not
  ...
  IF lv_act_f_e038 EQ abap_true.                                "If Enhancement is not Active
    INCLUDE zqtcn_tax_procedure_04 IF FOUND.
  ENDIF.
ENDENHANCEMENT.
