class ZCL_ZQTCO_BLOCKORDERS__MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZQTCO_BLOCKORDERS__MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZQTCO_BLOCKORDERS__MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZQTCO_BLOCKORDERS_E266_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZQTCO_BLOCKORDERS__MPC=>TS_BILLINGBLOCK' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZQTCO_BLOCKORDERS__MPC=>TS_SOLDTO' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZQTCO_BLOCKORDERS__MPC=>TS_TIME' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210331104350'.                  "#EC NOTEXT
