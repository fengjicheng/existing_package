*&---------------------------------------------------------------------*
*&  Include           ZQTCN_LONG_TEXT_UPDATE_TOP
*&---------------------------------------------------------------------*
TYPE-POOLS :slis.
TYPES: BEGIN OF ty_order_details,
         contract TYPE  vbeln_va,  " Business Partner
...
DATA:  i_order_data      TYPE STANDARD TABLE OF ty_order_details,
       i_order_data_main TYPE STANDARD TABLE OF ty_order_details,
       i_order_sel       TYPE STANDARD TABLE OF ty_order_sel,
       i_order_find      TYPE STANDARD TABLE OF ty_order_details,
...
DATA : gv_total      TYPE char10,
       ...
       v_e070_path   TYPE salv_de_selopt_low,
       v_dir         TYPE string,
       v_path_fname  TYPE localfile,       " Local file for upload/download
       v_path_fname1 TYPE localfile,       " Local file for upload/download
       v_file_path   TYPE localfile.       " Local file path for upload/download

CONSTANTS: c_true     TYPE sap_bool VALUE 'X',
           c_devid    TYPE zdevid     VALUE 'E070',
           c_param1   TYPE rvari_vnam VALUE 'NO_OF_RECORDS',
           c_param2   TYPE rvari_vnam VALUE 'LOGICAL_PATH',
           ...
           c_err_file TYPE char16 VALUE 'ORDER_TXT_ERROR_',
           c_suc_file TYPE char18 VALUE 'ORDER_TXT_SUCCESS_'.
