...
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  ERPM-20007/OTCM-14498/OTCM-2660
* REFERENCE NO:  ED2K919939/ED2K919964
* DEVELOPER   :  AMOHAMMED / SGUDA
* DATE        :  10/15/2020
* DESCRIPTION :  Invoice / Credit memo Cancellation for F024 / Mutiple
*                Tax ID display/Layout re-adjustment
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-25961
* REFERENCE NO:  ED2K921069
* DEVELOPER   :  SGUDA
* DATE        :  01/20/2021
* DESCRIPTION :  Proforma documents which state "Invoice" should state Proforma
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
...
* REFERENCE NO:  ED2K923849/ED2K923960
...
* REFERENCE NO:  ED2K924062 / ED2K924644
* DEVELOPER   :  SGUDA
...
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-47079-INC0326442
* REFERENCE NO:  ED2K924696
* DEVELOPER   :  Sivareddy Guda (SGUDA)
* DATE        :  01/OCT/2021
* DESCRIPTION :   ZACS Output Fee Alignment
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
...
* Begin of ADD:OTCM-30892:SGUDA:08-FEB-2021:ED2K921723
  CONSTANTS : lc_zsos TYPE nast-kschl VALUE 'ZSOS',
              lc_zsod TYPE nast-kschl VALUE 'ZSOD'.
...
* Begin of ADD:FMM-2242/OTCM-40083:SGUDA:20-JULY-2021:ED2K924191
  PERFORM f_get_t005 USING st_header.
...
* Begin of ADD:OTCM-30892:SGUDA:08-FEB-2021:ED2K921723
  ELSEIF v_output_typ EQ lc_zsos.
    PERFORM f_populate_layout_summary.
  ELSEIF v_output_typ EQ lc_zsod.
    PERFORM f_populate_layout_detail.
* End of ADD:OTCM-30892:SGUDA:08-FEB-2021:ED2K921723
  ELSEIF v_output_typ EQ c_output_type_zzap.
    PERFORM f_populate_layout_detail.
...
* Begin of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
    IF  li_vbrp IS NOT INITIAL.
      " AND r_po_type_java IS NOT INITIAL.
      REFRESH:i_vbak_qua.
      SELECT vbeln
             bsark
             knumv   "MRAJKUMAR:OTCM-27170/OTCM-67135-4-MAY-2022: ED2K927170
        FROM vbak
        INTO TABLE i_vbak_qua
        FOR ALL ENTRIES IN li_vbrp
        WHERE vbeln = li_vbrp-aubel.
*        AND bsark IN r_po_type_java.
      IF sy-subrc IS INITIAL.
        "Do Nothing
      ENDIF.
*{ Begin of Change by MRAJKUMAR:OTCM-27170/OTCM-67135-4-MAY-2022: ED2K927170
      FREE i_unitprice.
      IF i_vbak_qua IS NOT INITIAL.
        SELECT knumv
               kposn
               kschl
               kbetr
          FROM konv
          INTO TABLE i_unitprice "MRAJKUMAR:OTCM-27170/OTCM-67135-4-MAY-2022:ED2K927413
          FOR ALL ENTRIES IN i_vbak_qua
          WHERE knumv EQ i_vbak_qua-knumv.
*         AND kschl EQ 'ZLPR'."v_unit_auart.
        IF sy-subrc IS INITIAL.
...
*{ End of Change by MRAJKUMAR:OTCM-27170/OTCM-67135-4-MAY-2022: ED2K927170
    ENDIF.
* End of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
    SELECT vbeln,
           posnr,
...
*          Begin of ADD:ERP-6145:WROY:08-AUG-2018:ED2K912958
           matnr,      " Material Number
           mvgr1,      "Material group 1 "OTCM-53609-INC0344959:SGUDA:12-JAN-2022:ED2K925564
           ismpubltype, "Publication Type "OTCM-53609-INC0344959:SGUDA:12-JAN-2022:ED2K925564
* Begin of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
           zzrgcode,   " Registration code/License Number
* End of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
...
* Data Declaration
  DATA : li_final     TYPE ztqtc_item_detail_f024,
         ...
         lst_final2   TYPE zstqtc_item_detail_f024, " Structure for Item table
...
*        Begin of ADD:OTCM-60913/OTCM-60949:SISIREDDY:14-JUL-2022:ED2K92795
         lv_tax25     TYPE kzwi6,                   " Tax
         lv_fees25    TYPE kzwi1,                   " Subtotal 1 from pricing procedure for condition
         lv_disc25    TYPE kzwi5,                   " Discount
*        End of ADD:OTCM-60913/OTCM-60949:SISIREDDY:14-JUL-2022:ED2K92795
...
*End   of ADD:ERP-4131:WROY:14-SEP-2017:ED2K908554
         ...
         lv_quantity     TYPE char15, "OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
* Begin of Change by MRAJKUMAR OTCM-27170:10-MAR-2022: ED2K926052
*         lv_unitprice    TYPE char15, "OTCM-27170-MRAJKUMAR:10-MAR-2022:ED2K926035
         lv_unitprice    TYPE p DECIMALS 2,
         lv_unitvalue    TYPE char15,
* End of Change by MRAJKUMAR OTCM-27170:10-MAR-2022 ED2K926052
         lcc_quan        TYPE p. "OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
...
* Begin of ADD:FMM-2242/OTCM-40083:SGUDA:20-JULY-2021:ED2K924191
  IF i_tax_data[] IS NOT INITIAL.
    PERFORM f_our_tax_validate USING li_tax_data.
...
**************************************************************************************************
  ...
  DATA(li_vbkd_temp25) = i_vbkd[].
  SORT:li_vbkd_temp25 BY bsark.
  DELETE ADJACENT DUPLICATES FROM li_vbkd_temp25 COMPARING bsark.
  READ TABLE li_vbkd_temp25 INTO DATA(lst_vbkd_temp25) INDEX 1.
  IF ( sy-subrc EQ 0 AND lst_vbkd_temp25-bsark IN r_pur_ord_type ) OR v_output_typ EQ c_output_type_zzap.
    DATA(i_vbrp_final25) = i_vbrp_final[].
    SORT:i_vbrp_final25 BY matnr.
    DELETE ADJACENT DUPLICATES FROM i_vbrp_final25 COMPARING matnr.
    DESCRIBE TABLE i_vbrp_final25 LINES DATA(lv_lines_temp25).
    SORT i_vbrp_final25 BY vbeln posnr matnr.
* Populate final table
    LOOP AT i_vbrp_final25 INTO DATA(lst_vbrp_final25) WHERE vbeln = fp_st_vbrk-vbeln.
      DATA(lv_lines_temp26) = sy-tabix.
      DATA(lst_vbrp25) = lst_vbrp_final25.
      AT NEW matnr."prod_group.
        IF lst_vbrp25-uepos IS INITIAL.
* Begin of ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
          IF v_vkorg IN r_sales_org_pq.
            READ TABLE i_vbkd INTO DATA(lst_vbkd_pq25) WITH KEY vbeln = lst_vbrp25-aubel
                                                                posnr = lst_vbrp25-aupos.
            IF sy-subrc EQ 0 AND lst_vbkd_pq25-bsark IN r_po_type_pq.
              READ TABLE i_vbap INTO DATA(lst_vbap_pq25) WITH KEY vbeln = lst_vbrp25-aubel
                                                                  posnr = lst_vbrp25-aupos.

              IF sy-subrc EQ 0 AND lst_vbap_pq25-mvgr1 IN r_pub_type_pq.
                TRANSLATE lst_vbap_pq25-zzdealtyp TO UPPER CASE.
                IF  lst_vbap_pq25-zzdealtyp IN r_deal_type_pq.
                  CALL FUNCTION 'ISP_CONVERT_FIRSTCHARS_TOUPPER'
                    EXPORTING
                      input_string  = lst_vbap_pq25-zzdealtyp
                      separators    = ' -.,;:'
                    IMPORTING
                      output_string = lst_final-description.
                  DATA(lv_flag_pq25) = abap_true.
                  lv_flag_pub_typ  = abap_true.
                ENDIF.
              ENDIF.
            ENDIF.
          ENDIF.
          IF lv_flag_pq25 = abap_false.
* End of ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
            READ TABLE i_pub_typ INTO DATA(lst_pub_typ25) WITH KEY publication_type = lst_vbrp25-ismpubltype
                                                                      BINARY SEARCH.
            IF sy-subrc EQ 0.
              lst_final-description = lst_pub_typ25-prod_group_d.
              IF lst_pub_typ25-prod_group IN r_pub_typ. "If Token then populate flag
*              DATA(lv_flag_pub_typ) = abap_true. "ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
                lv_flag_pub_typ  = abap_true. "ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
              ENDIF. " IF lst_pub_typ-prod_group IN r_pub_typ
            ENDIF. " IF sy-subrc EQ 0
          ENDIF. "ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
      ...
      CLEAR:lv_fees25,
            lv_tax25,
            lst_vbrp_final25-fkimg,
            lv_tabix25,
            lv_disc25.

**EOC by MODUTTA on 06-Jun-18 for CR# 6145 TR#: ED2K912187
      LOOP AT i_vbrp_final   INTO DATA(lst_vbrp26) WHERE vbeln = fp_st_vbrk-vbeln
                                                    AND  matnr = lst_vbrp25-matnr.
        lv_tabix25 = lv_tabix25 + 1 .
* Begin of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
        READ TABLE i_vbak_qua INTO DATA(lst_vbak_tmp_t25) WITH KEY vbeln  = lst_vbrp26-aubel.
        IF sy-subrc EQ 0.
          lst_vbrp_final25-fkimg = lst_vbrp_final25-fkimg + lst_vbrp26-fkimg.
          READ TABLE i_vbap INTO DATA(lst_vbap_license_t25) WITH KEY vbeln = lst_vbrp26-aubel
                                                                     posnr = lst_vbrp26-aupos.
          IF sy-subrc EQ 0 AND lst_vbap_license_t25-zzrgcode IS NOT INITIAL.
            CLEAR:v_txt_name,lv_text_id,v_subs_type.
            v_txt_name = c_license_no.
            lv_text_id = lc_text_id.
            PERFORM f_read_sub_type USING v_txt_name
                                          lv_text_id
                             CHANGING v_subs_type.
            IF lv_tabix25 EQ 1.
              CONCATENATE v_subs_type lst_vbap_license_t25-zzrgcode INTO lst_final2-description.
            ELSE.
              CONCATENATE lst_final2-description lst_vbap_license_t25-zzrgcode INTO lst_final2-description SEPARATED BY c_comma.
            ENDIF.
          ENDIF.
        ENDIF.
* End of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
**          BOC by MODUTTA on 15/01/2018 for CR# TBD
        READ TABLE li_konv INTO DATA(lst_konv25) WITH KEY kposn = lst_vbrp26-posnr
                                                          kschl = v_cond_type
                                                          BINARY SEARCH.
        IF sy-subrc EQ 0.
          lv_kwert = lv_kwert + lst_konv25-kwert.
        ENDIF. " IF sy-subrc EQ 0
...
*   For Digital,Print,Combined and Shipping
        READ TABLE fp_i_mara INTO DATA(lst_mara25) WITH KEY matnr = lst_vbrp26-matnr
                                                             BINARY SEARCH.
        IF sy-subrc EQ 0.
***      Populate media type text
          IF lst_mara25-ismmediatype = v_sub_type_di.
          ...
          ELSEIF lst_mara25-ismmediatype = v_sub_type_ph.
            v_txt_name = lc_print.
            lv_text_id = lc_text_id.
            PERFORM f_read_sub_type USING v_txt_name
                                              lv_text_id
          ...
          ELSEIF lst_mara25-ismmediatype = v_sub_type_mm.
            v_txt_name = lc_mixed.
            lv_text_id = lc_text_id.
            PERFORM f_read_sub_type USING v_txt_name
                                              lv_text_id
          ...
          ELSEIF lst_mara25-ismmediatype = v_sub_type_se.
...
*     Begin of ADD:CR#743:WROY:13-Mar-2018:ED2K911320
          lst_tax_item-subs_type = lst_mara25-ismmediatype.
*     End   of ADD:CR#743:WROY:13-Mar-2018:ED2K911320
        ENDIF. " IF sy-subrc EQ 0

***for bom component tax calculation
        READ TABLE li_vbrp INTO DATA(lst_vbrp_temp25) WITH KEY uepos = lst_vbrp26-posnr.
        IF sy-subrc EQ 0.
          DATA(lv_tabix_tmp) = sy-tabix.
          LOOP AT li_vbrp INTO DATA(lst_vbrp_tmp25) FROM lv_tabix_tmp.
            IF lst_vbrp_tmp25-uepos NE lst_vbrp26-posnr.
              EXIT.
            ENDIF. " IF lst_vbrp_tmp-uepos NE lst_vbrp-posnr
            lv_tax = lv_tax + lst_vbrp_tmp25-kzwi6.
...
***   Populate percentage
        READ TABLE li_tkomv INTO DATA(lst_komv25) WITH KEY kposn = lst_vbrp26-posnr.
*   Begin of ADD:ERP-6894:WROY:14-Mar-2018:ED2K911366
        IF sy-subrc NE 0.
          CLEAR: lst_komv25.
...
*   End   of DEL:ERP-6894:WROY:14-Mar-2018:ED2K911366
          ...
          LOOP AT li_tkomv INTO lst_komv25 FROM lv_index.
            IF lst_komv25-kposn NE lst_vbrp26-posnr.
              EXIT.
            ENDIF. " IF lst_komv-kposn NE lst_vbrp-posnr
            lv_kbetr = lv_kbetr + lst_komv25-kbetr.
*       Begin of ADD:ERP-6894:WROY:14-Mar-2018:ED2K911366
****    Populate taxable amount
            lst_tax_item-taxable_amt = lst_komv25-kawrt.
*       End   of ADD:ERP-6894:WROY:14-Mar-2018:ED2K911366
...
*   Begin of ADD:ERP-6660:WROY:15-Feb-2018:ED2K910930
        IF lst_tax_item-taxable_amt IS INITIAL.
          lst_tax_item-taxable_amt = lst_vbrp26-netwr. " Net value of the billing item in document currency
        ENDIF. " IF lst_tax_item-taxable_amt IS INITIAL
*   End   of ADD:ERP-6660:WROY:15-Feb-2018:ED2K910930
**      Populate tax amount
        lst_tax_item-tax_amount = lst_vbrp26-kzwi6.

        IF lst_vbrp26-kzwi6 IS INITIAL.
          CLEAR lv_tax_amount.
...
***EOC by MODUTTA for CR_743
        ...
        IF lst_vbrp26-uepos IS INITIAL. "BOM header or Non BOM but no BOM components
...
***      EOC by MODUTTA on 11/01/2018 for CR_TBD
          CLEAR lst_mara25.
          READ TABLE fp_i_mara INTO lst_mara25 WITH KEY matnr = lst_vbrp26-matnr
                                             BINARY SEARCH.
          IF sy-subrc EQ 0.
            IF lst_mara25-mtart IN r_mtart_med_issue. "Media Issues
              READ TABLE fp_i_makt ASSIGNING FIELD-SYMBOL(<lst_makt25>)
                   WITH KEY matnr = lst_vbrp26-matnr
                            spras = st_header-language "Customer Language
                   BINARY SEARCH.
              IF sy-subrc NE 0.
                READ TABLE fp_i_makt ASSIGNING <lst_makt25>
                     WITH KEY matnr = lst_vbrp26-matnr
                              spras = c_deflt_langu "Default Language
                     BINARY SEARCH.
              ENDIF. " IF sy-subrc NE 0
              IF sy-subrc EQ 0.
                lst_final-description = <lst_makt25>-maktx. "Material Description
              ENDIF. " IF sy-subrc EQ 0
            ELSE. " ELSE -> IF lst_mara-mtart IN r_mtart_med_issue
*         Fetch Material Basic Text
              CLEAR: li_lines,
                     lv_mat_text.
              lv_tdname = lst_mara25-matnr.
...
***          BOC by MODUTTA on 11/01/2018 for CR# TBD
          IF lst_vbrp26-uepos IS INITIAL.
            CLEAR lst_mara25.
            READ TABLE fp_i_mara INTO lst_mara25 WITH KEY matnr = lst_vbrp26-matnr BINARY SEARCH.
            IF sy-subrc EQ 0.
              LOOP AT fp_i_jptidcdassign INTO DATA(lst_jptidcdassign25) WHERE matnr = lst_mara25-matnr.
...
*            ENDIF. " IF lst_mara-ismmediatype = c_print
                IF lst_jptidcdassign25-identcode IS NOT INITIAL.
...
*                CONCATENATE v_text_line lst_jptidcdassign-identcode INTO lst_final-prod_id SEPARATED BY ':'. "Comment by MODUTTA for CR#6145
                    lst_final-prod_id = lst_jptidcdassign25-identcode.
*                APPEND lst_final TO fp_i_final.
*                CLEAR lst_final.
...
*** Begin of: CR#6802 KKR20180626  ED2K912204/ED2K912369
          IF fp_st_vbrk-fkart = v_pinv.
            READ TABLE i_vbap_pinv INTO ls_vbap_pinv WITH KEY
                       vbeln = lst_vbrp25-aubel posnr = lst_vbrp26-aupos
                       BINARY SEARCH.
          ENDIF. " IF fp_st_vbrk-fkart = v_pinv
*** End of: CR#6802 KKR20180626  ED2K912204/ED2K912369
...
*        lv_fees = ls_vbap_pinv-kzwi2."Commented by RKUMAR2, ED1K908531,INC0212338
            lv_fees = lv_fees25 + lst_vbrp26-kzwi1."Added by RKUMAR2, ED1K908531,INC0212338
          ELSE. " ELSE -> IF fp_st_vbrk-fkart = v_pinv
*** End of: CR#6802 KKR20180626  ED2K912204/ED2K912369
            lv_fees = lv_fees25 + lst_vbrp26-kzwi1.
          ENDIF. " IF fp_st_vbrk-fkart = v_pinv
          IF fp_st_vbrk-vbtyp IN r_crd
            AND lv_fees GT 0.
...
*        lv_disc = ls_vbap_pinv-kzwi5."Commented by RKUMAR2, ED1K908531,INC0212338
            lv_disc = lv_disc25 + lst_vbrp26-kzwi5."Added by RKUMAR2, ED1K908531,INC0212338
          ELSE. " ELSE -> IF fp_st_vbrk-fkart = v_pinv
*** End of: CR#6802 KKR20180626  ED2K912204/ED2K912369
            lv_disc = lv_disc25 + lst_vbrp26-kzwi5.
          ENDIF. " IF fp_st_vbrk-fkart = v_pinv
          IF fp_st_vbrk-vbtyp IN r_crd.
            lv_disc = lv_disc * -1.
...
*        lv_subtot = ls_vbap_pinv-kzwi1 + lv_subtot."Commented by RKUMAR2, ED1K908531,INC0212338
            lv_subtot = lst_vbrp26-kzwi3 + lv_subtot."Added by RKUMAR2, ED1K908531,INC0212338
*        v_subtotal_val = v_subtotal_val + ls_vbap_pinv-kzwi1.  "Commented by RKUMAR2, ED1K908531,INC0212338
          ELSE. " ELSE -> IF fp_st_vbrk-fkart = v_pinv
*** End of: CR#6802 KKR20180626  ED2K912204/ED2K912369
            lv_subtot = lst_vbrp26-kzwi3 + lv_subtot.
          ENDIF. " IF fp_st_vbrk-fkart = v_pinv
...
******     Item Number
          lst_final-item = lst_vbrp26-posnr.
...
*          lv_tax = ls_vbap_pinv-kzwi6 + lv_tax."Commented by RKUMAR2, ED1K908531,INC0212338
              lv_tax = lst_vbrp26-kzwi6 + lv_tax."Added by RKUMAR2, ED1K908531,INC0212338
            ELSE. " ELSE -> IF fp_st_vbrk-fkart = v_pinv
*** End of: CR#6802 KKR20180626  ED2K912204/ED2K912369
              lv_tax = lst_vbrp26-kzwi6 + lv_tax.
            ENDIF. " IF fp_st_vbrk-fkart = v_pinv
          ENDIF. " IF lst_final-tax_amount IS INITIAL
          IF fp_st_vbrk-fkart = v_pinv.
*          lv_tax = ls_vbap_pinv-kzwi6 + lv_tax."Commented by RKUMAR2, ED1K908531,INC0212338
            lv_tax25 = lst_vbrp26-kzwi6 + lv_tax25."Added by RKUMAR2, ED1K908531,INC0212338
          ELSE. " ELSE -> IF fp_st_vbrk-fkart = v_pinv
*** End of: CR#6802 KKR20180626  ED2K912204/ED2K912369
            lv_tax25 = lst_vbrp26-kzwi6 + lv_tax25.
          ENDIF. " IF fp_st_vbrk-fkart = v_pinv

          IF fp_st_vbrk-vbtyp IN r_crd
             AND lv_tax25 GT 0.
            WRITE lv_tax25 TO lst_final-tax_amount CURRENCY st_vbrk-waerk.
...
*        lv_amnt = lv_amnt + ls_vbap_pinv-cmpre.""Commented by RKUMAR2, ED1K908531,INC0212338
            lv_amnt = lst_vbrp26-kzwi3 + lv_tax + lv_amnt."Added by RKUMAR2, ED1K908531,INC0212338
            lv_total_due = lv_total_due + ls_vbap_pinv-cmpre.
          ELSE. " ELSE -> IF fp_st_vbrk-fkart = v_pinv
*** End of: CR#6802 KKR20180626  ED2K912204/ED2K912369
            lv_amnt = lst_vbrp26-kzwi3 + lv_tax + lv_amnt.
          ENDIF. " IF fp_st_vbrk-fkart = v_pinv
...
*      v_sales_tax    = ls_vbap_pinv-kzwi6 + v_sales_tax."Commented by RKUMAR2, ED1K908531,INC0212338
          v_sales_tax    = lst_vbrp26-kzwi6 + v_sales_tax. "Added by RKUMAR2, ED1K908531,INC0212338
        ELSE. " ELSE -> IF fp_st_vbrk-fkart = v_pinv
*** End of: CR#6802 KKR20180626  ED2K912204/ED2K912369
          v_sales_tax    = lst_vbrp26-kzwi6 + v_sales_tax.
        ENDIF. " IF fp_st_vbrk-fkart = v_pinv
      ENDLOOP.
      IF lst_final2 IS NOT INITIAL.
        APPEND lst_final2 TO fp_i_final.
        CLEAR lst_final2.
      ENDIF.
      IF lst_final IS NOT INITIAL.
        IF lst_final-prod_id IS INITIAL.
          lst_final-prod_id     = lst_vbrp26-matnr.
        ENDIF.
        IF lst_final-description IS INITIAL.
          lst_final-description = lst_vbrp26-arktx.
        ENDIF.
        APPEND lst_final TO fp_i_final.
        CLEAR lst_final.
      ENDIF. " IF lst_final IS NOT INITIAL
...
***BOC by MODUTTA on 18/10/2017 for CR#666
      ...
      IF lst_final IS NOT INITIAL
        AND lst_vbrp25-uepos IS INITIAL.
        APPEND lst_final TO fp_i_final.
        CLEAR lst_final.
...
**BOC by MODUTTA on 06-Jun-18 for CR# 6145 TR#: ED2K912187
      IF st_header-contract_date IS INITIAL.
        READ TABLE i_veda INTO DATA(lst_veda) WITH KEY vbeln = lst_vbrp25-aubel
                                                       vposn = lst_vbrp25-aupos
                                                       BINARY SEARCH.
        IF sy-subrc NE 0.
          READ TABLE i_veda INTO lst_veda WITH KEY vbeln = lst_vbrp25-aubel
                                                         vposn = '000000'
                                                         BINARY SEARCH.
        ENDIF. " IF sy-subrc NE 0
        IF sy-subrc EQ 0.
      ...
      IF lv_flag_pub_typ IS NOT INITIAL.
        WRITE lst_vbrp25-fkimg TO lv_fkimg_txt UNIT lst_vbrp25-vrkme.
...
*  TAX ID/VAT ID
      lv_doc_line = lst_vbrp25-posnr.
      READ TABLE li_tax_data INTO DATA(lst_tax_data) WITH KEY document = lst_vbrp25-vbeln
      ...
      ELSEIF lst_vbrp25-kzwi6 IS NOT INITIAL OR
             fp_st_vbrk-fkart = v_pinv. " CR#6802 KKR20180626  ED2K912204/ED2K912369
        IF st_header-comp_code_country EQ lst_vbrp25-lland.
          READ TABLE i_tax_id ASSIGNING FIELD-SYMBOL(<lst_tax_id>)
               WITH KEY land1 = lst_vbrp25-lland
               BINARY SEARCH.
          IF sy-subrc EQ 0.
...
*  BOC by MODUTTA on 08/08/2017 for CR#408
      IF st_header-buyer_reg IS INITIAL.
        READ TABLE li_tax_buyer INTO DATA(lst_tax_buyer) WITH KEY document = lst_vbrp25-vbeln
                                                              doc_line_number = lv_doc_line
                                                              BINARY SEARCH.
        IF sy-subrc EQ 0
          AND lst_vbrp25-uepos IS INITIAL.
...
*      ENDIF.
*    ENDIF.
***************for eMRWs Update Orders*************
      READ TABLE i_vbap INTO DATA(lst_vbap_tmp) WITH KEY vbeln = lst_vbrp_final25-aubel
                                                         posnr = lst_vbrp_final25-aupos.
      IF sy-subrc EQ 0.
        READ TABLE i_vbkd INTO DATA(lst_vbkd_content) WITH KEY vbeln = lst_vbrp_final25-aubel
                                                            posnr = lst_vbrp_final25-aupos.
        IF sy-subrc EQ 0.
          READ TABLE i_mara INTO DATA(lst_mara_tmp25) WITH KEY matnr = lst_vbap_tmp-matnr.
          IF sy-subrc EQ 0.
            IF lst_mara_tmp25-ismpubltype   IN r_pub_type          "Publication Type = MR (eMRW)
               AND lst_vbap_tmp-pstyv       IN r_item_catg_zeon    "Item Category = ZEON
               AND lst_vbap_tmp-mvgr1       IN r_mat_grp_1         "Material Group 1 = NE
               AND lst_vbkd_content-kdkg5   IN r_cust_cond_grp_ua. "Condition Group 5 = UA
* Get Text id (0062) of Object Type VBBP = “AUPD” or “GUPD” or “CUPD”
              CLEAR v_string.
              PERFORM f_get_emrw_orders USING lst_vbap_tmp
                                        CHANGING  v_string.
              IF ( v_string CS c_aupd OR v_string CS c_gupd OR v_string CS c_cupd ).
                lv_flag_content = abap_true.
              ENDIF.
            ELSEIF lst_vbap_tmp-pstyv       IN r_item_catg_zbak    "Item Category = ZBAK
              AND  lst_vbkd_content-kdkg5   IN r_doc_itm_cust_cond_grp.    "Condition Group 5 = SB
* Get Text id (0062) of Object Type VBBP = “AFTE” or “GFTE” or “CFTE”
              CLEAR v_string.
              PERFORM f_get_emrw_orders USING lst_vbap_tmp
                                        CHANGING  v_string.
              IF ( v_string CS c_afte OR v_string CS c_gfte OR v_string CS c_cfte ).
                lv_flag_content = abap_true.
              ENDIF.
            ENDIF. " For Orders
          ENDIF. " For Material data
        ENDIF. " For Business data
      ENDIF. "For Order Item
...
* Begin of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
      ...
      IF lv_flag_pub_typ IS INITIAL.
        READ TABLE i_vbak_qua INTO DATA(lst_vbak_tmp1) WITH KEY vbeln  = lst_vbrp_final25-aubel.
        IF sy-subrc EQ 0. "AND lst_vbrp_final25-fkimg GT 1.
* Quantity
          CLEAR: lv_quantity,lcc_quan.
          MOVE lst_vbrp_final25-fkimg TO lcc_quan.
          lv_quantity = lcc_quan.
          CONDENSE lv_quantity.
          CLEAR:v_txt_name,lv_text_id,v_subs_type.
          v_txt_name = c_quantity_text.
          lv_text_id = lc_text_id.
          PERFORM f_read_sub_type USING v_txt_name
                                        lv_text_id
                           CHANGING v_subs_type.
          CONCATENATE v_subs_type lv_quantity INTO lst_final-description SEPARATED BY space.
          APPEND lst_final TO fp_i_final.
          CLEAR lst_final.
*{ Begin of Change by MRAJKUMAR:OTCM-27170-10-MAR-2022:ED2K926035
* Unit Price
*{ Begin of Change by MRAJKUMAR:OTCM-27170/OTCM-67135-4-MAY-2022: ED2K927170
*        CLEAR: lv_quantity,lcc_quan,lv_unitprice.
*        MOVE lst_vbrp_final-fkimg TO lcc_quan.
*        lv_quantity = lcc_quan.
*        lv_unitprice = lst_vbrp_final-kzwi1 / lv_quantity.
          CLEAR: lv_unitprice,lv_unitvalue.
          READ TABLE i_unitprice ASSIGNING FIELD-SYMBOL(<fs_unitprice>)
            WITH KEY kposn = lst_vbrp_final25-posnr  kschl = 'ZLPR'."v_unit_auart."MRAJKUMAR:OTCM-27170/OTCM-67135-4-MAY-2022:ED2K927413
          IF  sy-subrc IS INITIAL
          AND <fs_unitprice> IS ASSIGNED.
            lv_unitprice = <fs_unitprice>-kbetr.
          ENDIF.
*{ End of Change by MRAJKUMAR:OTCM-27170/OTCM-67135-4-MAY-2022: ED2K927170
* Begin of Change by MRAJKUMAR OTCM-27170:10-MAR-2022: ED2K926052
          MOVE lv_unitprice TO lv_unitvalue.
*        CONDENSE lv_unitprice.
          CONDENSE lv_unitvalue.
* End of Change by MRAJKUMAR OTCM-27170:10-MAR-2022: ED2K926052
          CLEAR:v_txt_name,lv_text_id,v_subs_type.
          v_txt_name = c_unit_price.
          lv_text_id = lc_text_id.
          PERFORM f_read_sub_type USING v_txt_name
                                        lv_text_id
                           CHANGING v_subs_type.
** Begin of Change by MRAJKUMAR OTCM-27170:10-MAR-2022: ED2K926052
**        CONCATENATE v_subs_type lv_unitprice INTO lst_final-description SEPARATED BY space.
*          CONCATENATE v_subs_type lv_unitvalue INTO lst_final-description SEPARATED BY space.
** End of Change by MRAJKUMAR OTCM-27170:10-MAR-2022: ED2K926052
*          APPEND lst_final TO fp_i_final.
          CLEAR:lst_final,v_subs_type.
...
*- End of ADD:ERPM-1362:SGUDA:02-Dec-2019:ED2K917059
      IF NOT lv_lines_temp26 EQ lv_lines_temp25.
        AT END OF matnr."PROD_GROUP
          APPEND lst_final TO fp_i_final.
      ...
      CLEAR lst_vbrp_final25. "ERPM-1362:SGUDA:02-Dec-2019:ED2K917059
    ENDLOOP. " LOOP AT i_vbrp_final INTO DATA(lst_vbrp_final) WHERE vbeln = fp_st_vbrk-vbeln
*  ENDIF.
***********************************************************************************************************
** End of ADD:OTCM-60913/OTCM-60949:SISIREDDY:14-JUL-2022:ED2K927959                                                 *
***********************************************************************************************************
...
* Begin of ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
          IF v_vkorg IN r_sales_org_pq.
            READ TABLE i_vbkd INTO DATA(lst_vbkd_pq) WITH KEY vbeln = lst_vbrp-aubel
                                                              posnr = lst_vbrp-aupos.
            IF sy-subrc EQ 0 AND lst_vbkd_pq-bsark IN r_po_type_pq.
              READ TABLE i_vbap INTO DATA(lst_vbap_pq) WITH KEY vbeln = lst_vbrp-aubel
                                                                posnr = lst_vbrp-aupos.

              IF sy-subrc EQ 0 AND lst_vbap_pq-mvgr1 IN r_pub_type_pq.
                TRANSLATE lst_vbap_pq-zzdealtyp TO UPPER CASE.
                IF  lst_vbap_pq-zzdealtyp IN r_deal_type_pq.
                  CALL FUNCTION 'ISP_CONVERT_FIRSTCHARS_TOUPPER'
                    EXPORTING
                      input_string  = lst_vbap_pq-zzdealtyp
                      separators    = ' -.,;:'
                    IMPORTING
                      output_string = lst_final-description.
                  DATA(lv_flag_pq) = abap_true.
                  lv_flag_pub_typ  = abap_true.
                ENDIF.
              ENDIF.
            ENDIF.
          ENDIF.
          IF lv_flag_pq = abap_false.
* End of ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
...
**EOC by MODUTTA on 06-Jun-18 for CR# 6145 TR#: ED2K912187
* Begin of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
      READ TABLE i_vbak_qua INTO DATA(lst_vbak_tmp_t) WITH KEY vbeln  = lst_vbrp-aubel.
      IF sy-subrc EQ 0.
        READ TABLE i_vbap INTO DATA(lst_vbap_license_t) WITH KEY vbeln = lst_vbrp-aubel
                                                               posnr = lst_vbrp-aupos.
        IF sy-subrc EQ 0 AND lst_vbap_license_t-zzrgcode IS NOT INITIAL.
          CLEAR:v_txt_name,lv_text_id,v_subs_type.
          v_txt_name = c_license_no.
          lv_text_id = lc_text_id.
          PERFORM f_read_sub_type USING v_txt_name
                                        lv_text_id
                           CHANGING v_subs_type.
          CONCATENATE v_subs_type lst_vbap_license_t-zzrgcode INTO lst_final-description.
          APPEND lst_final TO fp_i_final.
          CLEAR lst_final.
        ENDIF.
      ENDIF.
...
*  TAX ID/VAT ID
      ...
      READ TABLE li_tax_data INTO lst_tax_data WITH KEY document = lst_vbrp-vbeln
                                                              doc_line_number = lv_doc_line
                                                              BINARY SEARCH.
      IF sy-subrc EQ 0
        AND lst_tax_data-seller_reg IS NOT INITIAL.
...
*  BOC by MODUTTA on 08/08/2017 for CR#408
      IF st_header-buyer_reg IS INITIAL.
        READ TABLE li_tax_buyer INTO lst_tax_buyer WITH KEY document = lst_vbrp-vbeln
                                                            doc_line_number = lv_doc_line
                                                              BINARY SEARCH.
        IF sy-subrc EQ 0
          AND lst_vbrp-uepos IS INITIAL.
...
*    ENDIF.
***************for eMRWs Update Orders*************
      READ TABLE i_vbap INTO  lst_vbap_tmp WITH KEY vbeln = lst_vbrp_final-aubel
                                                         posnr = lst_vbrp_final-aupos.
      IF sy-subrc EQ 0.
        READ TABLE i_vbkd INTO lst_vbkd_content WITH KEY vbeln = lst_vbrp_final-aubel
                                                            posnr = lst_vbrp_final-aupos.
        IF sy-subrc EQ 0.
          READ TABLE i_mara INTO DATA(lst_mara_tmp) WITH KEY matnr = lst_vbap_tmp-matnr.
          IF sy-subrc EQ 0.
            IF lst_mara_tmp-ismpubltype     IN r_pub_type          "Publication Type = MR (eMRW)
               AND lst_vbap_tmp-pstyv       IN r_item_catg_zeon    "Item Category = ZEON
               AND lst_vbap_tmp-mvgr1       IN r_mat_grp_1         "Material Group 1 = NE
               AND lst_vbkd_content-kdkg5   IN r_cust_cond_grp_ua. "Condition Group 5 = UA
* Get Text id (0062) of Object Type VBBP = “AUPD” or “GUPD” or “CUPD”
...
* Begin of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
      ...
      IF lv_flag_pub_typ IS INITIAL.
        READ TABLE i_vbak_qua INTO lst_vbak_tmp1 WITH KEY vbeln  = lst_vbrp_final-aubel.
        IF sy-subrc EQ 0 AND lst_vbrp_final-fkimg GT 1.
* Quantity
          CLEAR: lv_quantity,lcc_quan.
          MOVE lst_vbrp_final-fkimg TO lcc_quan.
          lv_quantity = lcc_quan.
...
*        lv_unitprice = lst_vbrp_final-kzwi1 / lv_quantity.
          CLEAR: lv_unitprice, lv_unitvalue.
          READ TABLE i_unitprice ASSIGNING <fs_unitprice>
            WITH KEY kposn = lst_vbrp_final-posnr kschl = v_unit_auart."MRAJKUMAR:OTCM-27170/OTCM-67135-4-MAY-2022:ED2K927413
          IF  sy-subrc IS INITIAL
          AND <fs_unitprice> IS ASSIGNED.
            lv_unitprice = <fs_unitprice>-kbetr.
          ENDIF.
...
* BOC by SGUDA on 10/16/2020 for OTCM-14498 with ED2K919939 *
        im_v_seller_reg_2       = v_seller_reg_1  "ERPM-14498
        im_v_terms_cond_2       = v_terms_cond_2
...
*       im_v_text_flag          = v_text_flag
        im_v_signature_text     = v_signature_text
...
* Begin of ADD:OTCM-51284/FMM-5645:SGUDA:12-Nov-2021:ED1K913785
  DATA(liv_vbrp1) = i_vbrp[ 1 ].
  IF st_vbrk-bukrs IN r_comp_code AND st_vbrk-waerk IN  r_docu_currency  AND liv_vbrp1-vkbur IN r_sales_office1.
    CLEAR fp_v_remit_to.
    fp_v_remit_to  = c_remit.
...
* Begin of ADD:OTCM-51284/FMM-5645:SGUDA:12-Nov-2021:ED1K913785
  IF st_vbrk-bukrs IN r_comp_code AND st_vbrk-waerk IN  r_docu_currency  AND liv_vbrp1-vkbur IN r_sales_office1.
    ...
    fp_v_bank_detail  = c_bank.
    CONDENSE fp_v_bank_detail NO-GAPS.
  ENDIF.
* End of ADD:OTCM-51284/FMM-5645:SGUDA:12-Nov-2021:ED1K913785
* Begin of ADD:ERP-6599:MODUTTA:04-Apr-2018:ED2K911793
...
* Populate Payment detail
    ...
    v_terms_cond_2 = fp_v_payment_detail.
    CLEAR li_lines.
    CALL FUNCTION 'READ_TEXT'
      EXPORTING
        id                      = lc_st
...
* Retrieve Tax/VAT values and add with document currency value
  ...
  IF sy-subrc EQ 0.
    ...
    IF sy-subrc EQ 0.
      CONDENSE lv_text.
* BOC by SGUDA on 10/16/2020 for OTCM-2660 with ED2K919939 *
      fp_v_vat  = lv_text . "ERPM-2660
*      CONCATENATE lv_text st_header-doc_currency INTO fp_v_vat SEPARATED BY space. ""ERPM-2660
* EOC by SGUDA on 10/16/2020 for OTCM-2660 with ED2K919939 *
    ENDIF. " IF sy-subrc EQ 0
  ENDIF. " IF sy-subrc EQ 0
*  ENDIF. " IF sy-subrc EQ 0
...
* Fetch prepaid amount text from text module
  ...
  LOOP AT i_txtmodule INTO lst_line.
* BOC by SGUDA on 10/16/2020 for OTCM-2660 with ED2K919939 *
*    CONCATENATE lst_line-tdline st_header-doc_currency INTO v_prepaidamt SEPARATED BY space. "ERPM-2660
    v_prepaidamt = lst_line-tdline. "ERPM-2660
* EOC by SGUDA on 10/16/2020 for OTCM-2660 with ED2K919939 *
...
* BOC by SGUDA on 10/16/2020 for OTCM-2660 with ED2K919939 *
*      CONCATENATE v_pinv_num v_prepaidamt st_header-doc_currency INTO v_prepaidamt SEPARATED BY space. " ERPM-2660
      CONCATENATE v_pinv_num v_prepaidamt  INTO v_prepaidamt SEPARATED BY space. " ERPM-2660
* EOC by SGUDA on 10/16/2020 for OTCM-2660 with ED2K919939 *
...
* Begin of ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923395
              lc_bpid_ftp              TYPE rvari_vnam VALUE 'BPID_FTP',   " BP ID for FTP Agents email trigger
              lc_output_ftp            TYPE rvari_vnam VALUE 'OUTPUT_FTP', " Outputs for FTP Agents email trigger
              lc_po_type_ftp           TYPE rvari_vnam VALUE 'PO_TYPE_FTP', " PO type for FTP Agents email trigger
* End of ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923395
* Begin of ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
              lc_sales_team_email      TYPE rvari_vnam VALUE 'SALES_TEAM_EMAIL',
              lc_supplement_po         TYPE rvari_vnam VALUE 'SUPPLEMENT_PO',
...
* Begin of ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
              lc_sales_org_pq          TYPE rvari_vnam VALUE 'SALES_ORG_PQ',
              lc_ismpubltype_pq        TYPE rvari_vnam VALUE 'ISMPUBLTYPE',
              lc_deal_type_pq          TYPE rvari_vnam VALUE 'DEAL_TYPE',
              lc_po_type_pq            TYPE rvari_vnam VALUE 'PO_TYPE',
* End of ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
* Begin of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
              lc_po_type_java          TYPE rvari_vnam VALUE 'PO_TYPE_JAVA',
* End of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
* Begin of ADD:OTCM-60913/OTCM-60949 SISIREDDY:18-July-2022:ED2K927959
              lc_pur_ord_type          TYPE rvari_vnam VALUE 'PUR_ORD_TYPE'.
* End of ADD:OTCM-60913/OTCM-60949 SISIREDDY:18-July-2022:ED2K927959
* Data Declaration
...
*- End of ADD:ERPM-1362:SGUDA:02-Dec-2019:ED2K917059
*- Begin of ADD OTCM-60913/OTCM-60949 SISIREDDY:18-July-2022:ED2K927959
      IF lst_constant-param1 EQ lc_pur_ord_type.
        APPEND INITIAL LINE TO r_pur_ord_type  ASSIGNING FIELD-SYMBOL(<lst_pur_ord_type>).
        <lst_pur_ord_type>-sign   = lst_constant-sign.
        <lst_pur_ord_type>-option = lst_constant-opti.
        <lst_pur_ord_type>-low    = lst_constant-low.
        <lst_pur_ord_type>-high   = lst_constant-high.
      ENDIF.
*- End of ADD OTCM-60913/OTCM-60949 SISIREDDY:18-July-2022:ED2K927959
* Begin of ADD:ERPM-10760:SGUDA:05-MAR-2020:ED2K917764
...
* End by AMOHAMMED on 10/15/2020 ERPM- 20007
* Begin of ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923395
      IF lst_constant-param1 EQ lc_bpid_ftp.   " BP ID for FTP Agents email trigger
        APPEND INITIAL LINE TO r_bpid_ftp ASSIGNING FIELD-SYMBOL(<lfs_bpid_ftp>).
        <lfs_bpid_ftp>-sign = lst_constant-sign.
        <lfs_bpid_ftp>-option = lst_constant-opti.
        <lfs_bpid_ftp>-low  = lst_constant-low.
        <lfs_bpid_ftp>-high = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_output_ftp.   " Output for FTP Agents email trigger
        APPEND INITIAL LINE TO r_output_ftp ASSIGNING FIELD-SYMBOL(<lfs_output_ftp>).
        <lfs_output_ftp>-sign = lst_constant-sign.
        <lfs_output_ftp>-option = lst_constant-opti.
        <lfs_output_ftp>-low  = lst_constant-low.
        <lfs_output_ftp>-high = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_po_type_ftp.   " PO type for FTP Agents email trigger
        APPEND INITIAL LINE TO r_po_type_ftp ASSIGNING FIELD-SYMBOL(<lfs_po_type_ftp>).
        <lfs_po_type_ftp>-sign = lst_constant-sign.
        <lfs_po_type_ftp>-option = lst_constant-opti.
        <lfs_po_type_ftp>-low  = lst_constant-low.
        <lfs_po_type_ftp>-high = lst_constant-high.
      ENDIF.
* End of ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923395
* Begin of ADD:OTCM-4948:MRAJKUMAR:17-JUNE-2021:ED2K923849
      " Billing Types to print the Signature Text
      IF lst_constant-param1 EQ  c_billtype.
        APPEND INITIAL LINE TO r_billing_type ASSIGNING FIELD-SYMBOL(<lfs_fkart>).
        <lfs_fkart>-sign   = lst_constant-sign.
        <lfs_fkart>-option = lst_constant-opti.
        <lfs_fkart>-low    = lst_constant-low.
        <lfs_fkart>-high   = lst_constant-high..
      ENDIF.
      " Billing country to print the Signature Text
      IF lst_constant-param1 EQ c_country.
        APPEND INITIAL LINE TO r_bill_ship_country  ASSIGNING FIELD-SYMBOL(<lfs_land1>).
        <lfs_land1>-sign   = lst_constant-sign.
        <lfs_land1>-option = lst_constant-opti.
        <lfs_land1>-low    = lst_constant-low.
        <lfs_land1>-high   = lst_constant-high.
      ENDIF.
      "End of ADD:OTCM-4948:MRAJKUMAR:17-JUNE-2021:ED2K923849
* Begin of ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
      IF lst_constant-param1 EQ lc_sales_team_email.   " PO type for FTP Agents email trigger
        APPEND INITIAL LINE TO r_sales_team_email ASSIGNING FIELD-SYMBOL(<lfs_sales_team_email>).
        <lfs_sales_team_email>-sign = lst_constant-sign.
        <lfs_sales_team_email>-option = lst_constant-opti.
        <lfs_sales_team_email>-low  = lst_constant-low.
        <lfs_sales_team_email>-high = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_supplement_po.   " PO type for FTP Agents email trigger
        APPEND INITIAL LINE TO r_supplement_po ASSIGNING FIELD-SYMBOL(<lfs_supplement_po>).
        <lfs_supplement_po>-sign = lst_constant-sign.
        <lfs_supplement_po>-option = lst_constant-opti.
        <lfs_supplement_po>-low  = lst_constant-low.
        <lfs_supplement_po>-high = lst_constant-high.
      ENDIF.
* End of ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
*  Begin of ADD:FMM-2242/OTCM-40083:SGUDA:20-JULY-2021:ED2K924191
      IF lst_constant-param1 EQ c_sales_org_1001 AND lst_constant-param2 EQ c_param2_our_taxid.
        APPEND INITIAL LINE TO r_sales_org_1001 ASSIGNING FIELD-SYMBOL(<lfs_sales_org_1001>).
        <lfs_sales_org_1001>-sign   = lst_constant-sign.
        <lfs_sales_org_1001>-option = lst_constant-opti.
        <lfs_sales_org_1001>-low    = lst_constant-low.
        <lfs_sales_org_1001>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ c_sales_org_3310 AND lst_constant-param2 EQ c_param2_our_taxid.
        APPEND INITIAL LINE TO r_sales_org_3310 ASSIGNING FIELD-SYMBOL(<lfs_sales_org_3310>).
        <lfs_sales_org_3310>-sign   = lst_constant-sign.
        <lfs_sales_org_3310>-option = lst_constant-opti.
        <lfs_sales_org_3310>-low    = lst_constant-low.
        <lfs_sales_org_3310>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ c_our_taxid_eu AND lst_constant-param2 EQ c_param2_our_taxid.
        APPEND INITIAL LINE TO r_our_taxid_eu  ASSIGNING FIELD-SYMBOL(<lfs_our_taxid_eu>).
        <lfs_our_taxid_eu>-sign   = lst_constant-sign.
        <lfs_our_taxid_eu>-option = lst_constant-opti.
        <lfs_our_taxid_eu>-low    = lst_constant-low.
        <lfs_our_taxid_eu>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ c_our_taxid_fr AND lst_constant-param2 EQ c_param2_our_taxid.
        APPEND INITIAL LINE TO r_our_taxid_fr  ASSIGNING FIELD-SYMBOL(<lfs_our_taxid_fr>).
        <lfs_our_taxid_fr>-sign   = lst_constant-sign.
        <lfs_our_taxid_fr>-option = lst_constant-opti.
        <lfs_our_taxid_fr>-low    = lst_constant-low.
        <lfs_our_taxid_fr>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ c_bill_to_eu AND lst_constant-param2 EQ c_param2_our_taxid.
        APPEND INITIAL LINE TO r_bill_to_country_eu  ASSIGNING FIELD-SYMBOL(<lfs_bill_to_country_eu>).
        <lfs_bill_to_country_eu>-sign   = lst_constant-sign.
        <lfs_bill_to_country_eu>-option = lst_constant-opti.
        <lfs_bill_to_country_eu>-low    = lst_constant-low.
        <lfs_bill_to_country_eu>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ c_bill_to_fr AND lst_constant-param2 EQ c_param2_our_taxid.
        APPEND INITIAL LINE TO r_bill_to_country_fr  ASSIGNING FIELD-SYMBOL(<lfs_bill_to_country_fr>).
        <lfs_bill_to_country_fr>-sign   = lst_constant-sign.
        <lfs_bill_to_country_fr>-option = lst_constant-opti.
        <lfs_bill_to_country_fr>-low    = lst_constant-low.
        <lfs_bill_to_country_fr>-high   = lst_constant-high.
      ENDIF.
*  End of ADD:FMM-2242/OTCM-40083:SGUDA:20-JULY-2021:ED2K924191
*- Begin of ADD:OTCM-51284/FMM-5645:SGUDA:12-Nov-2021:ED1K913785
      IF lst_constant-param1 EQ c_comp_code.
      ...
      ENDIF.
      IF lst_constant-param1 EQ c_docu_currency.
      ...
      ENDIF.
      IF lst_constant-param1 EQ c_sales_office.
        APPEND INITIAL LINE TO r_sales_office1 ASSIGNING FIELD-SYMBOL(<lst_sales_office1>).
        <lst_sales_office1>-sign   = lst_constant-sign.
        <lst_sales_office1>-option = lst_constant-opti.
        <lst_sales_office1>-low    = lst_constant-low.
        <lst_sales_office1>-high   = lst_constant-high.
      ENDIF.
*- End of ADD:OTCM-51284/FMM-5645:SGUDA:12-Nov-2021:ED1K913785
*- Begin of ADD:OTCM-42834 INC0333245:SGUDA:30-SEP-2021:ED2K924663
      IF lst_constant-param1 EQ lc_currency_from.
        APPEND INITIAL LINE TO r_currency_from ASSIGNING FIELD-SYMBOL(<lst_currency_from>).
        <lst_currency_from>-sign   = lst_constant-sign.
        <lst_currency_from>-option = lst_constant-opti.
        <lst_currency_from>-low    = lst_constant-low.
        <lst_currency_from>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_currency_to.
        APPEND INITIAL LINE TO r_currency_to ASSIGNING FIELD-SYMBOL(<lst_currency_to>).
        <lst_currency_to>-sign   = lst_constant-sign.
        <lst_currency_to>-option = lst_constant-opti.
        <lst_currency_to>-low    = lst_constant-low.
        <lst_currency_to>-high   = lst_constant-high.
      ENDIF.
*- End of ADD:OTCM-42834 INC0333245:SGUDA:30-SEP-2021:ED2K924663
* Begin of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
      IF lst_constant-param1 EQ lc_po_type_java.
        APPEND INITIAL LINE TO r_po_type_java ASSIGNING FIELD-SYMBOL(<lst_po_type_java>).
        <lst_po_type_java>-sign   = lst_constant-sign.
        <lst_po_type_java>-option = lst_constant-opti.
        <lst_po_type_java>-low    = lst_constant-low.
        <lst_po_type_java>-high   = lst_constant-high.
      ENDIF.
* End of CHANGE:OTCM-27170-INC0307782:SGUDA:10-Jan-2022:ED2K925518
* Begin of ADD:OTCM-53609-INC0344959:SGUDA:12-JAN-2022:ED2K925564
      IF lst_constant-param1 EQ c_cust_cond_grp_ua.
        APPEND INITIAL LINE TO r_cust_cond_grp_ua ASSIGNING FIELD-SYMBOL(<lst_cust_cond_grp_ua>).
        <lst_cust_cond_grp_ua>-sign   = lst_constant-sign.
        <lst_cust_cond_grp_ua>-option = lst_constant-opti.
        <lst_cust_cond_grp_ua>-low    = lst_constant-low.
        <lst_cust_cond_grp_ua>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ c_item_catg_zbak.
        APPEND INITIAL LINE TO r_item_catg_zbak ASSIGNING FIELD-SYMBOL(<lst_item_catg_zbak>).
        <lst_item_catg_zbak>-sign   = lst_constant-sign.
        <lst_item_catg_zbak>-option = lst_constant-opti.
        <lst_item_catg_zbak>-low    = lst_constant-low.
        <lst_item_catg_zbak>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ c_item_catg_zeon.
        APPEND INITIAL LINE TO r_item_catg_zeon ASSIGNING FIELD-SYMBOL(<lst_item_catg_zeon>).
        <lst_item_catg_zeon>-sign   = lst_constant-sign.
        <lst_item_catg_zeon>-option = lst_constant-opti.
        <lst_item_catg_zeon>-low    = lst_constant-low.
        <lst_item_catg_zeon>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ c_mat_grp_1.
        APPEND INITIAL LINE TO r_mat_grp_1 ASSIGNING FIELD-SYMBOL(<lst_mat_grp_1>).
        <lst_mat_grp_1>-sign   = lst_constant-sign.
        <lst_mat_grp_1>-option = lst_constant-opti.
        <lst_mat_grp_1>-low    = lst_constant-low.
        <lst_mat_grp_1>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ c_pub_type.
        APPEND INITIAL LINE TO r_pub_type ASSIGNING FIELD-SYMBOL(<lst_pub_type>).
        <lst_pub_type>-sign   = lst_constant-sign.
        <lst_pub_type>-option = lst_constant-opti.
        <lst_pub_type>-low    = lst_constant-low.
        <lst_pub_type>-high   = lst_constant-high.
      ENDIF.
* End of ADD:OTCM-53609-INC0344959:SGUDA:12-JAN-2022:ED2K925564
* Begin of ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
      IF lst_constant-param1 EQ lc_sales_org_pq.
        APPEND INITIAL LINE TO r_sales_org_pq ASSIGNING FIELD-SYMBOL(<lst_sales_org_pq>).
        <lst_sales_org_pq>-sign   = lst_constant-sign.
        <lst_sales_org_pq>-option = lst_constant-opti.
        <lst_sales_org_pq>-low    = lst_constant-low.
        <lst_sales_org_pq>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_ismpubltype_pq.
        APPEND INITIAL LINE TO r_pub_type_pq ASSIGNING FIELD-SYMBOL(<lst_pub_type_pq>).
        <lst_pub_type_pq>-sign   = lst_constant-sign.
        <lst_pub_type_pq>-option = lst_constant-opti.
        <lst_pub_type_pq>-low    = lst_constant-low.
        <lst_pub_type_pq>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_deal_type_pq.
        APPEND INITIAL LINE TO r_deal_type_pq ASSIGNING FIELD-SYMBOL(<lst_deal_type_pq>).
        <lst_deal_type_pq>-sign   = lst_constant-sign.
        <lst_deal_type_pq>-option = lst_constant-opti.
        <lst_deal_type_pq>-low    = lst_constant-low.
        <lst_deal_type_pq>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_po_type_pq.
        APPEND INITIAL LINE TO r_po_type_pq  ASSIGNING FIELD-SYMBOL(<lst_po_type_pq>).
        <lst_po_type_pq>-sign   = lst_constant-sign.
        <lst_po_type_pq>-option = lst_constant-opti.
        <lst_po_type_pq>-low    = lst_constant-low.
        <lst_po_type_pq>-high   = lst_constant-high.
      ENDIF.
* End of ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
*Begin of Change by RAJKUMAR:OTCM-27170/OTCM-67135-4-MAY-2022: ED2K927170
      IF lst_constant-param1 EQ c_unitpirce_auart.
        CLEAR v_unit_auart.
        v_unit_auart = lst_constant-low.
      ENDIF.
*Begin of Change by RAJKUMAR:OTCM-27170/OTCM-67135-4-MAY-2022: ED2K927170
      CLEAR lst_constant.
...
* BOC by SGUDA on 10/16/2020 for OTCM-14498 with ED2K919951
      IF v_seller_reg IS INITIAL.
        LOOP AT li_tax_data INTO lst_tax_data.
          IF sy-tabix = 1.
...
* Begin of ADD:OTCM-47079-INC0326442:SGUDA:01-OCT-2021:ED2K924696
* Populate first line od description
  lst_final-description = 'ENHANCED ACCESS LICENSE'.
  DATA(li_vbkd_temp) = i_vbkd[].
  SORT li_vbkd_temp BY kdkg5.
...
*
  ...
  IF v_text_line IS NOT INITIAL.
    ...
    CLEAR lst_final.
  ENDIF. " IF v_text_line IS NOT INITIAL
* End of ADD:OTCM-47079-INC0326442:SGUDA:01-OCT-2021:ED2K924696
* BOC by SRBOSE
  IF v_seller_reg IS NOT INITIAL.
...
* Begin of ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
      IF v_vkorg IN r_sales_org_pq.
        READ TABLE i_vbkd INTO DATA(lst_vbkd_pq) WITH KEY vbeln = <lst_vbrp_final>-aubel
                                                          posnr = <lst_vbrp_final>-aupos.
        IF sy-subrc EQ 0 AND lst_vbkd_pq-bsark IN r_po_type_pq.
          READ TABLE i_vbap INTO DATA(lst_vbap_pq) WITH KEY vbeln = <lst_vbrp_final>-aubel
                                                            posnr = <lst_vbrp_final>-aupos.
          IF sy-subrc EQ 0 AND lst_vbap_pq-mvgr1 IN r_pub_type_pq.
            TRANSLATE lst_vbap_pq-zzdealtyp TO UPPER CASE.
            IF lst_vbap_pq-zzdealtyp IN r_deal_type_pq.
...
* End   of DEL:ERP-5069:WROY:14-Nov-2017:ED2K909404
  DATA lv_flag_pub_typ TYPE char1.
...
* Begin of ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
      IF v_vkorg IN r_sales_org_pq.
        READ TABLE i_vbkd INTO DATA(lst_vbkd_pq) WITH KEY vbeln = lst_vbrp_vbpa-aubel
                                                          posnr = lst_vbrp_vbpa-aupos.
        IF sy-subrc EQ 0 AND lst_vbkd_pq-bsark IN r_po_type_pq.
          READ TABLE i_vbap INTO DATA(lst_vbap_pq) WITH KEY vbeln = lst_vbrp_vbpa-aubel
                                                            posnr = lst_vbrp_vbpa-aupos.
          IF sy-subrc EQ 0  AND lst_vbap_pq-mvgr1 IN r_pub_type_pq.
            TRANSLATE lst_vbap_pq-zzdealtyp TO UPPER CASE.
            IF lst_vbap_pq-zzdealtyp IN r_deal_type_pq.
...
* Begin by AMOHAMMED on 10/15/2020 ERPM- 20007
  IF fp_st_vbrk-vbtyp IN r_can_inv.
    " Read the text "Credit Note" when Invoice is cancelled
    PERFORM f_read_text USING c_name_crd_not
                        CHANGING fp_v_accmngd_title.
...
* Read the text "Original Document" againt the cancelled document
  IF st_vbrk-vbtyp IN r_can_inv OR st_vbrk-vbtyp IN r_can_crd.
    PERFORM f_read_text USING    c_org_doc
                        CHANGING v_title.
    CONCATENATE v_title fp_st_vbrk-sfakn INTO v_title
                                         SEPARATED BY space.
  ENDIF.
* End by AMOHAMMED on 10/15/2020 ERPM- 20007
* Begin of ADD:OTCM-25961:SGUDA:20-JAN-2021:ED2K921069
*  IF st_vbrk-fkart = v_pinv.
*    PERFORM f_read_text USING c_proforma_text
*                        CHANGING fp_v_accmngd_title.
*  ENDIF.
* End of ADD:OTCM-25961:SGUDA:20-JAN-2021:ED2K921069
...
* End of change: PBOSE: 19-May-2017: Defect 2185 : ED2K905977
         lv_name    TYPE thead-tdname. "ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
...
* Constant Declaration
  CONSTANTS : lc_raw      TYPE so_obj_tp      VALUE 'RAW',                        " Code for document class
              ...
              lc_so_email TYPE thead-tdname  VALUE 'ZQTC_EMAIL_BODY_STANDING_ORD'. " Standing orders email body "ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
...
* Message body and subject
  ...
  ENDTRY.
* Begin of ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
  IF v_supplementry_po IN r_supplement_po.
    lv_name = lc_so_email.
  ELSE.
    lv_name  = lc_name.
  ENDIF.
...
********FM is used to SAPscript: Read text
  CALL FUNCTION 'READ_TEXT'
    EXPORTING
      id                      = c_st
      language                = st_header-language
*     name                    = lc_name "ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
      name                    = lv_name "ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
      object                  = c_object
    TABLES
      lines                   = li_lines
    EXCEPTIONS
...
* Begin of ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
  IF v_supplementry_po IN r_supplement_po.
    CONCATENATE 'Your Invoice'(005) st_header-invoice_number 'With John Wiley & Sons'(006)
...
* End   of CHANGE:ERP-4930/ERP-5069:WROY:01-Nov-2017:ED2K909229
  ...
  ENDIF. "ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
  TRY .
...
* EOC by NPOLINA 05-Aug-2019 DM1897 ED2K915832
* Begin of ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923395
  DATA(liv_vbrp_po) = i_vbrp[ 1 ].
  SELECT SINGLE
         bsark,     " Customer purchase order type
         bstzd     " Purchase order number supplement "ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
         FROM vbak " Sales Document: Header Data
*         INTO @DATA(lvv_po_type)  ""ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
         INTO @DATA(lst_vbak_po)   "ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
         WHERE vbeln = @liv_vbrp_po-aubel.
  IF  st_header-bill_cust_number IN r_bpid_ftp " BP ID validation for FTP email trigger
  AND v_output_typ IN  r_output_ftp           " Output type validation for FTP email trigger
*  AND lvv_po_type IN r_po_type_ftp.           " PO type validation for FTP email trigger "ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
   AND lst_vbak_po-bsark IN r_po_type_ftp.           " PO type validation for FTP email trigger "ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
    CLEAR fp_i_emailid[].
* Checking BPID having email ID or not
    IF li_email[] IS NOT INITIAL.
* Should send to BP ID email ID
      LOOP AT li_email INTO lst_email WHERE smtp_addr IS NOT INITIAL.
        lst_emailid-smtp_addr = lst_email-smtp_addr.
        APPEND lst_emailid TO fp_i_emailid.
        CLEAR lst_emailid.
      ENDLOOP. " LOOP AT li_email INTO lst_email
* If BPID does not have email id, should send to account managed forms
    ELSE.
      LOOP AT r_email INTO DATA(lstt_email_id).
        lst_emailid-smtp_addr = lstt_email_id-low.
        APPEND lst_emailid TO fp_i_emailid.
        CLEAR: lst_emailid,lst_email_id.
      ENDLOOP. " LOOP AT r_email INTO DATA(lst_email_id)
    ENDIF.
...
* End of ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923395
* Begin of ADD:OTCM-30892/45037:SGUDA:08-JUL-2021:ED2K924062
  IF lst_vbak_po-bstzd IS NOT INITIAL.
    IF lst_vbak_po-bstzd IN r_supplement_po. " Checking supplementery PO
      v_supplementry_po = lst_vbak_po-bstzd.
      CLEAR: fp_i_emailid[],li_email[].
* Begin of ADD:OTCM-30892/45037:SGUDA:30-SEP-2021:ED2K924644
* Checking AR text having email ID or not
      PERFORM get_ar_text_for_emailid USING liv_vbrp_po-aubel
                                      CHANGING li_email.
* End of ADD:OTCM-30892/45037:SGUDA:30-SEP-2021:ED2K924644
      IF li_email[] IS NOT INITIAL.
** Should send to BP ID email ID
        LOOP AT li_email INTO lst_email WHERE smtp_addr IS NOT INITIAL.
          lst_emailid-smtp_addr = lst_email-smtp_addr.
...
* If BPID does not have email id, should send to account managed forms
      ELSE.
        LOOP AT r_sales_team_email INTO DATA(lstt_sales_team_email).
          lst_emailid-smtp_addr = lstt_sales_team_email-low.
          APPEND lst_emailid TO fp_i_emailid.
          CLEAR: lst_emailid,lstt_sales_team_email.
        ENDLOOP. " LOOP AT r_email INTO DATA(lst_email_id)
      ENDIF.
    ENDIF.
  ENDIF.
...
* Begin of ADD:OTCM-4948:MRAJKUMAR:28-JUNE-2021:ED2K923960
*Receipt should be replaced by  TAXINVOICE as per OTCM-4948 changes
        v_taxinvoice_flag = abap_true.
* End of ADD:OTCM-4948:MRAJKUMAR:28-JUNE-2021:ED2K923960
*   Begin of CHANGE:ERP-4930/ERP-5069:WROY:01-Nov-2017:ED2K909229
...
* BOC by SGUDA on 10/16/2020 for OTCM-14498 with ED2K919939 *
  IF v_seller_reg IS NOT INITIAL.
    SPLIT v_seller_reg AT c_comma INTO v_seller_reg v_seller_reg_1.
    IF v_seller_reg_1 IS NOT INITIAL .
      CONCATENATE v_seller_reg c_comma INTO v_seller_reg.
    ENDIF.
  ENDIF.
* EOC by SGUDA on 10/16/2020 for OTCM-14498 with ED2K919939 *
* Begin of ADD:OTCM-4948:MRAJKUMAR:17-JUNE-2021:ED2K923935
* Check the bill country/ship to country equals to India then print TAX INVOICE instead of
* Receipt and display signature Text also.
* Begin of ADD:OTCM-4948:MRAJKUMAR:02-SEPT-2021:ED2K924460
*  CLEAR v_text_flag.
  CLEAR v_signature_text.
* End of ADD:OTCM-4948:MRAJKUMAR:02-SEPT-2021:ED2K924460
  IF ( st_header-bill_country IN r_bill_ship_country
  OR  st_header-ship_country IN r_bill_ship_country  )
  AND st_vbrk-fkart          IN r_billing_type.
    IF v_taxinvoice_flag EQ abap_true.
      PERFORM f_read_text USING c_name_tax_inv
                          CHANGING v_accmngd_title.
    ENDIF.
* Begin of ADD:OTCM-4948:MRAJKUMAR:02-SEPT-2021:ED2K924460
*    v_text_flag = abap_true.
    IF st_vbrk-vbtyp EQ c_creditmemo.
      v_signature_text = c_creditmemo_text.
    ELSEIF st_vbrk-vbtyp NE c_creditmemo.
      v_signature_text = c_signature_text.
    ENDIF.
* End of ADD:OTCM-4948:MRAJKUMAR:02-SEPT-2021:ED2K924460
  ENDIF.
...
* Begin of ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922413
       lst_billing_date TYPE fkdat.
  lst_billing_date = st_vbrk-fkdat - 1.
* End of ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922413
...
*       date       = st_vbrk-fkdat          " Billing Date  "ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922413
        date       = lst_billing_date         "ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922413
      IMPORTING
...
*         Translate foreign currency amount to local currency
    CALL FUNCTION 'CONVERT_TO_LOCAL_CURRENCY'
      EXPORTING
*       date             = st_vbrk-fkdat          "Currency translation date "ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922413
        date             = lst_billing_date         "ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922413
...
*- Begin of ADD:OTCM-42834 INC0333245:SGUDA:30-SEP-2021:ED2K924663
  IF st_header-doc_currency IN r_currency_from AND  v_waers IN r_currency_to.
...
* Begin of ADD:OTCM-52198:SGUDA:01-JUL-2022:ED2K927848
          IF v_vkorg IN r_sales_org_pq.
            READ TABLE i_vbkd INTO DATA(lst_vbkd_pq) WITH KEY vbeln = lst_vbrp_core-aubel
                                                              posnr = lst_vbrp_core-aupos.
            IF sy-subrc EQ 0 AND lst_vbkd_pq-bsark IN r_po_type_pq.
              READ TABLE i_vbap INTO DATA(lst_vbap_pq) WITH KEY vbeln = lst_vbrp_core-aubel
                                                                posnr = lst_vbrp_core-aupos.
              IF sy-subrc EQ 0 AND lst_vbap_pq-mvgr1 IN r_pub_type_pq.
                TRANSLATE lst_vbap_pq-zzdealtyp TO UPPER CASE.
                IF lst_vbap_pq-zzdealtyp IN r_deal_type_pq.
...
* EOC by SGUDA on 10/16/2020 for OTCM-14498 with ED2K919939 *
* Begin of ADD:OTCM-4948:MRAJKUMAR:17-JUNE-2021:ED2K923935
  " If Billing country or Ship to country is India then  Receipt should
  "replace by TAX INVOICE and Signature text should print
* Begin of ADD:OTCM-4948:MRAJKUMAR:02-SEPT-2021:ED2K924460
*  CLEAR v_text_flag.
  CLEAR v_signature_text.
* End of ADD:OTCM-4948:MRAJKUMAR:02-SEPT-2021:ED2K924460
...
*  <--  p2        text
*----------------------------------------------------------------------*
FORM f_our_tax_validate CHANGING p_li_tax_data TYPE tt_tax_data.
  DATA : lv_indix TYPE sytabix.
* Checking Sales org: 1001 and Your tax ID should not be blank for "EU" Customers
  IF  st_vbrk-vkorg IN r_sales_org_1001 AND st_header-buyer_reg IS NOT INITIAL
    AND st_t005-xegld = c_x."st_header-bill_country IN r_bill_to_country_eu.
    CLEAR lv_indix.
* Clear respective "EU" tax id from internal table
    LOOP AT p_li_tax_data INTO DATA(lst_tax_data_eu) WHERE seller_reg IN r_our_taxid_eu.
      lv_indix = sy-tabix.
      CLEAR lst_tax_data_eu-seller_reg.
      MODIFY p_li_tax_data FROM lst_tax_data_eu INDEX lv_indix TRANSPORTING seller_reg.
      CLEAR: lst_tax_data_eu,lv_indix.
    ENDLOOP.
* Checking Sales org: 3310 and Your tax ID should not be blank for "FR" Customers
  ELSEIF st_vbrk-vkorg IN r_sales_org_3310 AND st_header-buyer_reg IS NOT INITIAL
    AND st_header-bill_country IN r_bill_to_country_fr.
    CLEAR lv_indix.
* Clear respective "FR" tax id from internal table
    LOOP AT p_li_tax_data INTO DATA(lst_tax_data_fr) WHERE seller_reg IN r_our_taxid_fr.
      lv_indix = sy-tabix.
      CLEAR lst_tax_data_fr-seller_reg.
      MODIFY p_li_tax_data FROM lst_tax_data_fr INDEX lv_indix TRANSPORTING seller_reg.
      CLEAR: lst_tax_data_fr,lv_indix.
    ENDLOOP.
  ENDIF.
ENDFORM.
*&---------------------------------------------------------------------*
...
*      -->P_ST_HEADER  text
*----------------------------------------------------------------------*
FORM f_get_t005  USING    p_st_header TYPE zstqtc_header_detail_f024.
  SELECT SINGLE * FROM t005 INTO st_t005
                   WHERE land1 = p_st_header-bill_country.
ENDFORM.
*&---------------------------------------------------------------------*
...
*       text
*----------------------------------------------------------------------*
*      -->P_LIV_VBRP_PO_AUBEL  text
*      <--P_LI_EMAIL  text
*----------------------------------------------------------------------*
FORM get_ar_text_for_emailid  USING    p_liv_vbrp_po_aubel
                              CHANGING p_li_email TYPE tt_email.
...
* Validation for Email ID
      CALL FUNCTION 'SX_INTERNET_ADDRESS_TO_NORMAL'
        ...
        EXCEPTIONS
          ...
          OTHERS               = 4.
      IF sy-subrc EQ 0.
        lsst_email-smtp_addr = lst_tline-tdline.
        CONDENSE lsst_email-smtp_addr.
        APPEND lsst_email TO p_li_email.
        CLEAR lsst_email.
      ENDIF.
    ENDIF.
  ELSE.
...
*      <--P_V_STRING  text
*----------------------------------------------------------------------*
FORM f_get_emrw_orders  USING    p_lst_vbap_tmp TYPE ty_vbap
                        CHANGING p_v_string.
  DATA:lv_text_td     TYPE thead-tdid,
       lv_text_object TYPE thead-tdobject,
       lv_tdname      TYPE thead-tdname,
       lt_line        TYPE TABLE OF tline.
  lv_text_td = '0062'.
  lv_text_object = 'VBBP'.
  CONCATENATE p_lst_vbap_tmp-vbeln p_lst_vbap_tmp-posnr INTO lv_tdname.
  CLEAR lt_line[].
  CALL FUNCTION 'READ_TEXT'
    EXPORTING
      id                      = lv_text_td
