*&---------------------------------------------------------------------*
*& Report  ZQTCR_EDU_PUB_LET_ZLOC3_F055
*&---------------------------------------------------------------------*
* PROGRAM NAME: ZQTCR_EDU_PUB_LET_ZLOC3_F055
...
* DESCRIPTION:
*----------------------------------------------------------------------*
REPORT zqtcr_edu_pub_let_zloc3_f055 NO STANDARD PAGE HEADING.

TYPE-POOLS: szadr.
*- Top include
INCLUDE ZQTCN_EDU_PUB_LET_ZLC3_TOP.
*INCLUDE ZQTCN_EDU_PUB_LET_ZLOC3_TOP.
...
INCLUDE ZQTCN_EDU_PUB_LET_ZLC3_F01.
*INCLUDE ZQTCN_EDU_PUB_LET_ZLOC3_F01.
