...
* REFERENCE NO: ERPM-16179/OTCM-20007/OTCM-14498
* DEVELOPER:    Siva Guda (SGUDA) / Lahiru Wathudura(LWATHUDURA)
* DATE:         10/16/2020
* DESCRIPTION: Multiple Po number display/new output for cancelled
*              invoice and cancelled credit memo/Display mutiple tax Id's
*----------------------------------------------------------------------*
* REVISION NO:  ED2K920889
* REFERENCE NO: OTCM-30721
* DEVELOPER:    Siva Guda (SGUDA)
* DATE:         12/16/2020
* DESCRIPTION:  Need the ability to provide an invoice/receipt form for
*               ZADR doc type in order to collect payments for our
*               aquired subs
*----------------------------------------------------------------------*
* REVISION NO:  ED1K912690 / ED1K912783
* REFERENCE NO: PRB0047137
* DEVELOPER:    Nikhilesh Palla (NPALLA)
* DATE:         02/16/2021
* DESCRIPTION: Direct Debit Mandate incorrectly received with society
*              Offline invoice
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-31644
* REFERENCE NO:  ED2K922411
* DEVELOPER   :  SGUDA
* DATE        :  03/09/2021
* DESCRIPTION :  Exchange Rates Alignment between Batch and Manual Invoices
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-39738
* REFERENCE NO:  ED2K922411
* DEVELOPER   :  SGUDA
* DATE        :  03/15/2021
* DESCRIPTION :  ZTBT output for 0160 PO type(FTP) to be sent to generic
*                Account Managed e-mail address "AccountManagedForms@wiley.com"
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-39738/INC0352240
* REFERENCE NO:  ED2K922842
* DEVELOPER   :  SGUDA
* DATE        :  04/01/2021
* DESCRIPTION :  Reported Issue: If PO number is  "0160", CMR/Invoice documents should send
* to Account Managed email(AccountManagedForms@wiley.com) instead of BP Email ID,
* but few of the cases it's not happening.
* As per my analysis with few documents ( Invoice / CMR), PO number is
* not determining correctly from sales document header table( VBAK) due
* to VBFA internal table entries are deleting randomly with delete statement.
* This issue is in existing production.
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
...
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-52516/52531
* REFERENCE NO:   ED2K924824
* DEVELOPER   :  Murali (mimmadiset)
* DATE        :  09/OCT/2021
* DESCRIPTION : Adding the change for J&J Ed project for output type ZJJI
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
...
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-55199 / Post Egret Changes
* REFERENCE NO:  ED2K925786
* DEVELOPER   :  Sivareddy Guda (sguda)
* DATE        :  2/14/2022
* DESCRIPTION :  Email verbiage changes for ZMAI output
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-54290 / Post jji changes
* REFERENCE NO:  ED2K925875
* DEVELOPER   :  Murali (mimmadiset)
* DATE        :  2/23/2022
* DESCRIPTION : JJI output type changes for description
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-55203 / Post EGRET changes
* REFERENCE NO:  ED2K925904
* DEVELOPER   :  Sivareddy Guda (sguda)
* DATE        :  02/28/2022
* DESCRIPTION : ZMAI Logo changes
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-48718/OTCM-60474
* REFERENCE NO:  ED2K926474
* DEVELOPER   :  Sivareddy Guda (SGUDA)
* DATE        :  03/31/2022
* DESCRIPTION : Form changes on header for email change and at footer
*               the credit card information was removed
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-61258
* REFERENCE NO:  ED2K926836
* DEVELOPER   :  Murali (mimmadiset)
* DATE        :  04/14/2022
* DESCRIPTION : Form changes for customer material text in Oable project
*----------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-61258
...
*&---------------------------------------------------------------------*
* REVISION HISTORY-----------------------------------------------------*
* REVISION NO :  OTCM-55199/OTCM-65018
* REFERENCE NO:  ED2K927542
* DEVELOPER   :  Sivareddy Guda (SGUDA)
* DATE        :  06/06/2022
* DESCRIPTION : Egret Post Deployment Requirements - Commented Billing plan date
*&---------------------------------------------------------------------*
...
*End   of DEL:ERP-6712:WROY:22-Feb-2018:ED2K911002
  ...
  ELSEIF v_output_typ EQ v_outputyp_tbt OR v_output_typ = v_outputyp_jji "++mimmadiset OTCM-52516 ED2K924824
    OR v_output_typ IN r_kschl.         "++mimmadiset OTCM-54509 ED2K925058,ED2K925180
...
*- End of OTCM-40086:SGUDA:15-SEP-2021:ED2K924580
          ...
          abrbg  "settlement period  ++mimmadiset OTCM-54509 ED2K925058,ED2K925180
...
* Fetch Sales Document Flow from VBFA table
  SELECT vbelv " Preceding sales and distribution document
         ...
         vbtyp_n "Document category of subsequent document     " SGUDA on 04/01/2021 for OTCM-39738/INC0352240 with ED2K922842
         vbtyp_v " Document category of preceding SD document  " SGUDA on 04/01/2021 for OTCM-39738/INC0352240 with ED2K922842
         stufe " Level of the document flow record             " SGUDA on 04/01/2021 for OTCM-39738/INC0352240 with ED2K922842
  ...
  IF sy-subrc EQ 0.
    ...
    " Entries should be delete if  document flow record(VBAK-STUFE) is not equal to blank, to get next preceding document.
    DELETE li_vbfa WHERE stufe NE space.        " SGUDA on 04/01/2021 for OTCM-39738/INC0352240 with ED2K92284"
    " Entries should be delete if Document category of preceding SD document (VBAK-VBTYP_V) to get cancelled documents processing
    DELETE li_vbfa WHERE  vbtyp_v = c_doc_cat.  " SGUDA on 04/01/2021 for OTCM-39738/INC0352240 with ED2K922842
...
*  BOC by SRBOSE on 11-DEC-2017 #TR: ED2K909786
           ...
           bsark, "Customer purchase order type "SGUDA on 03/15/2021 for OTCM-39738 with ED2K922543
...
*  BOC by SRBOSE on 19-Jan-2018 #TR: ED2K910373
        ...
        st_header-po_type = lst_vbak-bsark. "SGUDA on 03/15/2021 for OTCM-39738 with ED2K922543
*  BOC by SRBOSE on 19-Jan-2018 #TR: ED2K910373
*       Begin of DEL:ERP-6712:WROY:22-Feb-2018:ED2K911002
...
*    DATA(li_vbkd_tmp) = fp_i_vbkd[].
*    SORT li_vbkd_tmp BY bstkd.
*    CLEAR v_po_lines.
*    DELETE ADJACENT DUPLICATES FROM li_vbkd_tmp COMPARING bstkd.
*    DESCRIBE TABLE li_vbkd_tmp LINES DATA(lv_po_lines).
*    IF lv_po_lines GT 1.
*      PERFORM f_read_text USING c_multiple_po
*                          CHANGING v_po_text.
*      CONDENSE v_po_text.
*      fp_st_header-po_number = v_po_text.
*      v_po_lines = c_x.
*    ELSE.
...
* Constant Declaration
  CONSTANTS : lc_bill_type_inv      TYPE rvari_vnam VALUE 'BILL_TYPE_INV', " ABAP: Name of Variant Variable
              ...
              lc_jji_type           TYPE rvari_vnam VALUE 'JJI',           " ZJJI output type++ mimmadiset OTCM-52516 ED2K924824
...
* BOC by SGUDA on 03/15/2021 for OTCM-39738 with ED2K922543
              lc_ftp_email          TYPE rvari_vnam VALUE 'FTP_EMAIL',
              lc_ftp_po_type        TYPE rvari_vnam VALUE 'PO_TYPE',
              lc_ftp_output_type    TYPE rvari_vnam VALUE 'OUTPUT_TYPE',
* EOC by SGUDA on 03/15/2021 for OTCM-39738 with ED2K922543
* Begin of ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923401
              lc_bpid_ftp           TYPE rvari_vnam VALUE 'BPID_FTP',
* End of ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923401
*- Begin of OTCM-40086:SGUDA:15-SEP-2021:ED2K924580
...
*- Begin of ADD:OTCM-48718/OTCM-60474:SGUDA:31-MAR-2022:ED2K926474
              lc_ind_sales_office   TYPE rvari_vnam VALUE 'IND_SALES_OFFICE',
              lc_ind_po_type        TYPE rvari_vnam VALUE 'IND_PO_TYPE',
              lc_ind_output         TYPE rvari_vnam VALUE 'IND_OUTPUT',
*- End of ADD:OTCM-48718/OTCM-60474:SGUDA:31-MAR-2022:ED2K926474
*** Boc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
              lc_mai_type           TYPE rvari_vnam VALUE 'KSCHL_ALL',     "All new output types
              lc_cust_kschl         TYPE rvari_vnam VALUE 'CUST_SRV_KSCHL', "Cust service mail id information for all new o/p type
*** Eoc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
              lc_logo               TYPE rvari_vnam VALUE 'LOGO', "++OTCM-54796 ED2K925511 MIMMADISET 1/11/2022
              lc_body               TYPE rvari_vnam VALUE 'EMAILBODY', "++OTCM-54719 ED2K925511 MIMMADISET 1/11/2022
              lc_logo_col           TYPE rvari_vnam VALUE 'LOGO_COL', " ADD:OTCM-55203:SGUDA:28-FEB-2022:ED2K925904
              lc_inv_des            TYPE rvari_vnam  VALUE 'INV_DESC'. " ++mimmadiset OTCM-61258 05/06/2022 ED2K927184
...
*** Boc 10/08/2021 mimmadiset OTCM-52516  ED2K924824
      IF lst_constant-param1 EQ  lc_jji_type.
        v_outputyp_jji = lst_constant-low.
      ENDIF." IF lst_constant-param1 EQ lc_JJI_TYPE
*** Eoc 10/08/2021 mimmadiset OTCM-52516  ED2K924824
*** Boc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
      IF lst_constant-param1 EQ  lc_mai_type.
        APPEND INITIAL LINE TO r_kschl ASSIGNING FIELD-SYMBOL(<lst_kschl>).
        <lst_kschl>-sign   = lst_constant-sign.
        <lst_kschl>-option = lst_constant-opti.
        <lst_kschl>-low    = lst_constant-low.
        <lst_kschl>-high   = lst_constant-high.
      ENDIF." IF lst_constant-param1 EQ lc_MAI_TYPE
      IF lst_constant-param1 EQ  lc_cust_kschl.
        APPEND INITIAL LINE TO r_cust_srv ASSIGNING FIELD-SYMBOL(<lst_cu_kschl>).
        <lst_cu_kschl>-sign   = lst_constant-sign.
        <lst_cu_kschl>-option = lst_constant-opti.
        <lst_cu_kschl>-low    = lst_constant-low.
        <lst_cu_kschl>-high   = lst_constant-high.
      ENDIF." IF lst_constant-param1 EQ lc_MAI_TYPE
*** Eoc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
**BOC OTCM-54796 ED2K925511 MIMMADISET 1/18/2022
      IF lst_constant-param1 EQ  lc_logo.
        APPEND INITIAL LINE TO r_kschl_logo ASSIGNING FIELD-SYMBOL(<lst_logo>).
        <lst_logo>-sign   = lst_constant-sign.
        <lst_logo>-option = lst_constant-opti.
        <lst_logo>-low    = lst_constant-low.
        <lst_logo>-high   = lst_constant-high.
      ENDIF." IF lst_constant-param1 EQ lc_LOGO
      IF lst_constant-param1 EQ  lc_body. "Email body
        APPEND INITIAL LINE TO r_kschl_body ASSIGNING FIELD-SYMBOL(<lst_body>).
        <lst_body>-sign   = lst_constant-sign.
        <lst_body>-option = lst_constant-opti.
        <lst_body>-low    = lst_constant-low.
        <lst_body>-high   = lst_constant-high.
      ENDIF." IF lst_constant-param1 EQ lc_BODY
**EOC OTCM-54796 ED2K925511 MIMMADISET 1/11/2022
*++mimmadiset OTCM-61258 05/06/2022 ED2K927184
      IF lst_constant-param1 EQ  lc_inv_des. "Invoice
        APPEND INITIAL LINE TO r_kschl_inv ASSIGNING FIELD-SYMBOL(<lst_inv>).
        <lst_inv>-sign   = lst_constant-sign.
        <lst_inv>-option = lst_constant-opti.
        <lst_inv>-low    = lst_constant-low.
        <lst_inv>-high   = lst_constant-high.
...
* EOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
* BOC by SGUDA on 03/15/2021 for OTCM-39738 with ED2K922543
      IF lst_constant-param1 EQ lc_ftp_email.
        APPEND INITIAL LINE TO r_ftp_email ASSIGNING FIELD-SYMBOL(<lfs_ftp_email>).
        <lfs_ftp_email>-sign   = lst_constant-sign.
        <lfs_ftp_email>-option   = lst_constant-opti.
        <lfs_ftp_email>-low    = lst_constant-low.
        <lfs_ftp_email>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_ftp_po_type.
        APPEND INITIAL LINE TO r_ftp_po_type ASSIGNING FIELD-SYMBOL(<lfs_ftp_po_type>).
        <lfs_ftp_po_type>-sign   = lst_constant-sign.
        <lfs_ftp_po_type>-option   = lst_constant-opti.
        <lfs_ftp_po_type>-low    = lst_constant-low.
        <lfs_ftp_po_type>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_ftp_output_type.
        APPEND INITIAL LINE TO r_ftp_output_type ASSIGNING FIELD-SYMBOL(<lfs_ftp_output_type>).
        <lfs_ftp_output_type>-sign   = lst_constant-sign.
        <lfs_ftp_output_type>-option   = lst_constant-opti.
        <lfs_ftp_output_type>-low    = lst_constant-low.
        <lfs_ftp_output_type>-high   = lst_constant-high.
      ENDIF.
* EOC by SGUDA on 03/15/2021 for OTCM-39738 with ED2K922543
* Begin of ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923401
      IF lst_constant-param1 EQ lc_bpid_ftp.
        APPEND INITIAL LINE TO r_ftp_bpid ASSIGNING FIELD-SYMBOL(<lfs_ftp_bpid>).
        <lfs_ftp_bpid>-sign   = lst_constant-sign.
        <lfs_ftp_bpid>-option = lst_constant-opti.
        <lfs_ftp_bpid>-low    = lst_constant-low.
        <lfs_ftp_bpid>-high   = lst_constant-high.
      ENDIF.
...
*- Begin of OTCM-40086:SGUDA:15-SEP-2021:ED2K924580
      IF lst_constant-param1 EQ lc_print.
        APPEND INITIAL LINE TO r_print_media_product ASSIGNING FIELD-SYMBOL(<lst_print_media_product>).
        <lst_print_media_product>-sign   = lst_constant-sign.
        <lst_print_media_product>-option = lst_constant-opti.
        <lst_print_media_product>-low    = lst_constant-low.
        <lst_print_media_product>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_digital.
        APPEND INITIAL LINE TO r_digital_media_product ASSIGNING FIELD-SYMBOL(<lst_digital_media_product>).
        <lst_digital_media_product>-sign   = lst_constant-sign.
        <lst_digital_media_product>-option = lst_constant-opti.
        <lst_digital_media_product>-low    = lst_constant-low.
        <lst_digital_media_product>-high   = lst_constant-high.
      ENDIF.
*- End of OTCM-40086:SGUDA:15-SEP-2021:ED2K924580
*- Begin of ADD:OTCM-42834 INC0333245:SGUDA:30-SEP-2021:ED2K924649
      ...
      ENDIF.
*- End of ADD:OTCM-42834 INC0333245:SGUDA:30-SEP-2021:ED2K924649
*- Begin of ADD:OTCM-55203:SGUDA:28-FEB-2022:ED2K925904
      IF lst_constant-param1 EQ lc_logo_col.
        APPEND INITIAL LINE TO r_logo_col ASSIGNING FIELD-SYMBOL(<lst_logo_col>).
        <lst_logo_col>-sign   = lst_constant-sign.
        <lst_logo_col>-option = lst_constant-opti.
        <lst_logo_col>-low    = lst_constant-low.
        <lst_logo_col>-high   = lst_constant-high.
      ENDIF.
*- End of ADD:OTCM-55203:SGUDA:28-FEB-2022:ED2K925904
*- Begin of ADD:OTCM-48718/OTCM-60474:SGUDA:31-MAR-2022:ED2K926474
      IF lst_constant-param1 EQ lc_ind_sales_office.
        APPEND INITIAL LINE TO r_ind_sales_office ASSIGNING FIELD-SYMBOL(<lst_ind_sales_office>).
        <lst_ind_sales_office>-sign   = lst_constant-sign.
        <lst_ind_sales_office>-option = lst_constant-opti.
        <lst_ind_sales_office>-low    = lst_constant-low.
        <lst_ind_sales_office>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_ind_po_type.
        APPEND INITIAL LINE TO r_ind_po_type ASSIGNING FIELD-SYMBOL(<lst_ind_po_type>).
        <lst_ind_po_type>-sign   = lst_constant-sign.
        <lst_ind_po_type>-option = lst_constant-opti.
        <lst_ind_po_type>-low    = lst_constant-low.
        <lst_ind_po_type>-high   = lst_constant-high.
      ENDIF.
      IF lst_constant-param1 EQ lc_ind_output.
        APPEND INITIAL LINE TO r_ind_output ASSIGNING FIELD-SYMBOL(<lst_ind_output>).
        <lst_ind_output>-sign   = lst_constant-sign.
        <lst_ind_output>-option = lst_constant-opti.
        <lst_ind_output>-low    = lst_constant-low.
        <lst_ind_output>-high   = lst_constant-high.
      ENDIF.
*- End of ADD:OTCM-48718/OTCM-60474:SGUDA:31-MAR-2022:ED2K926474
      CLEAR lst_constant.
...
* BOC by SGUDA on 03/15/2021 for OTCM-39738 with ED2K922543
  IF st_header-po_type IN r_ftp_po_type AND v_output_typ  IN r_ftp_output_type.
    CLEAR : fp_i_emailid[].
* Begin of ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923401
    IF st_header-bill_cust_number IN r_ftp_bpid
      AND li_email[] IS NOT INITIAL.
* Get email address in table
      LOOP AT li_email INTO lst_email.
        lst_emailid-smtp_addr = lst_email-smtp_addr.
        APPEND lst_emailid TO fp_i_emailid.
    ...
    ELSE.
* End of ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923401
      LOOP AT r_ftp_email INTO DATA(lst_ftp_email).
        lst_emailid-smtp_addr = lst_ftp_email-low.
        APPEND lst_emailid TO fp_i_emailid.
        CLEAR lst_emailid.
      ENDLOOP.
    ENDIF. "ADD:OTCM-45440:SGUDA:12-MAY-2021:ED2K923401
  ENDIF.
* EOC by SGUDA on 03/15/2021 for OTCM-39738 with ED2K922543
ENDFORM.
*&---------------------------------------------------------------------*
...
* BOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
      ELSEIF lv_fees GT 0 AND fp_st_vbrk-vbtyp IN r_cinv.
        lv_minus_flag = abap_true.
        PERFORM f_value_change USING lv_fees st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_css-amount.
      ELSEIF fp_st_vbrk-vbtyp IN r_ccrd.
        lv_minus_flag = abap_false.
        PERFORM f_value_change USING lv_fees st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_css-amount.
* EOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
...
* BOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
      ELSEIF lv_disc GT 0 AND fp_st_vbrk-vbtyp IN r_cinv.
        lv_minus_flag = abap_false.
        PERFORM f_value_change USING lv_disc st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_css-discount.
      ELSEIF fp_st_vbrk-vbtyp IN r_ccrd.
        lv_minus_flag = abap_false.
        PERFORM f_value_change USING lv_disc st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_css-discount.
...
* BOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
        ELSEIF lv_tax GT 0 AND fp_st_vbrk-vbtyp IN r_cinv.
          lv_minus_flag = abap_true.
          PERFORM f_value_change USING lv_tax st_header-doc_currency lv_minus_flag
                                 CHANGING lst_final_css-tax.
        ELSEIF fp_st_vbrk-vbtyp IN r_ccrd.
          lv_minus_flag = abap_false.
          PERFORM f_value_change USING lv_tax st_header-doc_currency lv_minus_flag
                                 CHANGING lst_final_css-tax.
...
* BOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
      ELSEIF lv_total_val GT 0 AND fp_st_vbrk-vbtyp IN r_cinv.
        lv_minus_flag = abap_true.
        PERFORM f_value_change USING lv_total_val st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_css-total.
      ELSEIF fp_st_vbrk-vbtyp IN r_ccrd.
        lv_minus_flag = abap_false.
        PERFORM f_value_change USING lv_total_val st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_css-total.
...
*        CONCATENATE lc_first lst_final_css-amount lc_second INTO lst_final_css-amount.
          CONCATENATE '-' lst_final_css-amount INTO lst_final_css-amount.
* BOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
        ELSEIF fp_st_vbrk-vbtyp IN r_cinv.      " cancelled invoice
          lv_minus_flag = abap_true.
          PERFORM f_value_change USING lst_vbrp-kzwi4 st_header-doc_currency lv_minus_flag
                                 CHANGING lst_final_css-amount.
...
* BOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
        ELSEIF  fp_st_vbrk-vbtyp IN r_cinv.
          lv_minus_flag = abap_true.
          PERFORM f_value_change USING lv_total_shipping st_header-doc_currency lv_minus_flag
                                 CHANGING lst_final_css-total.
        ELSEIF fp_st_vbrk-vbtyp IN r_ccrd.
          lv_minus_flag = abap_false.
          PERFORM f_value_change USING lv_total_shipping st_header-doc_currency lv_minus_flag
...
*- Begin of OTCM-40086:SGUDA:15-SEP-2021:ED2K924580
        IF lst_vbrp-uepos IS INITIAL.
          DATA(li_all_media_product) =  i_vbrp[].
          CLEAR: lst_digital,lst_print,li_print_media_product[],li_digital_media_product[].
          LOOP AT li_all_media_product INTO DATA(lst_all_media) WHERE uepos = lst_vbrp-posnr.
            IF lst_all_media-mvgr4 IN r_print_media_product.
              MOVE-CORRESPONDING lst_all_media TO lst_print.
              APPEND lst_print TO li_print_media_product.
              CLEAR lst_print.
            ENDIF.
            IF lst_all_media-mvgr4 IN r_digital_media_product.
...
* BOC by SGUDA on 10/16/2020 for OTCM-16179 with ED2K919951 *
*    IF v_po_lines IS NOT INITIAL.
*      SORT i_vbkd BY vbeln posnr.
*      READ TABLE i_vbkd INTO DATA(lst_vbkd_po) WITH KEY vbeln = lst_vbrp-vgbel
*                                                        posnr = lst_vbrp-vgpos
*                                               BINARY SEARCH.
*      IF sy-subrc EQ 0.
*        PERFORM f_read_text USING c_po_number
*                            CHANGING v_po_text.
*        CONDENSE v_po_text.
*        CONCATENATE v_po_text lst_vbkd_po-bstkd INTO lst_final_css-desc_advertiser SEPARATED BY space.
*        APPEND lst_final_css TO fp_i_final_css.
*      ENDIF.
*    ENDIF.
* EOC by SGUDA on 10/16/2020 for OTCM-16179 with ED2K919951 *
...
* End of ADD:OTCM-4948:MRAJKUMAR:02-SEPT-2021:ED2K924466
* End of ADD:OTCM-4948:MRAJKUMAR:17-JUNE-2021:ED2K923935
          im_v_suppress_credit_card = v_suppress_credit_card "ADD:OTCM-48718/OTCM-60474:SGUDA:31-MAR-2022:ED2K926474
        IMPORTING
          /1bcdwb/formoutput        = st_formoutput
        EXCEPTIONS
          usage_error               = 1
...
*              lc_soc_footer       TYPE char30     VALUE 'ZQTC_F027_FOOTER_',          " Footer of type CHAR20
              lc_soc_footer       TYPE char30     VALUE 'ZQTC_F042_FOOTER_',          " Footer of type CHAR20
              ...
              lc_st               TYPE thead-tdid     VALUE 'ST',                     "Text ID of text to be read
              lc_object           TYPE thead-tdobject VALUE 'TEXT',                   "Object of text to be read
              lc_bank             TYPE thead-tdname   VALUE 'ZQTC_F042_BANK_DETAILS_1001_USD', "ADD:OTCM-51284/FMM-5645:SGUDA:12-Nov-2021:ED1K913785
              lc_remit            TYPE thead-tdname   VALUE 'ZQTC_F042_CHECK_DETAILS_1001_USD'. "ADD:OTCM-51284/FMM-5645:SGUDA:12-Nov-2021:ED1K913785
...
* Retrieve all the standard text names
  DATA(liv_vbrp) = i_vbrp[ 1 ]. "OTCM-51284/FMM-5645:SGUDA:12-Nov-2021:ED1K913785
  IF v_output_typ EQ v_outputyp_css.
* Fetch Remit to text
    CONCATENATE lc_css_remit_to
           ...
           INTO fp_v_remit_to.
* Begin of ADD:OTCM-51284/FMM-5645:SGUDA:12-Nov-2021:ED1K913785
    IF fp_st_vbrk-bukrs IN r_comp_code AND fp_st_vbrk-waerk IN  r_docu_currency  AND liv_vbrp-vkbur IN r_sales_office.
      CLEAR fp_v_remit_to.
...
*    CONCATENATE lst_line-tdline fp_st_header-doc_currency INTO fp_v_shipping SEPARATED BY space. ""Commeneted by NRMODUGU ERPM-2190
  ...
  ENDLOOP. " LOOP AT i_txtmodule INTO lst_line
*- Begin of ADD:OTCM-48718/OTCM-60474:SGUDA:31-MAR-2022:ED2K926474
  IF liv_vbrp-vkbur IN r_ind_sales_office "sales office is 0080
     AND st_header-po_type IN r_ind_po_type "PO Type is 0161
     AND nast-kschl IN r_ind_output. "Output type ZTBT
    fp_v_cust_service_det = c_india_po_sales_text.
    v_suppress_credit_card = c_x.
  ELSE.
    CLEAR v_suppress_credit_card.
  ENDIF.
*- End of ADD:OTCM-48718/OTCM-60474:SGUDA:31-MAR-2022:ED2K926474
**********************************************************************
...
* Begin of ADD:OTCM-30721:SGUDA:16-DEC-2020:ED2K920889
...
*   Fetch title text for invoice
      PERFORM f_read_text    USING c_name_inv
                          CHANGING fp_v_accmngd_title.
    ENDIF. " IF fp_st_header-comp_code IN r_country
* End of ADD:OTCM-30721:SGUDA:16-DEC-2020:ED2K920889
  ENDIF. " IF fp_st_vbrk-vbtyp IN r_inv

* BOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
  IF fp_st_vbrk-vbtyp IN r_cinv.
    PERFORM f_read_text USING c_can_inv    " Cancelled invoice
                        CHANGING fp_v_accmngd_title.
  ELSEIF fp_st_vbrk-vbtyp IN r_ccrd.
    PERFORM f_read_text USING c_can_crd_note    "Tax INvoice" when Credit memo is cancelled
                      CHANGING fp_v_accmngd_title.
  ENDIF.
  ...
  IF st_vbrk-vbtyp IN r_cinv OR st_vbrk-vbtyp IN r_ccrd.  " Display the original document againt the canceled document
    PERFORM f_read_text    USING c_org_doc
                           CHANGING v_title.
    CONCATENATE v_title st_header-orignal_doc INTO v_title SEPARATED BY space.
  ENDIF.
* EOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
...
*Begin of ADD:OTCM-4948:MRAJKUMAR:28-JUNE-2021:ED2K923958
      "Receipt should be replaced by TAXINVOICE
      v_taxinvoice_flag = abap_true.
*End of ADD:OTCM-4948:MRAJKUMAR:28-JUNE-2021:ED2K923958
*   Begin of CHANGE:ERP-4930/ERP-5069:WROY:01-Nov-2017:ED2K909227
...
* BOC by SGUDA on 10/16/2020 for OTCM-14498 with ED2K919951 *
  IF v_seller_reg IS NOT INITIAL.
    SPLIT v_seller_reg AT c_comma INTO v_seller_reg v_seller_reg_1 v_seller_reg_2.
...
* End of ADD:OTCM-4948:MRAJKUMAR:02-SEPT-2021:ED2K924466
  ...
  AND st_header-bill_type   IN r_billing_type.
...
****EOC by MODUTTA on 13/11/2017 for JIRA# 5069
*** Boc 10/08/2021 mimmadiset OTCM-52516 ED2K924824
  IF v_output_typ = v_outputyp_jji.
*    v_crdt_card_det = c_jji_crd_card_det. "Commented by RBRAHMADI ED2K924901
    v_cust_service_det = c_jji_cust_service.
  ENDIF.
***Eoc 10/08/2021 mimmadiset OTCM-52516 ED2K924824
**BOC OTCM-54796 ED2K925511 MIMMADISET 1/11/2022
  IF v_output_typ IN r_kschl_logo AND
    r_kschl_logo IS NOT INITIAL.
*  * Subroutine to populate logo based on the output type
    PERFORM f_populate_logo_jj CHANGING v_society_logo.
  ENDIF.
**EOC OTCM-54796 ED2K925511 MIMMADISET 1/11/2022
*** Boc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
  IF v_output_typ IN r_cust_srv AND
     r_cust_srv IS NOT INITIAL.
    v_cust_service_det = c_mai_cust_service && v_output_typ.
  ENDIF.
*** Eoc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
**  BOC by MODUTTA on 22/01/2018 for CR# TBD
  DATA(lv_paid_amt) = v_paid_amt.
...
*     Subroutine to fetch text value of receipt
        PERFORM f_read_text    USING c_name_receipt
                            CHANGING v_accmngd_title.
*Begin of ADD:OTCM-4948:MRAJKUMAR:28-JUNE-2021:ED2K923935
        "Receipt should be replaced by TAXINVOICE
        v_taxinvoice_flag = abap_true.
*End of ADD:OTCM-4948:MRAJKUMAR:28-JUNE-2021:ED2K923935
*   Begin of CHANGE:ERP-4930/ERP-5069:WROY:01-Nov-2017:ED2K909227
      ENDIF. " IF st_header-credit_flag IS INITIAL AND
*   End   of CHANGE:ERP-4930/ERP-5069:WROY:01-Nov-2017:ED2K909227
* BOC: CR#7431&7189  KKRAVURI20181109  ED2K913809
...
* BOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
      ELSEIF lv_disc GT 0 AND fp_st_vbrk-vbtyp  IN r_cinv. " Cancelled invoice
        lv_minus_flag = abap_false.
        PERFORM f_value_change USING lv_disc st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_tbt-discount.
      ELSEIF fp_st_vbrk-vbtyp IN r_ccrd.                  " cancelled credit memo
        lv_minus_flag = abap_false.
        PERFORM f_value_change USING lv_disc st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_tbt-discount.
...
* BOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
      ELSEIF lv_total GT 0 AND fp_st_vbrk-vbtyp IN r_cinv.      " Cancelled invoice
        lv_minus_flag = abap_true.
        PERFORM f_value_change USING lv_total st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_tbt-total.
      ELSEIF fp_st_vbrk-vbtyp IN r_ccrd.                  "  Cancelled credit memo
        lv_minus_flag = abap_false.
        PERFORM f_value_change USING lv_total st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_tbt-total.
...
*************EOC by SRBOSE on 08/08/2017 for CR# 408****************
*** Boc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
    IF v_output_typ IN r_cust_srv AND r_cust_srv IS NOT INITIAL.
      lst_final_tbt-item = lst_vbrp-posnr.
    ENDIF.
*** Eoc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
...
*                            CHANGING v_po_text.
*        CONDENSE v_po_text.
*        CONCATENATE v_po_text lst_vbkd_po-bstkd INTO lst_final_tbt-subs_type SEPARATED BY space.
*        APPEND lst_final_tbt TO fp_i_final_tbt.
*      ENDIF.
*    ENDIF.
* Boc 10/08/2021 mimmadiset OTCM-52516 ED2K924824
    IF v_output_typ = v_outputyp_jji.
      PERFORM f_populate_jji_item   USING lst_vbrp
                                   CHANGING fp_i_final_tbt.
    ENDIF.
* Eoc 10/08/2021 mimmadiset OTCM-52516 ED2K924824
*** Boc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
    IF v_output_typ IN r_cust_srv AND r_cust_srv IS NOT INITIAL.
      PERFORM f_populate_mai_item   USING lst_vbrp
                                   CHANGING fp_i_final_tbt.
    ENDIF.
*** eoc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
* EOC by SGUDA on 10/16/2020 for OTCM-16179 with ED2K919951 *
...
* BOC by NPALLA on 02/16/2021 for PRB0047137 with ED1K912690 *
*  READ TABLE i_vbrp INTO DATA(lst_vbrp) INDEX 1.
  DATA(li_vbrp_tmp) = i_vbrp.
  SORT li_vbrp_tmp BY vbeln posnr.
  READ TABLE li_vbrp_tmp INTO DATA(lst_vbrp) WITH KEY vbeln = st_vbrk-vbeln
                                                      BINARY SEARCH.
* EOC by NPALLA on 02/16/2021 for PRB0047137 with ED1K912690 *
...
* End of ADD:OTCM-4948:MRAJKUMAR:02-SEPT-2021:ED2K924466
  ...
  OR st_header-ship_country IN r_bill_ship_country )
  AND st_header-bill_type   IN r_billing_type.
    IF v_taxinvoice_flag = abap_true.
      PERFORM f_read_text USING c_name_tax_inv
                          CHANGING v_accmngd_title.
    ENDIF.
* Begin of ADD:OTCM-4948:MRAJKUMAR:02-SEPT-2021:ED2K924466
...
* BOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
      ELSEIF lv_disc GT 0 AND fp_st_vbrk-vbtyp IN r_cinv.   " Cancelled invoice
        lv_minus_flag = abap_false.
        PERFORM f_value_change USING lv_disc st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_soc-discount.
      ELSEIF fp_st_vbrk-vbtyp IN r_ccrd.                    " Credit memo cancellation
        lv_minus_flag = abap_false.
        PERFORM f_value_change USING lv_disc st_header-doc_currency lv_minus_flag
                               CHANGING lst_final_soc-discount.
...
*                            CHANGING v_po_text.
*        CONDENSE v_po_text.
*        CONCATENATE v_po_text lst_vbkd_po-bstkd INTO lst_final_soc-description  SEPARATED BY space.
*        APPEND lst_final_soc TO fp_i_final_soc.
*      ENDIF.
*    ENDIF.
* EOC by SGUDA on 10/16/2020 for OTCM-16179 with ED2K919951 *
...
*** Email body and subject change for new M&A output types
**BOC OTCM-54719 ED2K925511 MIMMADISET 1/11/2022
  IF v_output_typ IN r_kschl_body AND
    r_kschl_body IS NOT INITIAL AND v_output_typ IS NOT INITIAL.
    IF st_vbrk-vbtyp IN r_inv.
****Populate the email body for new M&A output types (ZJJI) for invoice
      DATA(lv_body_tdname) = c_ma_body.
      lv_body_tdname = lv_body_tdname && v_output_typ && c_inv.
****Populate the email subject for new M&A output types (ZJJI) for invoice
      DATA(lv_sub_tdnameinv) = c_ma_sub.
      lv_sub_tdnameinv = lv_sub_tdnameinv && v_output_typ && c_inv.
      PERFORM f_read_text USING lv_sub_tdnameinv
                          CHANGING lv_title.
      lv_subject = lv_title.
* Begin of ADD:OTCM-55199:SGUDA:14-FEB-2022:ED2K925786
      IF lv_subject CS '@'.
        REPLACE ALL OCCURRENCES OF '@'  IN lv_subject WITH st_header-invoice_number.
      ENDIF.
* End of ADD:OTCM-55199:SGUDA:14-FEB-2022:ED2K925786
      CLEAR:lv_sub_tdnameinv.
    ELSEIF st_vbrk-vbtyp IN r_crd.
****Populate the email body for new M&A output types (ZJJI) for credit memo
      lv_body_tdname = c_ma_body.
      lv_body_tdname = lv_body_tdname && v_output_typ && c_cr.
****Populate the email subject for new M&A output types (ZJJI) for credit memo
      DATA(lv_sub_tdname) = c_ma_sub.
      lv_sub_tdname = lv_sub_tdname && v_output_typ && c_cr.
      PERFORM f_read_text USING lv_sub_tdname
                          CHANGING lv_title.
      lv_sub = lv_title.
      CONCATENATE lv_sub st_header-invoice_number INTO lv_subject SEPARATED BY space.
      CLEAR:lv_sub_tdname.
    ENDIF.
********FM is used to SAPscript: Read text
    IF lv_body_tdname IS NOT INITIAL. "Invoice body credit memo email body name
      REFRESH:li_message_body,li_lines.
      CALL FUNCTION 'READ_TEXT'
        EXPORTING
          id                      = c_st
          language                = st_header-language
      ...
      IF sy-subrc EQ 0.
        ...
        ENDLOOP. " LOOP AT li_lines INTO lst_lines
      ENDIF. " IF sy-subrc EQ 0
      CLEAR:lv_body_tdname.
    ENDIF."lv_body_tdname
**
    DATA: lv_doc_id        TYPE so_entryid, " Folder Entry ID (Obj+Fol+Forwarder Name)
          lst_attach_obj   TYPE obj_record, " Structure of types OLE2_OBJECT
          i_binary_content TYPE solix_tab,
          lv_lines         TYPE syindex,    " Loop Index
          li_doc_content   TYPE STANDARD TABLE OF soli . " SAPoffice: line, length 255
    READ TABLE  i_veda  INTO DATA(lS_VEDA) INDEX 1.
    DATA:LV_CON TYPE SIBFBORIID.
LV_CON = LS_VEDA-VBELN.
    SELECT SINGLE *
         FROM srgbtbrel
         INTO   @DATA(ls_srgbtbrel)
         WHERE typeid_a = 'BUS2034' AND
               catid_a  = 'BO' AND
               instid_a LIKE @LV_CON AND   "'0040003460' AND
     reltype = 'ATTA'.
    ...
    CALL FUNCTION 'SO_DOCUMENT_READ_API1'
      ...
      TABLES
        object_content             = li_doc_content
        contents_hex               = i_binary_content
      EXCEPTIONS
        ...
        OTHERS                     = 4.
    IF sy-subrc = 0.
*        LOOP AT li_doc_content INTO DATA(ls_doc).
*        ENDLOOP.
    ENDIF.
  ENDIF."v_output_typ IN r_kschl_body AND
**EOC OTCM-54719 ED2K925511 MIMMADISET 1/11/2022
  ...
  IF i_emailid[] IS NOT INITIAL.
    ...
    ENDTRY.
    IF i_binary_content IS NOT INITIAL.
      TRY.
          lr_document->add_attachment( EXPORTING
          i_attachment_type = 'XLS'
          i_attachment_subject = 'Time sheet'
...
*** Boc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
           ...
           r_cust_srv,
*** Eoc 11/24/2021 mimmadiset OTCM-54509 ED2K925058,ED2K925180
           r_kschl_logo, "++ OTCM-54796 ED2K925511 MIMMADISET 1/11/2022
           r_kschl_body. "++ OTCM-54719 ED2K925511 MIMMADISET 1/11/2022
ENDFORM.
*&---------------------------------------------------------------------*
*&      Form  F_GET_TEXT_VAL
*&---------------------------------------------------------------------*
...
*  READ TABLE i_vbrp INTO DATA(lstt_vbrp) INDEX 1.
  DATA(li_vbrp_tmp) = i_vbrp.
  SORT li_vbrp_tmp BY vbeln posnr.
  READ TABLE li_vbrp_tmp INTO DATA(lstt_vbrp) WITH KEY vbeln = st_vbrk-vbeln
                                              BINARY SEARCH.
* EOC by NPALLA on 02/16/2021 for PRB0047137 with ED1K912690 *
...
* Begin of ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922411
       lst_billing_date TYPE fkdat.

  lst_billing_date = st_vbrk-fkdat - 1.
* End of ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922411
...
*       date       = st_vbrk-fkdat          " Billing Date  "ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922411
        date       = lst_billing_date       " Billing Date  "ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922411
      IMPORTING
...
*         Translate foreign currency amount to local currency
    CALL FUNCTION 'CONVERT_TO_LOCAL_CURRENCY'
      EXPORTING
*       date             = st_vbrk-fkdat          "Currency translation date "ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922411
        date             = lst_billing_date       " Billing Date  "ADD:OTCM-31644:SGUDA:09-MAR-2021:ED2K922411
...
* BOC by Lahiru on 10/16/2020 for OTCM-20007 with ED2K919951 *
FORM f_value_change USING fp_input_value
                          fp_doc_cur
                          fp_flag
                    CHANGING fp_output_value.

  WRITE fp_input_value TO fp_output_value CURRENCY fp_doc_cur.
  CONDENSE fp_output_value.
  IF fp_flag = abap_true. " flag is changing based on Document category.
    CONCATENATE c_minus fp_output_value INTO fp_output_value.
  ENDIF.
...
*      -->P_ST_HEADER  text
*----------------------------------------------------------------------*
FORM f_get_t005  USING    p_st_header TYPE zstqtc_header_detail_f042.
  SELECT SINGLE * FROM t005 INTO st_t005
                   WHERE land1 = p_st_header-bill_country.
ENDFORM.
*&---------------------------------------------------------------------*
*&      Form  F_POPULATE_JJI_ITEM
*&---------------------------------------------------------------------*
*       text
*----------------------------------------------------------------------*
*      -->P_ST_VBRK  text
...
*      <--P_I_FINAL_TBT  text
**----------------------------------------------------------------------*
FORM f_populate_jji_item  USING   fp_lst_vbrp TYPE ty_vbrp
                          CHANGING fp_i_final_tbt TYPE ztqtc_item_detail_tbt_f042.
*  Local data declaration
  DATA:lst_makt_kdm TYPE char255,
       lst_final_jj TYPE zstqtc_item_detail_tbt_f042.
** Delete the empty records with quantity EQ space AND amount EQ space
** and update the material description
  DELETE fp_i_final_tbt WHERE quantity EQ space AND amount EQ space.
  DESCRIBE TABLE fp_i_final_tbt LINES DATA(lv_last_rec).
  IF sy-subrc = 0.
**BOC OTCM-54290  ED2K925875 MIMMADISET 2/23/2022
    CONCATENATE fp_lst_vbrp-arktx lst_makt_kdm INTO lst_makt_kdm.
**EOC OTCM-54290  ED2K925875 MIMMADISET 2/23/2022
**BOC OTCM-54290 ED2K925511 MIMMADISET 1/11/2022
*If CMIR text exist in the field VBAP-KDMAT populte,If doesn't exist the display the settle ment period
    READ TABLE i_vbap INTO DATA(lst_vbap)
         WITH KEY vbeln = fp_lst_vbrp-vgbel
        posnr = fp_lst_vbrp-vgpos.
    IF sy-subrc = 0 AND lst_vbap-kdmat IS NOT INITIAL.
      CONCATENATE lst_makt_kdm lst_vbap-kdmat INTO lst_makt_kdm SEPARATED BY space.
      CONDENSE lst_makt_kdm.
    ELSE.
** Check settlement period is not initial
      IF fp_lst_vbrp-abrbg IS NOT INITIAL.
* get month name and year
        IF i_month_names IS INITIAL AND
           st_header-language IS NOT INITIAL.
...
*            Start month and year
          ENDIF.
        ENDIF.
        READ TABLE i_month_names INTO DATA(lst_month_name) WITH KEY mnr = fp_lst_vbrp-abrbg+4(2).
        IF sy-subrc = 0.
          CONCATENATE lst_makt_kdm lst_month_name-ltx fp_lst_vbrp-abrbg+0(4) INTO lst_makt_kdm
          SEPARATED BY space.
          CONDENSE lst_makt_kdm.
        ENDIF.
      ENDIF."fp_lst_vbrp-abrbg IS NOT INITIAL AND
    ENDIF."IF sy-subrc = 0 AND lst_vbap-kdmat IS NOT INITIAL.
**EOC OTCM-54290 ED2K925511 MIMMADISET 1/11/2022
    READ TABLE fp_i_final_tbt ASSIGNING FIELD-SYMBOL(<fs_tbt>) INDEX lv_last_rec.
    IF sy-subrc = 0 AND lst_makt_kdm IS NOT INITIAL.
      <fs_tbt>-subs_type = lst_makt_kdm.
    ENDIF.
    APPEND lst_final_jj TO fp_i_final_tbt.
    CLEAR:lst_vbap,lst_makt_kdm,lv_last_rec.
  ENDIF.
ENDFORM.
*&---------------------------------------------------------------------*
*&      Form  F_POPULATE_MAI_ITEM
*&---------------------------------------------------------------------*
*       text
*----------------------------------------------------------------------*
*      -->P_LST_VBRP  text
*      <--P_FP_I_FINAL_TBT  text
*----------------------------------------------------------------------*
FORM f_populate_mai_item  USING   fp_lst_vbrp TYPE ty_vbrp
                          CHANGING fp_i_final_tbt TYPE ztqtc_item_detail_tbt_f042.
*  Local data declaration
  DATA:lst_makt_kdm  TYPE char255.
** Delete the empty records with quantity EQ space AND amount EQ space
** and update the material description
  DELETE fp_i_final_tbt WHERE quantity EQ space AND amount EQ space.
  READ TABLE fp_i_final_tbt ASSIGNING FIELD-SYMBOL(<fs_tbt>)
  WITH KEY item = fp_lst_vbrp-posnr.
  IF sy-subrc = 0.
**Boc mimmadiset OTCM-61258 05/06/2022 ED2K927184
    IF v_output_typ IN r_kschl_inv AND r_kschl_inv IS NOT INITIAL.
      CONCATENATE fp_lst_vbrp-arktx lst_makt_kdm INTO lst_makt_kdm.
    ELSE.
      READ TABLE i_makt INTO DATA(lst_makt)
           WITH KEY matnr = fp_lst_vbrp-matnr
                    spras =  st_header-language
           BINARY SEARCH.
      IF sy-subrc = 0.
        CONCATENATE lst_makt-maktx lst_makt_kdm INTO lst_makt_kdm.
      ENDIF.
    ENDIF.
**Eoc mimmadiset OTCM-61258 05/06/2022 ED2K927184
*If CMIR text exist in the field VBAP-KDMAT populte,If doesn't exist the display the settle ment period
    READ TABLE i_vbap INTO DATA(lst_vbap)
         WITH KEY vbeln = fp_lst_vbrp-vgbel
        posnr = fp_lst_vbrp-vgpos.
    IF sy-subrc = 0 AND lst_vbap-kdmat IS NOT INITIAL.
      ...
      CONDENSE lst_makt_kdm.
    ELSE.
*Begin of ADD:OTCM-55199/OTCM-65018:SGUDA:06-June-2022:ED2K927542
*      IF v_output_typ = c_mai_output."++boc mimmadiset 4/14/2022 61258 ED2K926836
*** Check settlement period is not initial
*        IF fp_lst_vbrp-abrbg IS NOT INITIAL.
** get month name and year
*          IF i_month_names IS INITIAL AND
...
*        ENDIF."fp_lst_vbrp-abrbg IS NOT INITIAL AND
*      ENDIF."IF sy-subrc = 0 AND lst_vbap-kdmat IS NOT INITIAL.
*End of ADD:OTCM-55199/OTCM-65018:SGUDA:06-June-2022:ED2K927542
    ENDIF." IF  v_output_typ = c_mai_output.
    IF lst_makt_kdm IS NOT INITIAL.
      <fs_tbt>-subs_type = lst_makt_kdm.
    ENDIF.
    CLEAR:lst_makt,lst_makt_kdm.
  ENDIF.
ENDFORM.
*&---------------------------------------------------------------------*
*&      Form  F_POPULATE_LOGO_JJ
*&---------------------------------------------------------------------*
*       text
*----------------------------------------------------------------------*
*      <--P_V_XSTRING  text
*----------------------------------------------------------------------*
FORM f_populate_logo_jj  CHANGING fp_v_xstring TYPE xstring..
  DATA: lv_btype  TYPE tdbtype VALUE 'BMON'. "ADD:OTCM-55203:SGUDA:28-FEB-2022:ED2K925904
* Local constant declaration
  CONSTANTS : lc_logo   TYPE tdobname   VALUE '_LOGO',        " Name
              lc_object TYPE tdobjectgr VALUE 'GRAPHICS',     " SAPscript Graphics Management: Application object
              lc_id     TYPE tdidgr     VALUE 'BMAP',         " SAPscript Graphics Management: ID
*              lc_btype  TYPE tdbtype    VALUE 'BMON',         " Graphic type "DEL:OTCM-55203:SGUDA:28-FEB-2022:ED2K925904
              lc_za     TYPE vbpa-parvw VALUE 'ZA',
              lc_bcol   TYPE tdbtype    VALUE 'BCOL'.         "ADD:OTCM-55203:SGUDA:28-FEB-2022:ED2K925904

  DATA:lv_logo_name TYPE tdobname.
**Uploaded the logo with output type in SE78 tcode
  lv_logo_name = v_output_typ && lc_logo.  "Logo Name
*- Begin of ADD:OTCM-55203:SGUDA:28-FEB-2022:ED2K925904
  IF  v_output_typ IN r_logo_col.
    lv_btype = lc_bcol.
  ENDIF.
*- End of ADD:OTCM-55203:SGUDA:28-FEB-2022:ED2K925904
* To Get a BDS Graphic in BMP Format
