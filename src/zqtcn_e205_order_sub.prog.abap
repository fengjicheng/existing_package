...
* PROGRAM DESCRIPTION: Create contracts
...
*-------------------------------------------------------------------
* REVISION HISTORY--------------------------------------------------
* REVISION NO   : ED2K924779
* REFERENCE NO  : OTCM_52349
* DEVELOPER     : MIMMADISET
* DATE(MM/DD/YYYY): 10/08/2021
* DESCRIPTION   : Adding the new column for J&J Ed Project
*-------------------------------------------------------------------
* REVISION HISTORY--------------------------------------------------
...
* DESCRIPTION   :Added a new column for Billing date updation in header
* Added the new fileds in background also.
*-------------------------------------------------------------------
* REVISION HISTORY--------------------------------------------------
...
FORM f_convert_new_ord_excel USING fp_p_file  TYPE rlgrap-filename " Local file for upload/download 5
  ...
  DATA :    li_excel        TYPE STANDARD TABLE OF zqtc_alsmex_tabline " Rows for Table with Excel Data
            ...
            lv_incpo        TYPE incpo,
            lv_ole          TYPE char1,
            lv_kbetr        TYPE kbetr, "++mimmadiset OTCM-54746 ED2K925068
            lv_kwmeng       TYPE dzmeng. "++mimmadiset OTCM-54746 ED2K925068
...
*       i_end_col               = 35      " NPOLINA 5/May/2019 Added DEV ID field ED2K915113
        i_end_col               = 39      " mimmadiset OTCM-54746 ED2K925068
        i_end_row               = 65000
      TABLES
        intern                  = li_excel
      EXCEPTIONS
          ...
          AT NEW col.
            CASE lst_excel_dummy-col.
              ...
              WHEN 2.
                ...
                TRANSLATE lst_final-auart TO UPPER CASE.
...
*** Boc 11/25/2021 mimmadiset OTCM-54746 ED2K925068
                TRY.
                    lv_kwmeng  = lst_final-kwmeng.
                  CATCH cx_root.
*                 Message: Quantity & is not in the correct format
                ...
                ENDTRY.
                IF lv_kwmeng LE 0.
                  MESSAGE 'Please check the file, Item Qty cannot be zero.'(123)
                  TYPE lc_i DISPLAY LIKE c_e.
                  LEAVE LIST-PROCESSING.
                ENDIF.
*** Eoc 11/25/2021 mimmadiset OTCM-54746 ED2K925068
                CLEAR:lst_excel_dummy,lv_kwmeng.
***--BOC: ERPP-124 - SKKAIRAMKO - 04/9/2019
**                IF lst_final-kwmeng LE 0.
**                  MESSAGE 'Please check the file, Item Qty cannot be zero.'(123)
**                  TYPE lc_i DISPLAY LIKE c_e.
**                  LEAVE LIST-PROCESSING.
**                ENDIF.
***--EOC: ERPP-124 - SKKAIRAMKO - 04/9/2019
              WHEN 14.
...
*** Boc 11/25/2021 mimmadiset OTCM-54746 ED2K925068
                TRY.
                    lv_kbetr = lst_excel_dummy-value.
                  CATCH cx_root.
*                 Message: Amount & format is incorrect
                ...
                ENDTRY.
*** Eoc 11/25/2021 mimmadiset OTCM-54746 ED2K925068
                CLEAR:lst_excel_dummy,lv_kbetr.
...
*** Eoc 11/25/2021 mimmadiset OTCM-54746 ED2K925068
              ...
              WHEN 35.
                ...
                IF NOT lst_final IS INITIAL.
                  ...
                  CLEAR: lst_final.
                ENDIF. " IF NOT lst_final IS INITIAL
*** Boc 10/08/2021 mimmadiset OTCM-52349 ED2K924779
              WHEN 36.
                lst_final-quan_uom = lst_excel_dummy-value.
                CLEAR:lst_excel_dummy.
*** Eoc 10/08/2021 mimmadiset OTCM-52349 ED2K924779
*** Boc 11/25/2021 mimmadiset OTCM-54746 ED2K925068
              WHEN 37.
                lst_final-zzsfdccase = lst_excel_dummy-value.
                CLEAR:lst_excel_dummy.
              WHEN 38.
                lst_final-vabndat = lst_excel_dummy-value.
                CLEAR:lst_excel_dummy.
*** Eoc 11/25/2021 mimmadiset OTCM-54746 ED2K925068
** Boc 12/10/2021 mimmadiset OTCM-55395 ED2K925236
              WHEN 39.
                lst_final-fkdat = lst_excel_dummy-value.
                CLEAR:lst_excel_dummy.
** Eoc 12/10/2021 mimmadiset OTCM-55395 ED2K925236
* SOC by NPOLINA 27/May/2019 ED2K915113
*              WHEN 36.
*                lst_final-devid = lst_excel_dummy-value.
*                CLEAR lst_excel_dummy.
*                IF v_devid IS INITIAL.
*                  v_devid = lst_final-devid.
*                  CONDENSE v_devid NO-GAPS.
*                ENDIF.
*                IF NOT lst_final IS INITIAL.
*                  APPEND lst_final TO fp_i_final.
*                  CLEAR: lst_final.
...
FORM f_display_new_data_ord_alv .  "6
  ...
  PERFORM f_buildcat USING:
            ...
            lv_counter 'QUAN_UOM'   'Target quantity UoM'(135), " mimmadiset OTCM-52349 ED2K924779
            lv_counter 'ZZSFDCCASE'   'SFDC Case'(136),     " mimmadiset OTCM-54746 ED2K925068
            lv_counter 'VABNDAT'   'Acceptance date'(137),  " mimmadiset OTCM-54746 ED2K925068
            lv_counter 'FKDAT'   'Billing date'(138).  " mimmadiset OTCM-55395 ED2K925236
*            lv_counter 'DEVID'      'Development ID'(124)    . " DEVID  Knewton Project NPOLINA ED2K915113
* fill up the ALV table
  LOOP AT i_final_ord INTO st_final_x.
    ...
    st_output_x-quan_uom  = st_final_x-quan_uom. "target quantity UoM ++mimmadiset OTCM-52349 ED2K924779
...
*    st_output_x-devid    = st_final_x-devid.  " DEVID  Knewton Project NPOLINA ED2K915113
    st_output_x-posnr    = st_final_x-posnr.
    st_output_x-zzsfdccase = st_final_x-zzsfdccase."++ mimmadiset OTCM-54746 ED2K925068
    st_output_x-vabndat    = st_final_x-vabndat."++ mimmadiset OTCM-54746 ED2K925068
    st_output_x-fkdat    = st_final_x-fkdat."++ mimmadiset OTCM-55395 ED2K925236
...
FORM f_contract_createfromdata .
  TYPES: BEGIN OF lty_cond_class,
         ...
         BEGIN OF ty_vbfa,
           ...
           posnv TYPE vbfa-posnv,    " Preceding sales and distribution document item
...
**====================================================================*
  DATA: li_return               TYPE STANDARD TABLE OF bapiret2,  " Return messages
        ...
        li_sales_schedules_in   TYPE STANDARD TABLE OF bapischdl, "++VDPATABALL OTCM-4728 ED2K919875  Knewton - Sales Order
        li_sales_schedules_inx  TYPE STANDARD TABLE OF bapischdlx, "++VDPATABALL OTCM-4728 ED2K919875  Knewton - Sales Order
*====================================================================*
*       Local Work-area
*====================================================================*
        ...
        lst_sales_schedules_in  TYPE bapischdl,   "++VDPATABALL OTCM-4728 ED2K919875  Knewton - Sales Order
        lst_sales_schedules_inx TYPE bapischdlx,  "++VDPATABALL OTCM-4728 ED2K919875  Knewton - Sales Order
...
*====================================================================*
  ...
  CONSTANTS:lc_zalo    TYPE auart    VALUE 'ZALO', "++VDPATABALL OTCM-4728 ED2K919875  Knewton - Sales Order
            lc_vbtyp_c TYPE vbtyp VALUE 'C',    "++VDPATABALL OTCM-4728 ED2K919875  Knewton - Sales Order
            lc_g       TYPE vbtyp    VALUE 'G'.    "++VDPATABALL OTCM-4728 ED2K919875  Knewton - Sales Order

  DATA:lv_strexp  TYPE cy_datef,
       lv_input   TYPE cy_datef,
       lv_dateexp TYPE sy-datum.
...
** Get Increment of item number in the SD document*
  ...
  IF li_output[] IS NOT INITIAL.
    SELECT kunnr,
           ...
           vtweg,
           spart, " Division
           waers " ++mimmadiset OTCM-43068 03/04/2021.
      FROM knvv  " Customer Master Sales Data
      INTO TABLE @DATA(li_knvv)
*       FOR ALL ENTRIES IN @li_output
*      WHERE ( kunnr = @li_output-kunnr_sp OR kunnr = @li_output-kunnr_we OR kunnr = @li_output-partner )
      WHERE vkorg = @p_vkorg
      AND vtweg = @p_vtweg
    ...
    ENDIF.
**BOC:ED2K927215:OTCM-63370:05/11/2022:MIMMADISET*****
    IF ch_sales IS INITIAL.
      DATA(lv2_vkorg) = p_vkorg &&
                       p_vtweg
                       && lst_ord_alv-spart.
      READ TABLE i_const TRANSPORTING NO FIELDS WITH KEY devid = c_devid
                                                  param1 = c_mat_spras
                                                  param2 = lv2_vkorg.
      IF sy-subrc = 0.
        SELECT matnr,
              ...
              maktx
             FROM makt
             INTO TABLE @DATA(lt1_makt)
             FOR ALL ENTRIES IN @li_output
             WHERE matnr = @li_output-matnr.
        IF sy-subrc EQ 0.
          SORT lt1_makt[] BY matnr spras.
        ENDIF.
      ENDIF.
    ENDIF.
**eOC:ED2K927215:OTCM-63370:05/11/2022:MIMMADISET*****
  ENDIF.
* Sort by Order Type
...
*     FOR ALL ENTRIES IN @li_output
     WHERE kappl EQ 'V'.
*     AND   ( kschl EQ @li_output-kschl OR kschl EQ @li_output-kschl2 OR kschl EQ @v_e205_cond ).
      IF sy-subrc IS INITIAL.
...
*---Begin of change VDPATABALL OTCM-4728 ED2K919875 Knewton Sales Order changes
    IF ch_sales IS NOT INITIAL.
      DATA(li_output_tmp) = i_ord_alv.
      SORT li_output_tmp BY kdmat.
      DELETE li_output_tmp WHERE kdmat IS INITIAL.
      IF li_output_tmp IS NOT INITIAL.
        SELECT vbak~vbeln,
               ...
               vbap~matnr,
               vbap~pstyv,
               vbap~zmeng,  " added by mimmadiset
               vbap~kdmat
          INTO TABLE @DATA(li_vbap_ref)
          FROM vbak
          INNER JOIN vbap ON vbak~vbeln = vbap~vbeln
          FOR ALL ENTRIES IN @li_output_tmp
          WHERE vbak~vkorg = @p_vkorg
            AND vbak~vtweg = @p_vtweg
            AND vbap~kdmat = @li_output_tmp-kdmat
            AND vbak~vbtyp = 'G'.
      ENDIF.
    ENDIF.
*---End of change VDPATABALL OTCM-4728 ED2K919875 Knewton Sales Order changes
  ENDIF.
*
...
**   Whenever we see new header entry, we refresh the tables
    IF lst_output_dummy-auart  IS NOT INITIAL.
      ...
      CLEAR: li_contract_itm,
             ...
             li_text,
             li_text1,
             li_sales_schedules_in,   "++VDPATABALL OTCM-4728 ED2K919875  Knewton - Sales Order
             lst_sales_schedules_in,  "++VDPATABALL OTCM-4728 ED2K919875  Knewton - Sales Order
             li_sales_schedules_inx,  "++VDPATABALL OTCM-4728 ED2K919875  Knewton - Sales Order
             lst_sales_schedules_inx, "++VDPATABALL OTCM-4728 ED2K919875  Knewton - Sales Order
             lst_contract_hrdinx,
             lst_contract_data,
...
*====================================================================*
      TRANSLATE lst_output_dummy-auart TO UPPER CASE.
...
*            date_external_is_invalid = 1.
        CLEAR:lv_input,lv_strexp,lv_dateexp.
        lv_input = lst_output_dummy-guebg.
        CALL FUNCTION 'CY_CONVERT_DATE'
          EXPORTING
            date_string_imp = lv_input
          IMPORTING
            date_string_exp = lv_strexp
            date_exp        = lst_contract_hdrin-ct_valid_f.
        ##FM_SUBRC_OK IF sy-subrc IS NOT INITIAL.
...
*            date_external_is_invalid = 1.
        ...
        CLEAR:lv_input,lv_strexp,lv_dateexp.
        lv_input = lst_output_dummy-gueen.
        CALL FUNCTION 'CY_CONVERT_DATE'
          EXPORTING
            date_string_imp = lv_input
          IMPORTING
            date_string_exp = lv_strexp
            date_exp        = lst_contract_hdrin-ct_valid_t.
...
*====================================================================*
        ...
        ELSE. " ELSE -> IF lst_contract_hdrin-purch_no_c IS NOT INITIAL
          lst_contract_hrdinx-purch_no_c = abap_false.
...
** Boc 12/10/2021 mimmadiset OTCM-55395 ED2K925236
        IF lst_output_dummy-fkdat IS NOT INITIAL.
          CLEAR:lv_input,lv_strexp,lv_dateexp.
          lv_input = lst_output_dummy-fkdat.
          CALL FUNCTION 'CY_CONVERT_DATE'
            EXPORTING
              date_string_imp = lv_input
            IMPORTING
              date_string_exp = lv_strexp
              date_exp        = lst_contract_hdrin-bill_date.
          ##FM_SUBRC_OK IF sy-subrc IS NOT INITIAL.
...
*** Boc 11/25/2021 mimmadiset OTCM-54746 ED2K925068
*====================================================================*
*     Populating Custom field in header VBAK
*====================================================================*
        REFRESH:li_extensionin.
        IF lst_output_dummy-zzsfdccase IS NOT INITIAL.
          lst_bape_vbak-zzsfdccase  = lst_output_dummy-zzsfdccase.
          ...
          lst_bape_vbakx-zzsfdccase = abap_true.
...
**-BOC: ERPP-124 - SKKAIRAKO - 4/9/2019
*
*      IF lst_output_dummy-kwmeng LE 0.
*        CONTINUE.
*      ENDIF.
**-BOC: ERPP-124 - SKKAIRAKO - 4/9/2019
...
**BOC:ED2K927215:OTCM-63370:05/11/2022:MIMMADISET*****
          IF ch_sales IS INITIAL.
            DATA(lv1_vkorg) = lst_contract_hdrin-sales_org &&
                             lst_contract_hdrin-distr_chan
                             && lst_contract_hdrin-division.
            READ TABLE i_const TRANSPORTING NO FIELDS WITH KEY devid = c_devid
                                                        param1 = c_mat_spras
                                                        param2 = lv1_vkorg.
            IF sy-subrc = 0.
              READ TABLE li_contract_partn INTO DATA(ls_ag)
              WITH KEY partn_role = c_sp itm_number = lc_posnr.
              IF sy-subrc = 0.
                SELECT SINGLE spras FROM kna1
                  INTO @DATA(lv_spras)
                  WHERE kunnr = @ls_ag-partn_numb.
                IF sy-subrc = 0.
                  READ TABLE lt1_makt ASSIGNING FIELD-SYMBOL(<lfs1_makt>) WITH KEY matnr = lst_output_dummy-matnr
                                                             spras = lv_spras
                                                             BINARY SEARCH.
                  IF sy-subrc EQ 0.
                    lst_contract_itm-short_text    = <lfs1_makt>-maktx.
                  ELSE.
                    READ TABLE lt1_makt ASSIGNING FIELD-SYMBOL(<lfs2_makt>)
                                                    WITH KEY matnr = lst_output_dummy-matnr
                                                             spras = sy-langu.
                    IF sy-subrc EQ 0.
                      lst_contract_itm-short_text    = <lfs2_makt>-maktx.
                    ENDIF.
                  ENDIF.
                ENDIF.
              ENDIF.
            ENDIF.
          ENDIF.
          IF lst_contract_itm-short_text IS INITIAL.
**EOC:ED2K927215:OTCM-63370:05/11/2022:MIMMADISET*****
...
*---Begin of change VDPATABALL OTCM-4728 ED2K919875 Knewton Sales Order changes
        IF ch_sales IS NOT INITIAL.
          ...
          SELECT vbak~vbeln,
            ...
            FROM vbak
            INNER JOIN vbap ON vbak~vbeln = vbap~vbeln
            INTO TABLE @DATA(li_vbak_t)
            WHERE vbak~auart = @lc_zalo
              AND vbak~vbtyp = @lc_g
              AND vbap~kdmat = @lst_output_dummy-kdmat.
          IF sy-subrc = 0.
            DESCRIBE TABLE li_vbak_t LINES DATA(lv_lines).
            IF lv_lines GT 1.
              lst_return-id       = 'ZQTC_R2'.
              lst_return-number   = 576.
              lst_return-type     = lc_e.
              lst_return+270(200) = text-131.
              lst_return-message  = text-131.
              APPEND lst_return TO li_return.
              CLEAR lst_return.
            ENDIF.
          ENDIF.
** Add mimmadiset
          IF li_vbak_t[] IS NOT INITIAL.
            SELECT
             vbelv,   "Preceding sales and distribution document
             posnv,   "Preceding item of an SD document
             vbeln,   "Preceding SD document
             posnn,   "Preceding item
             rfmng    " Referenced quantity in base unit of measure
               FROM vbfa     " Sales Document Flow
               INTO TABLE @DATA(li_doc_flow)
               FOR ALL ENTRIES IN @li_vbak_t
               WHERE vbelv   = @li_vbak_t-vbeln
            AND  posnv   = @li_vbak_t-posnr
            AND posnn = @li_vbak_t-posnr
            AND vbtyp_n = @lc_vbtyp_c.
            REFRESH:li_vbfa[].
            IF li_doc_flow IS NOT INITIAL.
              LOOP AT li_doc_flow ASSIGNING FIELD-SYMBOL(<ls_doc_flow>).
                lst_vbfa-vbelv    = <ls_doc_flow>-vbelv.
                lst_vbfa-posnv    = <ls_doc_flow>-posnv  .
                lst_vbfa-rfmng    = <ls_doc_flow>-rfmng.
                COLLECT lst_vbfa INTO li_vbfa.
                CLEAR lst_vbfa.
...
** End mimmadiset
          IF li_return IS INITIAL.
            ...
            READ TABLE li_vbap_ref INTO DATA(lst_vbap_ref) WITH KEY vkorg = p_vkorg
                                                                    vtweg = p_vtweg
                                                                    kdmat = lst_output_dummy-kdmat
                                                                    matnr = lst_output_dummy-matnr
                                                                    pstyv = lc_zal0.
            IF sy-subrc = 0.
              READ TABLE li_contract_partn INTO lst_contract_partn WITH KEY partn_role = c_sp
                                                                            partn_numb = lst_vbap_ref-kunnr.
              IF sy-subrc NE 0.
                lst_return-id       = 'ZQTC_R2'.
                lst_return-number   = 577.
                lst_return-type     = lc_e.
                lst_return-message_v1 = lst_vbap_ref-kunnr.
                APPEND lst_return TO li_return.
                CLEAR lst_return.
              ELSE.
                "Added by mimmadiset
                READ TABLE li_vbfa ASSIGNING FIELD-SYMBOL(<ls_vbfa>)
                   WITH KEY vbelv = lst_vbap_ref-vbeln posnv = lst_output_dummy-posnr.
                IF sy-subrc EQ 0.
                  <ls_vbfa>-rfmng = <ls_vbfa>-rfmng + lst_output_dummy-kwmeng.
                  IF <ls_vbfa>-rfmng GT lst_vbap_ref-zmeng.
                    lst_return-id       = 'ZQTC_R2'.
                    lst_return-number   = 582.
                    lst_return-type     = lc_e.
                    lst_return-message_v1 = lst_vbap_ref-vbeln.
                    APPEND lst_return TO li_return.
                    CLEAR lst_return.
                  ENDIF.
                ELSE.
                  IF lst_output_dummy-kwmeng GT lst_vbap_ref-zmeng.
                    lst_return-id       = 'ZQTC_R2'.
                    lst_return-number   = 582.
                    lst_return-type     = lc_e.
                    lst_return-message_v1 = lst_vbap_ref-vbeln.
                ...
                ENDIF.
                "End of mimmadiset
                lst_contract_hdrin-ref_doc        = lst_vbap_ref-vbeln.
                lst_contract_hdrin-refdoc_cat     = 'G'.
                lst_contract_hdrx-refdoc_cat      = abap_true.
                lst_contract_hdrx-ref_doc         = abap_true.
                lst_contract_itm-ref_doc          = lst_vbap_ref-vbeln.
                lst_contract_items_inx-ref_doc    = abap_true.
                lst_contract_itm-ref_doc_it       = lst_vbap_ref-posnr.
                lst_contract_items_inx-ref_doc_it = abap_true.
              ENDIF.
            ELSE.
              lst_return-type   = lc_e.
              lst_return-message_v1 = lst_output_dummy-matnr.
              lst_return-message_v2 = lst_output_dummy-kdmat.
              lst_return-id       = 'ZQTC_R2'.
              lst_return-number   = 578.
              APPEND lst_return TO li_return.
              CLEAR lst_return.
            ENDIF.
          ENDIF.
...
*---End of change VDPATABALL OTCM-4728 ED2K919875 Knewton Sales Order changes
        ...
        ENDIF.
*** Boc 10/08/2021 mimmadiset OTCM-52349 ED2K924779
        IF ch_sales IS INITIAL. "Logic for contract creation
          lst_contract_itm-target_qu = lst_output_dummy-quan_uom.
          IF  lst_contract_itm-target_qu IS NOT INITIAL.
            lst_contract_items_inx-target_qu = abap_true.
          ENDIF.
        ENDIF.
*** Eoc 10/08/2021 mimmadiset OTCM-52349 ED2K924779
...
*            date_external_is_invalid = 1.
        ...
        CLEAR:lv_input,lv_strexp,lv_dateexp.
        lv_input = lst_output_dummy-guebg_itm.
        CALL FUNCTION 'CY_CONVERT_DATE'
          EXPORTING
            date_string_imp = lv_input
          IMPORTING
            date_string_exp = lv_strexp
            date_exp        = lst_contract_sched-req_date.
        ##FM_SUBRC_OK   IF sy-subrc IS NOT INITIAL.
...
*====================================================================*
*** Boc 03/04/2021 mimmadiset OTCM-43068
*** Restrict the KBETR dividing by 10 for HUF currency sales org
**If we maintain the entry skip the KBETR dividing by 10 logic for contracts
        CLEAR:v_skip_curr.
        IF ch_sales IS INITIAL.
          DATA(lv_vkorg) = lst_contract_hdrin-sales_org && lst_contract_hdrin-distr_chan
                           && lst_contract_hdrin-division.
          READ TABLE i_const TRANSPORTING NO FIELDS WITH KEY devid = c_devid
                                                      param1 = c_waers
                                                      param2 = lv_vkorg.
          IF sy-subrc EQ 0.
            v_skip_curr = abap_true. "++mimmadiset OTCM-43068
          ENDIF.
        ENDIF.
*** Eoc 03/04/2021 mimmadiset OTCM-43068
*COndition Type 1
        IF lst_output_dummy-kbetr > 0.
          ...
          IF sy-subrc IS INITIAL AND lst_output_dummy-kbetr > 0.
            IF <lfs_cond>-krech NE 'A'.
              ...
              IF v_skip_curr = abap_true. "++mimmadiset OTCM-43068
...
*            date_external_is_invalid = 1.
        ...
        CALL FUNCTION 'CY_CONVERT_DATE'
          ...
          IMPORTING
            date_string_exp = lv_strexp
            date_exp        = lst_contract_data-con_st_dat.
...
*              date_external_is_invalid = 1.
          ...
          CLEAR:lv_input,lv_strexp,lv_dateexp.
          lv_input = lst_output_dummy-gueen_itm.
          CALL FUNCTION 'CY_CONVERT_DATE'
            EXPORTING
              date_string_imp = lv_input
            IMPORTING
              date_string_exp = lv_strexp
              date_exp        = lst_contract_data-con_en_dat.
          ...
          ENDIF. " IF sy-subrc IS NOT INITIAL
*** Boc 11/25/2021 mimmadiset OTCM-54746 ED2K925068
*Acceptance date is not initial at the item level
          IF lst_output_dummy-vabndat IS NOT INITIAL.
            CLEAR:lv_input,lv_strexp,lv_dateexp.
            lv_input = lst_output_dummy-vabndat."Acceptance date
            CALL FUNCTION 'CY_CONVERT_DATE'
              EXPORTING
                date_string_imp = lv_input
              IMPORTING
                date_string_exp = lv_strexp
                date_exp        = lst_contract_data-accept_dat.
            IF sy-subrc IS NOT INITIAL.  ##FM_SUBRC_OK
              CLEAR lst_contract_data-accept_dat.
            ELSE.
              IF lst_contract_data-accept_dat IS NOT INITIAL.
                lst_contract_data_inx-accept_dat = abap_true.
              ENDIF.
            ENDIF."IF sy-subrc IS NOT INITIAL.
          ENDIF." IF lst_output_dummy-vabndat IS NOT INITIAL.
*** Eoc 11/25/2021 mimmadiset OTCM-54746 ED2K925068
...
*Acceptance date is not initial at the item level
        IF lst_output_dummy-vabndat IS NOT INITIAL.
          CLEAR:lst_contract_data_inx-accept_dat,lst_contract_data-accept_dat.
        ENDIF.
**Eoc 11/25/2021 mimmadiset OTCM-54746 ED2K925068
*====================================================================*
...
*** Boc 03/04/2021 mimmadiset OTCM-43068
*** Fetch currency from KNVV table and populate in BAPI for sales org
*** which we maintained in zcaconstant table
    IF ch_sales IS INITIAL   "Contract check
      AND lv_create_contract EQ abap_true
      AND v_skip_curr IS NOT INITIAL.
      READ TABLE li_contract_partn INTO DATA(ls_sp_part)
      WITH KEY partn_role = c_sp itm_number = lc_posnr.
      IF sy-subrc = 0.
        READ TABLE li_knvv INTO DATA(ls_curr) WITH KEY kunnr = ls_sp_part-partn_numb
                                                       vkorg = lst_contract_hdrin-sales_org
                                                       vtweg = lst_contract_hdrin-distr_chan
                                                       spart = lst_contract_hdrin-division BINARY SEARCH.
        IF sy-subrc = 0 AND ls_curr-waers IS NOT INITIAL AND li_contract_cond IS NOT INITIAL.
          lst_contract_hdrin-currency = ls_curr-waers.
          lst_contract_hrdinx-currency = abap_true.
          DATA(lst_contract_cond1) = lst_contract_cond.
          CLEAR:lst_contract_cond1.
          lst_contract_cond1-currency = ls_curr-waers.
          MODIFY li_contract_cond FROM lst_contract_cond1
                 TRANSPORTING currency WHERE currency IS INITIAL.
        ENDIF.
      ENDIF.
    ENDIF.
*** Eoc 03/04/2021 mimmadiset OTCM-43068
...
*     Call Bapi
*====================================================================*
      IF ch_sales IS INITIAL. "++VDPATABALL OTCM-4728 ED2K919875 Knewton Sales Order changes
...
*---Begin of change VDPATABALL OTCM-4728 ED2K919875 Knewton Sales Order changes
            IF ch_sales IS INITIAL.
              st_err_msg-msgv1 = 'Contract'(134).
            ELSE.
*---End of change VDPATABALL OTCM-4728 ED2K919875 Knewton Sales Order changes
              st_err_msg-msgv1 = 'Order'(130)."lst_return-message_v1.
            ENDIF. "VDPATABALL OTCM-4728 ED2K919875 Knewton Sales Order changes
            st_err_msg-msgv2 = lst_return-message_v2.
            st_err_msg-msgv3 = lst_return-message_v3.
            st_err_msg-msgv4 = lst_return-message_v4.
            APPEND st_err_msg TO i_err_msg.
  ...
  WHILE lv_flag IS INITIAL.
    ...
    IF sy-subrc EQ 0.
      ...
      SPLIT lv_string AT '|' INTO <lfs_outpt>-sel
            ...
            <lfs_outpt>-tzone
            <lfs_outpt>-disc
*            <lfs_outpt>-devid     " DEVID  Knewton Project NPOLINA ED2K915113
            <lfs_outpt>-quan_uom  "Target Quantity UOM
            <lfs_outpt>-zzsfdccase   "SFDC case ++ mimmadiset OTCM-54746 ED2K925068
            <lfs_outpt>-vabndat     " Acceptance date ++ mimmadiset OTCM-54746 ED2K925068
            <lfs_outpt>-fkdat     " Billing date ++ mimmadiset OTCM-55395 ED2K925236
             <lfs_outpt>-posnr. "++ mimmadiset OTCM-55395 ED2K925265
* SOC by   NPOLINA ED2K915113 27/May/2019 e205
*      IF v_devid IS INITIAL AND <lfs_outpt>-devid IS NOT INITIAL.
*        v_devid = <lfs_outpt>-devid.
*      ENDIF.
...
* output column headings to active Excel sheet
    ...
    f_fill_cell USING 1 36 1 'Target quantity UoM'(135), "mimmadiset OTCM-52349 ED2K924779
    f_fill_cell USING 1 37 1 'SFDC case'(136), "++ mimmadiset OTCM-54746 ED2K925068
    f_fill_cell USING 1 38 1 'Acceptance date'(137), "++ mimmadiset OTCM-54746 ED2K925068
    f_fill_cell USING 1 39 1 'Billing date'(138). "++ mimmadiset OTCM-55395 ED2K925236
...
*                                                BINARY SEARCH.
      IF sy-subrc NE 0.
        CLEAR:p_vkorg.
*        MESSAGE 'Entered Sales Org is not possible value in ZCACONSTANT Table'(129) TYPE 'E' DISPLAY LIKE 'S'.
      ENDIF.
    ENDIF.
...
*      READ TABLE i_const ASSIGNING FIELD-SYMBOL(<lst_e205_tdid1>) WITH KEY devid = c_devid
*                                                param1 = lc_tdid
*                                                low = p_tdid
*                                                BINARY SEARCH.
*      IF sy-subrc NE 0.
**        MESSAGE 'Entered Text ID is not maintained in ZCACONSTANT Table'(126) TYPE 'E' DISPLAY LIKE 'S'.
*      ENDIF.
    ENDIF.
  ENDIF.
...
*** Local structure and internal table declaration
  ...
  LOOP AT fp_li_output_x ASSIGNING FIELD-SYMBOL(<lfs_outpt>).
    ...
    CONCATENATE
            ...
            <lfs_outpt>-disc
*            <lfs_outpt>-posnr
            <lfs_outpt>-quan_uom "++ mimmadiset OTCM-55395 ED2K925265
            <lfs_outpt>-zzsfdccase " ++mimmadiset OTCM-55395 ED2K925265
            <lfs_outpt>-vabndat "++ mimmadiset OTCM-55395 ED2K925265
            <lfs_outpt>-fkdat " 12/10/2021 mimmadiset OTCM-55395 ED2K925265
*            <lfs_outpt>-devid   "NPOLINA 27/May/2019 ED2K915113 DEV ID column added
            <lfs_outpt>-posnr
...
*      READ TABLE i_const ASSIGNING FIELD-SYMBOL(<lst_e205_tdid>) WITH KEY devid = c_devid
*                                                param1 = c_tdid
*                                                BINARY SEARCH.
*      IF sy-subrc EQ 0.
*        p_tdid = <lst_e205_tdid>-low.
*      ENDIF.
