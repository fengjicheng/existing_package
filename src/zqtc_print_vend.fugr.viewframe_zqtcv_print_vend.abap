*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZQTCV_PRINT_VEND
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZQTCV_PRINT_VEND    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZQTCV_PRINT_VEND'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZQTCV_PRINT_VEND_EXTRACT
TOTAL = ZQTCV_PRINT_VEND_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZQTCV_PRINT_VEND'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZQTCV_PRINT_VEND-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_PRINT_VEND_EXTRACT
TOTAL = ZQTCV_PRINT_VEND_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZQTCV_PRINT_VEND-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZQTCV_PRINT_VEND'
...
TOTAL = ZQTCV_PRINT_VEND_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZQTCV_PRINT_VEND-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZQTCV_PRINT_VEND-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZQTCV_PRINT_VEND'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZQTCV_PRINT_VEND-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_PRINT_VEND_EXTRACT
TOTAL = ZQTCV_PRINT_VEND_TOTAL
