class ZCL_ZQTC_BLOCKORDERS_MPC definition
  public
...
TT_BILLING type standard table of TS_BILLING .
  ...
  constants GC_BILLING type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Billing' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZQTC_BLOCKORDERS_MPC======CP' ##NO_TEXT.

  methods DEFINE_BILLING
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZQTC_BLOCKORDERS_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZQTC_BLOCKORDERS_SRV' ).

define_billing( ).
  endmethod.


  method DEFINE_BILLING.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Billing' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZQTC_BLOCKORDERS_MPC=>TS_BILLING' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'BillingSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210315165759'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Billing'.                            "#EC NOTEXT
