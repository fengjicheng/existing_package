*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZQTCV_PROD_GROUP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZQTCV_PROD_GROUP    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZQTCV_PROD_GROUP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZQTCV_PROD_GROUP_EXTRACT
TOTAL = ZQTCV_PROD_GROUP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZQTCV_PROD_GROUP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZQTCV_PROD_GROUP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_PROD_GROUP_EXTRACT
TOTAL = ZQTCV_PROD_GROUP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZQTCV_PROD_GROUP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZQTCV_PROD_GROUP'
...
TOTAL = ZQTCV_PROD_GROUP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZQTCV_PROD_GROUP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZQTCV_PROD_GROUP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZQTCV_PROD_GROUP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZQTCV_PROD_GROUP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_PROD_GROUP_EXTRACT
TOTAL = ZQTCV_PROD_GROUP_TOTAL
