*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZQTCV_MEMB_DUE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZQTCV_MEMB_DUE      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZQTCV_MEMB_DUE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZQTCV_MEMB_DUE_EXTRACT
TOTAL = ZQTCV_MEMB_DUE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZQTCV_MEMB_DUE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZQTCV_MEMB_DUE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_MEMB_DUE_EXTRACT
TOTAL = ZQTCV_MEMB_DUE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZQTCV_MEMB_DUE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZQTCV_MEMB_DUE'
...
TOTAL = ZQTCV_MEMB_DUE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZQTCV_MEMB_DUE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZQTCV_MEMB_DUE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZQTCV_MEMB_DUE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZQTCV_MEMB_DUE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_MEMB_DUE_EXTRACT
TOTAL = ZQTCV_MEMB_DUE_TOTAL
