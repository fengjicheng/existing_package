*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZQTCV_NOTIF_OUT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZQTCV_NOTIF_OUT     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZQTCV_NOTIF_OUT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZQTCV_NOTIF_OUT_EXTRACT
TOTAL = ZQTCV_NOTIF_OUT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZQTCV_NOTIF_OUT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZQTCV_NOTIF_OUT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_NOTIF_OUT_EXTRACT
TOTAL = ZQTCV_NOTIF_OUT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZQTCV_NOTIF_OUT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZQTCV_NOTIF_OUT'
...
TOTAL = ZQTCV_NOTIF_OUT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZQTCV_NOTIF_OUT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZQTCV_NOTIF_OUT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZQTCV_NOTIF_OUT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZQTCV_NOTIF_OUT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_NOTIF_OUT_EXTRACT
TOTAL = ZQTCV_NOTIF_OUT_TOTAL
