class Z1CX_TAX_CALCULATION_FAULT1 definition
  public
...
public section.
  ...
  data FAULT type Z1TAX_CALCULATION_FAULT1 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !FAULT type Z1TAX_CALCULATION_FAULT1 optional
...
CLASS Z1CX_TAX_CALCULATION_FAULT1 IMPLEMENTATION.
