...
*----------------------------------------------------------------------*
REPORT ytest_charm_invoice_f042 NO STANDARD PAGE HEADING.


INCLUDE ytest_charm2_form_top_f042.
*INCLUDE zqtcn_invoice_form_top_f042. " Include ZQTCN_INVOICE_FORM_TOP_F042

INCLUDE ytest_charm1_form_sub_f042.
...
* Implement all the processing logic
  SELECT SINGLE * FROM nast WHERE  objky IN s_objky AND kschl IN s_kschl.
