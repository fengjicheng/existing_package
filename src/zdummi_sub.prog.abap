...
*                                          li_fld_list.
  ...
  TYPES: BEGIN OF ty_components,
           ...
           kbetr           TYPE wertv,        "Rate (condition amount or percentage)
           konwa           TYPE waers,         "Field: Rate unit (currency or percentage)
           kpein           TYPE kpein,          "Field: Condition pricing unit
           kmein           TYPE meins,           "Field: Condition unit
           datab           TYPE datum,
           datbi           TYPE kodatbi,         "Validity end date of the condition record
           stfkz           TYPE stfkz,           "Field: Sale Type "++ VDPATABALL Adding new filed 08/21/2020
           konms           TYPE meins,          "Field: Sale Unit "++ VDPATABALL Adding new filed 08/21/2020
           ...
           vvis_lights     TYPE vvis_light,     "Field: Rate unit (currency or percentage)
*KOSRT TYPE CHAR10,
*KAPPL  TYPE KAPPL,         "Application
*KSTBM TYPE MENG15,          "Condition scale quantity
         END OF ty_components.

DATA LI_COMPONENTS TYPE ty_components.
FIELD-SYMBOLS: <st_cond_rc> TYPE ty_components,
               <i_cond_rcs> TYPE ty_components.
...
MODULE status_9000 OUTPUT.
  ...
  SET PF-STATUS 'ZPF_DUMMI'.
  SET TITLEBAR 'ZTITLE_DUMMI'.
