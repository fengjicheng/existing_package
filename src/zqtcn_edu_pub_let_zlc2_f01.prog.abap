...
** Local constant Delclaration
  CONSTANTS : lc_st           TYPE thead-tdid     VALUE 'ST',          " Text ID of text to be read
              ...
              lc_zqtcn_loc    TYPE char20 VALUE 'ZQTC_AC_TEMP',
...
** Read Partner University Number
          ...
          IF sy-subrc = 0.
            ...
            CONCATENATE 'PPPID:' '' INTO li_hdr_loc-idnumber_desc.
            CONCATENATE 'PDE AUN: 300000189' '' INTO li_hdr_loc-pdeaun.
          ENDIF.
        ENDIF.
...
** Read the SO10 text based on the university number
  CONCATENATE lc_zqtcn_loc v_output_typ c_devid
  ...
  LOOP AT lt_lines ASSIGNING FIELD-SYMBOL(<lw_lines>).
    REPLACE ALL OCCURRENCES OF '&STNAME&' IN <lw_lines>-tdline
...
****Logic to read the footer text
  IF lw_vbak-vkbur IS NOT INITIAL.
    ...
    ENDIF.
  ENDIF.
**  CONCATENATE lc_zqtcn_loc 'FOOTER' c_devid
