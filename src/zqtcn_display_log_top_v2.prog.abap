...
TYPES: BEGIN OF ty_opt,
         trkorr   TYPE zqtcr_tr_log_opt_str-trkorr,
         as4text  TYPE zqtcr_tr_log_opt_str-as4text,
         as4user  TYPE zqtcr_tr_log_opt_str-as4user,
         pgmid    TYPE zqtcr_tr_log_opt_str-pgmid,
         object   TYPE zqtcr_tr_log_opt_str-object,
         obj_name TYPE zqtcr_tr_log_opt_str-obj_name,
         obj_txt  TYPE zqtcr_tr_log_opt_str-obj_txt,
       END OF ty_opt.

DATA:i_opt    TYPE TABLE OF ty_opt,
     lst_opt  TYPE ty_opt,
     i_fcat   TYPE slis_t_fieldcat_alv,
     lst_fcat LIKE LINE OF i_fcat.

DATA: i_final       TYPE STANDARD TABLE OF zqtcr_tr_log_opt_str.
...
CONSTANTS:c_ed1         TYPE trtarsys   VALUE 'ED1',
          ...
          c_ed2rfc      TYPE char15 VALUE 'ED2CLNT130',
          c_eq          TYPE char3 VALUE 'EQ',
          c_cp          TYPE char3 VALUE 'CP',
          c_eds         TYPE char5 VALUE 'ED2K*',
          c_inp         TYPE char3 VALUE 'INP',
          c_prog        TYPE char4 VALUE 'PROG',
          c_fugr        TYPE char4 VALUE 'FUGR',
          c_clas        TYPE char4 VALUE 'CLAS',
          c_tabl        TYPE char4 VALUE 'TABL',
          c_view        TYPE char4 VALUE 'VIEW',
          c_ttyp        TYPE char4 VALUE 'TTYP',
          c_dtel        TYPE char4 VALUE 'DTEL',
          c_trkorr      TYPE char6 VALUE 'TRKORR',
          c_object      TYPE char8 VALUE 'OBJ_NAME',
          c_msg         TYPE char8 VALUE 'ZMESSAGE',
*          c_i           TYPE char1 VALUE 'I',
*          c_e           TYPE char1 VALUE 'E',
          c_otxt        TYPE char20 VALUE 'Open Transport',
          c_rtxt        TYPE char20 VALUE 'Released Transport',
          c_itxt        TYPE char20 VALUE 'Imported Transport',
          c_etxt        TYPE char20 VALUE 'Error Transport',
...
DATA:gt_tr    TYPE TABLE OF rsdsselopt,
     ...
     gt_obsel TYPE TABLE OF   e071,
     gs_obsel TYPE e071,
     gt_e070  TYPE TABLE OF e070,
     gs_e070  TYPE e070,
     gt_e071  TYPE TABLE OF e071,
     gs_e071  TYPE e071,
     gt_ilog  TYPE TABLE OF zca_tr_log,
...
DATA:lt_date  TYPE TABLE OF rsdsselopt,
     ...
     lt_des   TYPE TABLE OF zqtcr_tr_log_des,
     lst_des  TYPE zqtcr_tr_log_des,
     lt_user  TYPE TABLE OF rsdsselopt,
     lst_user TYPE rsdsselopt,
     lst_date TYPE rsdsselopt,
     lt_inc   TYPE TABLE OF rsdsselopt,
     lst_inc  TYPE rsdsselopt,
     lt_rdes  TYPE TABLE OF zqtcr_tr_log_des,
