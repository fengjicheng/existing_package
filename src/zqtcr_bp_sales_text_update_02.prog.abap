...
* OBJECT ID:             C105.1
* TRANSPORT NUMBER(S):   ED2K914796
*----------------------------------------------------------------------*
REPORT zqtcr_bp_sales_text_update_02.

"Include for the Declarations
INCLUDE ZQTCN_BP_SALES_TEXT_UPD_02_TOP.
*INCLUDE zqtcn_bp_sales_text_update_top IF FOUND.

"Include for Selection Screen
INCLUDE ZQTCN_BP_SALES_TEXT_UPD_02_SCR.
*INCLUDE zqtcn_bp_sales_text_update_scr IF FOUND.

"Include for the Subroutines.
INCLUDE ZQTCN_BP_SALES_TEXT_UPD_02_F01.
