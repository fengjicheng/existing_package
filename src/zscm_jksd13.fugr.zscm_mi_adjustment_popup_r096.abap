FUNCTION zscm_mi_adjustment_popup_r096.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"  EXPORTING
*"     VALUE(E_ADJUSTMENT) TYPE  CHAR13
*"----------------------------------------------------------------------
* REVISION HISTORY---------------------------------------------------*
...
* DATE: 11-FEB-2021
* DESCRIPTION: LITHO Report Adjustment Pop-Up
*--------------------------------------------------------------------*
* REVISION HISTORY---------------------------------------------------*
...
*EOI ED2K923103 TDIMANTHA 23.04.2021
  ...
  " Call popup screen
  CALL SCREEN 9002 STARTING AT im_start_column im_start_row.

  " Pass Log Number
  e_adjustment = gv_adjustment.

  " Clear the Global variables
  CLEAR: gv_adjustment, gv_matnr, gv_plant, gv_pubdate, gv_product,
         zscm_worklistlog.
