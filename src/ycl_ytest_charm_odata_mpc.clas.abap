class YCL_YTEST_CHARM_ODATA_MPC definition
  public
...
public section.
  ...
  types:
     TS_YTEST_CHARM type ZCAST_CONSTANT .
  types:
TT_YTEST_CHARM type standard table of TS_YTEST_CHARM .
  types:
  ...
  constants GC_YTEST_CHARM type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'YTEST_CHARM' ##NO_TEXT.
...
CLASS YCL_YTEST_CHARM_ODATA_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'YTEST_CHARM_ODATA_SRV' ).

define_ytest_charm( ).
  endmethod.


  method DEFINE_YTEST_CHARM.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'YTEST_CHARM' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZCAST_CONSTANT'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'YTEST_CHARMSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220406140037'.                  "#EC NOTEXT
