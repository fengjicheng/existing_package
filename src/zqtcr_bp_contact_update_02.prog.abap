...
* DESCRIPTION:
*----------------------------------------------------------------------*
REPORT zqtcr_bp_contact_update_02 MESSAGE-ID ZQTC_R2.

"Include for the Declarations
INCLUDE ZQTCN_BP_CONTACT_UPDATE_TOP_02.
*INCLUDE zqtcn_bp_contact_update_top.

"Include for Selection Screen
INCLUDE ZQTCN_BP_CONTACT_UPDATE_SCR_02.
*INCLUDE zqtcn_bp_contact_update_scr.

"Include for the Subroutines.
INCLUDE ZQTCN_BP_CONTACT_UPDATE_F01_02.
