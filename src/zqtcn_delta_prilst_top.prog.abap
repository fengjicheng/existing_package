...
DATA : r_cl_gui_alv_grid         TYPE REF TO cl_gui_alv_grid,
       ...
       i_fieldcatb               TYPE slis_t_fieldcat_alv,
       w_fieldcatb               LIKE LINE OF i_fieldcatb,
...
* End by amohammed on 04/09/2020 - ERPM-6882 - ED2K917919
  ...
  BEGIN OF ty_final_csv,
     activity    type char20,      "OTCM-6914 NPOLINA 12/11/2020
...
Types:    BEGIN OF ty_konhdelta,
            vakey TYPE vakey,                                       "PLTYP
            knumh TYPE knumh,                                       "Condition record number
...
*BOC <HIPATEL> <INC0215495> <ED1K908742> <10/15/2018>
  ...
  i_constants2 TYPE tt_constant,  "Application Constants
*EOC <HIPATEL> <INC0215495> <ED1K908742> <10/15/2018>

  w_final     TYPE ty_final,
  w_issn      TYPE ty_issn,
* SOC by NPOLINA OTCM-6914/OTCM-39345  ED2K921588
  i_konhdelta TYPE TABLE OF ty_konhdelta,
  w_konhdelta TYPE ty_konhdelta.
* EOC by NPOLINA OTCM-6914/OTCM-39345  ED2K921588
CONSTANTS:
  ...
  c_elec           TYPE char6        VALUE 'Online',##NO_TEXT        "Electronic media
...
*Begin of Add-Anirban-09.11.2017-ED2K908468-Defect 4392
  c_print          TYPE char5        VALUE 'Print',  ##NO_TEXT       "Print
*End of Add-Anirban-09.11.2017-ED2K908468-Defect 4392
  c_pne            TYPE char14       VALUE 'Print & Online',  ##NO_TEXT       "P+E
...
*BOC <HIPATEL> <INC0215495> <ED1K908742> <10/15/2018>
* SOC by NPOLINA OTCM-6914
  c_dev_i0390      TYPE zdevid       VALUE 'I0390',                    "Development ID
  c_rundays        TYPE rvari_vnam       VALUE 'RUNDAYS',                    "Development ID
  c_rundate        TYPE rvari_vnam       VALUE 'RUNDATE',                    "Development ID
  c_emailgrp       TYPE char30           VALUE 'DL_GROUP',
* EOC by NPOLINA OTCM-6914
*EOC <HIPATEL> <INC0215495> <ED1K908742> <10/15/2018>
...
* SOC by NPOLINA OTCM-6914
DATA: st_zcainterface TYPE zcainterface,
      v_runlimit      TYPE i,
      v_grp           TYPE char50,
      v_batch         TYPE char1,
...
* EOC by NPOLINA OTCM-6914
*CONSTANTS:c_new       TYPE char20 VALUE 'New'.
*CONSTANTS:c_del       TYPE char20 VALUE 'Delete'. ##NO_TEXT
*CONSTANTS:c_upd       TYPE char20 VALUE 'Update'.  ##NO_TEXT
