class ZCL_ZQTCO_ORDERS_APL_MPC definition
  public
...
TT_ORDERTYPE type standard table of TS_ORDERTYPE .
  ...
  begin of TS_APLCONSTENTRIES,
     ...
     LOW type string,
     HIGH type string,
  end of TS_APLCONSTENTRIES .
  types:
TT_APLCONSTENTRIES type standard table of TS_APLCONSTENTRIES .
  types:
  begin of TS_SHIPTO,
     KUNWE type string,
     NAME1 type string,
...
TT_SHIPTO type standard table of TS_SHIPTO .
  ...
  constants GC_APLCONSTENTRIES type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'APLConstEntries' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZQTCO_ORDERS_APL_MPC======CP' ##NO_TEXT.
  ...
  methods DEFINE_ORDERTYPE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_APLCONSTENTRIES
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZQTCO_ORDERS_APL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZQTCO_ORDERS_APL_SRV' ).

define_item( ).
define_soldto( ).
define_ordertype( ).
define_aplconstentries( ).
define_shipto( ).
define_actions( ).
  endmethod.
...
lo_action = model->create_action( 'SOCREATE' ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'ITEM' ). "#EC NOTEXT
...
lo_parameter = lo_action->create_input_parameter( iv_parameter_name = 'OTYPE'    iv_abap_fieldname = 'OTYPE' ). "#EC NOTEXT
lo_parameter->/iwbep/if_mgw_odata_property~set_type_edm_string( ).
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZQTCO_ORDERS_APL_MPC=>TS_SOCREATE' ). "#EC NOTEXT
  endmethod.


  method DEFINE_APLCONSTENTRIES.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - APLConstEntries
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'APLConstEntries' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZQTCO_ORDERS_APL_MPC=>TS_APLCONSTENTRIES' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'APLConstEntriesSet' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'NetPrice1' iv_abap_fieldname = 'NET_PRICE1' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
lo_property->set_maxlength( iv_max_length = 12 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Currency1' iv_abap_fieldname = 'CURRENCY1' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 5 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CondType1' iv_abap_fieldname = 'COND_TYPE1' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'NetPrice2' iv_abap_fieldname = 'NET_PRICE2' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
lo_property->set_maxlength( iv_max_length = 12 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Currency2' iv_abap_fieldname = 'CURRENCY2' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 5 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CondType2' iv_abap_fieldname = 'COND_TYPE2' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZQTCS_ITEM_APL'
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZQTCO_ORDERS_APL_MPC=>TS_ORDERTYPE' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZQTCO_ORDERS_APL_MPC=>TS_SHIPTO' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZQTCO_ORDERS_APL_MPC=>TS_SOLDTO' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220919122606'.                  "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'APLConstEntries'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
