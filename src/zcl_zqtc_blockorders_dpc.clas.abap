class ZCL_ZQTC_BLOCKORDERS_DPC definition
  public
...
protected section.
  ...
  methods BILLINGSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZQTC_BLOCKORDERS_MPC=>TS_BILLING
    raising
  ...
  methods BILLINGSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZQTC_BLOCKORDERS_MPC=>TT_BILLING
...
CLASS ZCL_ZQTC_BLOCKORDERS_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 2021.03.15 12:58:01 in client 130
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZQTC_BLOCKORDERS_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA billingset_create_entity TYPE zcl_zqtc_blockorders_mpc=>ts_billing.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA billingset_get_entity TYPE zcl_zqtc_blockorders_mpc=>ts_billing.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZQTC_BLOCKORDERS_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA billingset_get_entityset TYPE zcl_zqtc_blockorders_mpc=>tt_billing.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA billingset_update_entity TYPE zcl_zqtc_blockorders_mpc=>ts_billing.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
