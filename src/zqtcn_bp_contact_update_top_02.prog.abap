...
DATA :
  ...
  v_file_path      TYPE localfile,       " Local file for upload/download
  v_file_path_fg   TYPE localfile,"epsf-epsfilnam,    "file for background
...
CONSTANTS:
  ...
  c_param3      TYPE rvari_vnam VALUE 'LOGICAL_PATH',
