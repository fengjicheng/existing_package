*&---------------------------------------------------------------------*
*& Report  ZQTCR_EDU_PUB_LET_ZLOC2_F055
*&---------------------------------------------------------------------*
* PROGRAM NAME: ZQTCR_EDU_PUB_LET_ZLOC2_F055
* PROGRAM DESCRIPTION: This driver program implemented Lettor of Completion Form
*for ZLC2 template
* and template id LOC2_CEU
...
* DESCRIPTION:
*----------------------------------------------------------------------*
REPORT zqtcr_edu_pub_let_zloc2_f055 NO STANDARD PAGE HEADING.

TYPE-POOLS: szadr.
*- Top include
INCLUDE ZQTCN_EDU_PUB_LET_ZLC2_TOP.
*INCLUDE zqtcn_edu_pub_let_zloc2_top.
...
INCLUDE ZQTCN_EDU_PUB_LET_ZLC2_F01.
*INCLUDE zqtcn_edu_pub_let_zloc2_f01.
