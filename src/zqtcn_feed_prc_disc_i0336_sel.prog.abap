*----------------------------------------------------------------------*
* PROGRAM NAME:        ZQTCN_FEED_PRC_DISC_I0336_SEL (Selection Screen)
...
PARAMETERS:
  rb_age_x TYPE char1 RADIOBUTTON GROUP rdb1,                                "Agent ONIX-PC XML
  rb_age_c TYPE char1 RADIOBUTTON GROUP rdb1,                                "Agent CSV
