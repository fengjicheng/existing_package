...
*   Get Header data from Idoc Structure ------------>>
  READ TABLE didoc_data INTO lst_edidd_230_1 WITH KEY segnam = lc_ze1edk01.
  IF sy-subrc EQ 0.
    READ TABLE dxbdcdata INTO lst_dbcdata_230 WITH KEY fnam = 'VBKD-BSARK'.
    IF sy-subrc = 0.
      DATA(lv_tabix_t) = sy-tabix.
      lv_tabix_t = lv_tabix_t + 2.
    ENDIF.
    lst_ze1edk01 = lst_edidd_230_1-sdata.
...
* Update Header Partner Email IDS
    ...
    IF <li_xvbpa> IS ASSIGNED .
      LOOP AT didoc_data INTO lst_edidd_230_1 WHERE segnam = lc1_e1edka1_8.
        ...
        READ TABLE didoc_data ASSIGNING <lfs_zka1> WITH KEY segnam = lc1_z1qtc_e1edka1_01
                                                                          sdata+60(2) = lst_e1edka1_1-parvw.
        IF sy-subrc EQ 0.
          READ TABLE <li_xvbpa> ASSIGNING <lfs_pa1> WITH KEY parvw = lst_e1edka1_1-parvw.
          IF sy-subrc EQ 0.
            lv_row = sy-tabix.
...
* EOC by NPOLINA ERPM5261 ED2K916699
    ...
    CLEAR lst_bdcdata_230_1.
    lst_bdcdata_230_1-fnam = 'BDC_OKCODE'.
    lst_bdcdata_230_1-fval = '=T\07'.
    APPEND lst_bdcdata_230_1 TO li_dxbdcdata.

    INSERT LINES OF li_dxbdcdata INTO  dxbdcdata INDEX lv_tabix_t."lv_tabx.
    FREE:li_dxbdcdata.
  ENDIF.
ENDIF.
