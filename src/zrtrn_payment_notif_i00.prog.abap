...
*-------Adressdaten----------------------------------------------------
DATA: hkna1 TYPE SORTED TABLE OF kna1 WITH HEADER LINE      "1996349
      WITH UNIQUE KEY kunnr,                                    "1996349
      hlfa1 TYPE SORTED TABLE OF lfa1 WITH HEADER LINE      "1996349
      WITH UNIQUE KEY lifnr,                                    "1996349
      hknb1 TYPE SORTED TABLE OF knb1 WITH HEADER LINE      "1996349
      WITH UNIQUE KEY kunnr bukrs,                              "1996349
      hlfb1 TYPE SORTED TABLE OF lfb1 WITH HEADER LINE      "1996349
      WITH UNIQUE KEY lifnr bukrs.                              "1996349
...
DATA: gv_ryoshusho TYPE parct-ryoshusho.                    "2251727
...
***Begin Of change by Srbose: 17-Mar-2017
****Type declaration:
TYPES: BEGIN OF ty_final,
       ...
       BEGIN OF ty_bsid,
         ...
         umsks TYPE  umsks,  "Special G/L Transaction Type
       ...
       BEGIN OF ty_knb1,
         kunnr TYPE kunnr,  "Customer Number
         bukrs TYPE bukrs,  "Company Code
         zamio TYPE	dzamio,	     "Indicator: payment notice to customer (w/o cleared items)?
       END OF ty_knb1,
       ...
       BEGIN OF ty_bsegc,
         ...
         belnr TYPE  belnr_d,  "Accounting Document Number
         gjahr TYPE  gjahr,  "Fiscal Year
         rfzei TYPE  rfzei_cc, "Payment Card Item
       END OF ty_bsegc,
       BEGIN OF ty_hbsid.
        INCLUDE STRUCTURE hsortp.
        INCLUDE STRUCTURE bsid.
...
TYPES: tt_final    TYPE STANDARD TABLE OF ty_final,
       ...
       tt_bseg     TYPE STANDARD TABLE OF ty_bseg,
       tt_knb1     TYPE STANDARD TABLE OF ty_knb1,
       tt_bsegc    TYPE STANDARD TABLE OF ty_bsegc,
       tt_currency TYPE STANDARD TABLE OF ty_currency,
       tt_hbsid    TYPE STANDARD TABLE OF ty_hbsid.


****Internal Table Declaration
DATA: i_final    TYPE ztrtr_final,
      i_currency TYPE ztrtr_currency,
      i_bsid     TYPE tt_hbsid,
      i_bseg     TYPE tt_bseg.

****Global Variable
DATA : v_total    TYPE char20,
       v_currency TYPE waers.

*****Global Constant Declaration
CONSTANTS: c_x TYPE dzamio VALUE 'X'.

***End Of change by Srbose: 17-Mar-2017
