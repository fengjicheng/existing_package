*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZQTCV_RENWL_PLAN
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZQTCV_RENWL_PLAN    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZQTCV_RENWL_PLAN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZQTCV_RENWL_PLAN_EXTRACT
TOTAL = ZQTCV_RENWL_PLAN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZQTCV_RENWL_PLAN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZQTCV_RENWL_PLAN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_RENWL_PLAN_EXTRACT
TOTAL = ZQTCV_RENWL_PLAN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZQTCV_RENWL_PLAN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZQTCV_RENWL_PLAN'
...
TOTAL = ZQTCV_RENWL_PLAN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZQTCV_RENWL_PLAN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZQTCV_RENWL_PLAN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZQTCV_RENWL_PLAN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZQTCV_RENWL_PLAN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZQTCV_RENWL_PLAN_EXTRACT
TOTAL = ZQTCV_RENWL_PLAN_TOTAL
