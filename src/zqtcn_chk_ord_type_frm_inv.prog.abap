*&---------------------------------------------------------------------*
*&  Include           ZQTCN_CHK_ORD_TYPE_FRM_INV
*&---------------------------------------------------------------------*
*---------------------------------------------------------------------*
* PROGRAM NAME:        RV45B903 (Include)
*                      [Copy routine - 021]
* PROGRAM DESCRIPTION: Suppress warning message
* DEVELOPER:           NPOLINA
...
ENDIF.
IF  tvcpa-auarn IN li_auart AND alte_vbeln IS NOT INITIAL AND tvcpa-fkarv IN li_fkart.
...
*  ENDIF.
ELSE.
  IF NOT vbrk-rplnr IS INITIAL.             "CCARD
