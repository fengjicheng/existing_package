*----------------------------------------------------------------------*
* PROGRAM NAME: ZQTC_FIELDCAT_E335 (Check whether enhanmcent is active or not)
...
IF lv_actv_flag_e335 EQ abap_true.                           " Check Enhancement active flag
  INCLUDE zqtc_fieldcat_sub_e335 IF FOUND.                   " Subroutine for Filed catalog declaration
ENDIF.
